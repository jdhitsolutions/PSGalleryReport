...
+ [James Brundage](#James-Brundage) (74)
...
+ **PSSailpoint.NERMV2025 2.0.9**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*07/07/2026 09:39:01*]
+ **PSSailpoint.NERM 2.0.9**  - PSSailpoint.NERM - the PowerShell module for NERM API [*07/07/2026 09:38:47*]
+ **PSSailpoint.Workflows 2.0.9**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*07/07/2026 09:38:33*]
+ **PSSailpoint.WorkReassignment 2.0.9**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*07/07/2026 09:38:26*]
+ **PSSailpoint.WorkItems 2.0.9**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*07/07/2026 09:38:00*]
+ **PSSailpoint.Triggers 2.0.9**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*07/07/2026 09:37:27*]
+ **PSSailpoint.Transforms 2.0.9**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*07/07/2026 09:37:18*]
+ **PSSailpoint.TenantContext 2.0.9**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*07/07/2026 09:37:05*]
+ **PSSailpoint.TaskManagement 2.0.9**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*07/07/2026 09:36:33*]
+ **PSSailpoint.Tags 2.0.9**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*07/07/2026 09:36:14*]
+ **PSSailpoint.TaggedObjects 2.0.9**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*07/07/2026 09:36:09*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.0.9**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*07/07/2026 09:35:59*]
+ **PSSailpoint.SpConfig 2.0.9**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*07/07/2026 09:35:54*]
+ **PSSailpoint.Sources 2.0.9**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*07/07/2026 09:35:40*]
+ **PSSailpoint.SourceUsages 2.0.9**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*07/07/2026 09:35:23*]
+ **PSSailpoint.SodViolations 2.0.9**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*07/07/2026 09:35:09*]
+ **PSSailpoint.SodPolicies 2.0.9**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*07/07/2026 09:34:47*]
+ **PSSailpoint.SimIntegrations 2.0.9**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*07/07/2026 09:34:20*]
+ **PSSailpoint.Segments 2.0.9**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*07/07/2026 09:33:26*]
+ **PSSailpoint.SearchAttributeConfiguration 2.0.9**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*07/07/2026 09:33:14*]
+ **PSSailpoint.Search 2.0.9**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*07/07/2026 09:33:10*]
+ **PSSailpoint.ScheduledSearch 2.0.9**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*07/07/2026 09:33:05*]
+ **PSSailpoint.SavedSearch 2.0.9**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*07/07/2026 09:33:01*]
+ **PSSailpoint.Roles 2.0.9**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*07/07/2026 09:32:55*]
+ **PSSailpoint.RolePropagation 2.0.9**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*07/07/2026 09:32:51*]
+ **PSSailpoint.RequestableObjects 2.0.9**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*07/07/2026 09:32:32*]
+ **PSSailpoint.ReportsDataExtraction 2.0.9**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*07/07/2026 09:32:28*]
+ **PSSailpoint.PublicIdentitiesConfig 2.0.9**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*07/07/2026 09:32:24*]
+ **PSSailpoint.PublicIdentities 2.0.9**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*07/07/2026 09:32:09*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.0.9**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*07/07/2026 09:31:50*]
+ **PSSailpoint.PrivilegeCriteria 2.0.9**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*07/07/2026 09:31:43*]
+ **PSSailpoint.PersonalAccessTokens 2.0.9**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*07/07/2026 09:31:18*]
+ **PSSailpoint.PasswordSyncGroups 2.0.9**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*07/07/2026 09:30:55*]
+ **PSSailpoint.PasswordPolicies 2.0.9**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*07/07/2026 09:30:29*]
+ **PSSailpoint.PasswordManagement 2.0.9**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*07/07/2026 09:30:08*]
+ **PSSailpoint.PasswordDictionary 2.0.9**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*07/07/2026 09:29:38*]
+ **PSSailpoint.PasswordConfiguration 2.0.9**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*07/07/2026 09:29:15*]
+ **PSSailpoint.ParameterStorage 2.0.9**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*07/07/2026 09:28:48*]
+ **PSSailpoint.OrgConfig 2.0.9**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*07/07/2026 09:28:26*]
+ **PSSailpoint.OauthClients 2.0.9**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*07/07/2026 09:28:03*]
+ **PSSailpoint.Notifications 2.0.9**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*07/07/2026 09:27:40*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.0.9**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*07/07/2026 09:27:15*]
+ **PSSailpoint.MultiHostIntegration 2.0.9**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*07/07/2026 09:26:47*]
+ **PSSailpoint.MfaConfiguration 2.0.9**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*07/07/2026 09:26:38*]
+ **PSSailpoint.ManagedClusters 2.0.9**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*07/07/2026 09:26:09*]
+ **PSSailpoint.ManagedClusterTypes 2.0.9**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*07/07/2026 09:25:53*]
+ **PSSailpoint.ManagedClients 2.0.9**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*07/07/2026 09:25:45*]
+ **PSSailpoint.MachineIdentities 2.0.9**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*07/07/2026 09:25:41*]
+ **PSSailpoint.MachineClassificationConfig 2.0.9**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*07/07/2026 09:25:36*]
+ **PSSailpoint.MachineAccounts 2.0.9**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*07/07/2026 09:25:31*]
+ **PSSailpoint.MachineAccountSubtypes 2.0.9**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*07/07/2026 09:25:27*]
+ **PSSailpoint.MachineAccountMappings 2.0.9**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*07/07/2026 09:25:22*]
+ **PSSailpoint.MachineAccountCreationRequest 2.0.9**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*07/07/2026 09:25:17*]
+ **PSSailpoint.MachineAccountClassify 2.0.9**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*07/07/2026 09:25:12*]
+ **PSSailpoint.LifecycleStates 2.0.9**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*07/07/2026 09:25:08*]
+ **PSSailpoint.Launchers 2.0.9**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*07/07/2026 09:25:03*]
+ **PSSailpoint.JitActivations 2.0.9**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*07/07/2026 09:24:59*]
+ **PSSailpoint.JitAccess 2.0.9**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*07/07/2026 09:24:55*]
+ **PSSailpoint.Intelligence 2.0.9**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*07/07/2026 09:24:50*]
+ **PSSailpoint.IdentityProfiles 2.0.9**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*07/07/2026 09:24:46*]
+ **PSSailpoint.IdentityHistory 2.0.9**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*07/07/2026 09:24:42*]
+ **PSSailpoint.IdentityAttributes 2.0.9**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*07/07/2026 09:24:37*]
+ **PSSailpoint.Identities 2.0.9**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*07/07/2026 09:24:33*]
+ **PSSailpoint.Icons 2.0.9**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*07/07/2026 09:24:29*]
+ **PSSailpoint.IaiRoleMining 2.0.9**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*07/07/2026 09:24:24*]
+ **PSSailpoint.IaiRecommendations 2.0.9**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*07/07/2026 09:24:19*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.0.9**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*07/07/2026 09:24:15*]
+ **PSSailpoint.IaiOutliers 2.0.9**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*07/07/2026 09:24:11*]
+ **PSSailpoint.IaiCommonAccess 2.0.9**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*07/07/2026 09:24:06*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.0.9**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*07/07/2026 09:23:54*]
+ **PSSailpoint.GovernanceGroups 2.0.9**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*07/07/2026 09:23:49*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.0.9**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*07/07/2026 09:23:40*]
+ **PSSailpoint.Entitlements 2.0.9**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*07/07/2026 09:23:21*]
+ **PSSailpoint.EntitlementConnections 2.0.9**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*07/07/2026 09:23:15*]
+ **PSSailpoint.Dimensions 2.0.9**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*07/07/2026 09:23:08*]
+ **PSSailpoint.DeclassifySource 2.0.9**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*07/07/2026 09:23:03*]
+ **PSSailpoint.DataSegmentation 2.0.9**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*07/07/2026 09:22:43*]
+ **PSSailpoint.DataAccessSecurity 2.0.9**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*07/07/2026 09:22:34*]
+ **PSSailpoint.CustomUserLevels 2.0.9**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*07/07/2026 09:22:29*]
+ **PSSailpoint.CustomPasswordInstructions 2.0.9**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*07/07/2026 09:22:13*]
+ **PSSailpoint.CustomForms 2.0.9**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*07/07/2026 09:21:56*]
+ **PSSailpoint.Connectors 2.0.9**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*07/07/2026 09:21:35*]
+ **PSSailpoint.ConnectorRuleManagement 2.0.9**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*07/07/2026 09:21:26*]
+ **PSSailpoint.ConnectorCustomizers 2.0.9**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*07/07/2026 09:21:00*]
+ **PSSailpoint.ConfigurationHub 2.0.9**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*07/07/2026 09:20:35*]
+ **PSSailpoint.ClassifySource 2.0.9**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*07/07/2026 09:20:23*]
+ **PSSailpoint.Certifications 2.0.9**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*07/07/2026 09:19:54*]
+ **PSSailpoint.CertificationSummaries 2.0.9**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*07/07/2026 09:19:27*]
+ **PSSailpoint.CertificationCampaigns 2.0.9**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*07/07/2026 09:18:58*]
+ **PSSailpoint.CertificationCampaignFilters 2.0.9**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*07/07/2026 09:18:36*]
+ **PSSailpoint.Branding 2.0.9**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*07/07/2026 09:18:19*]
+ **PSSailpoint.AuthUsers 2.0.9**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*07/07/2026 09:17:54*]
+ **PSSailpoint.AuthProfile 2.0.9**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*07/07/2026 09:17:29*]
+ **PSSailpoint.Apps 2.0.9**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*07/07/2026 09:17:11*]
+ **PSSailpoint.Approvals 2.0.9**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*07/07/2026 09:16:48*]
+ **PSSailpoint.ApplicationDiscovery 2.0.9**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*07/07/2026 09:16:19*]
+ **PSSailpoint.ApiUsage 2.0.9**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*07/07/2026 09:15:59*]
+ **PSSailpoint.Accounts 2.0.9**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*07/07/2026 09:15:37*]
+ **PSSailpoint.AccountUsages 2.0.9**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*07/07/2026 09:15:16*]
+ **PSSailpoint.AccountDeletionRequests 2.0.9**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*07/07/2026 09:14:52*]
+ **PSSailpoint.AccountAggregations 2.0.9**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*07/07/2026 09:14:22*]
+ **PSSailpoint.AccountActivities 2.0.9**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*07/07/2026 09:13:54*]
+ **PSSailpoint.AccessRequests 2.0.9**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*07/07/2026 09:13:36*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.0.9**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*07/07/2026 09:13:13*]
+ **PSSailpoint.AccessRequestApprovals 2.0.9**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*07/07/2026 09:12:48*]
+ **PSSailpoint.AccessProfiles 2.0.9**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*07/07/2026 09:12:18*]
+ **PSSailpoint.AccessModelMetadata 2.0.9**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*07/07/2026 09:11:50*]
...
+ **[PowerBGInfo 1.0.4](https://github.com/EvotecIT/PowerBGInfo)**  - PowerBGInfo is a module that allows you to create background images with information about your environment. [*07/06/2026 13:40:00*]
...
*Updated: Tuesday, 07 July 2026 12:18:31 UTC*
