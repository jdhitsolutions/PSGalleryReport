...
+ **[PSSharedGoods 0.0.305](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*03/17/2025 08:37:39*]
...
+ **[EntraAuth 1.6.33](https://github.com/FriedrichWeinmann/EntraAuth)**  - Get Tokens from Entra ID [*03/10/2025 09:27:30*]
...
+ **[GitHub 0.17.0](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with GitHub, both interactively and via automation. [*03/17/2025 17:39:32*]
...
+ **[Path 1.0.15](https://github.com/PSModule/Path)**  - A PowerShell module to manage the PATH environment variable on Windows. [*03/14/2025 13:59:26*]
...
+ **[DynamicParams 1.1.10](https://github.com/PSModule/DynamicParams)**  - A PowerShell module that makes it easier to use dynamic params. [*03/14/2025 10:15:50*]
...
+ **[GoogleFonts 1.0.15](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*03/14/2025 09:43:57*]
...
+ **[PSOpenAI 4.19.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*03/13/2025 14:22:48*]
...
+ **[ModuleBuilder 3.1.7](https://github.com/PoshCode/ModuleBuilder)**  - A module for authoring and building PowerShell modules [*02/20/2025 04:41:02*]
...
+ **spec.network.management 1.0.6**  - A module to manage windows networking. [*03/10/2025 21:25:36*]
...
+ **[PSAI 0.4.6](https://github.com/dfinke/PSAI)**  - PSAI brings OpenAI ChatGPT to PowerShell, leveraging advanced AI capabilities in your PowerShell scripts for dynamic, intelligent automation and data processing [*03/15/2025 00:29:32*]
...
*Updated: Tuesday, 18 March 2025 02:17:39 UTC*
