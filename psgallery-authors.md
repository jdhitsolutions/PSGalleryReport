...
+ [Adam Driscoll](#Adam-Driscoll) (35)
+ [Akamai Technologies Ltd.](#Akamai-Technologies-Ltd) (34)
+ [Friedrich Weinmann](#Friedrich-Weinmann) (32)
+ [Jeff Hicks](#Jeff-Hicks) (30)
+ [Michael Haken](#Michael-Haken) (26)
+ [James Brundage](#James-Brundage) (24)
+ [mkht](#mkht) (22)
...
+ [PSModule](#PSModule) (18)
+ [EPRSBuildTeam](#EPRSBuildTeam) (17)
...
+ [Michal Gajda](#Michal-Gajda) (16)
+ [Jan Hoek](#Jan-Hoek) (15)
+ [Gabriel Adrian Samfira Alessandro Pilotti](#Gabriel-Adrian-Samfira-Alessandro-Pilotti) (15)
+ [WebMD Health Services](#WebMD-Health-Services) (15)
+ [Tao Yang](#Tao-Yang) (14)

## Broadcom

+ **[PowerValidatedSolutions 2.12.0.1050](https://vmware.github.io/power-validated-solutions-for-cloud-foundation/)**  - PowerShell Module for VMware Validated Solutions [*10/09/2024 16:18:57*]
...
+ **[ADEssentials 0.0.230](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*02/09/2025 13:15:51*]
+ **[TheDashboard 0.0.34](https://github.com/EvotecIT/TheDashboard)**  - TheDashboard is a module that allows you to create a dashboard for your HTML reports [*01/24/2025 15:49:42*]
+ **[PSSharedGoods 0.0.303](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*01/24/2025 10:04:22*]
...
+ **GraphEssentials 0.0.37**  - GraphEssentials is a PowerShell module that helps with Office 365 / Azure AD using mostly Graph [*11/05/2024 16:11:50*]
...
+ **[Testimo 0.0.90](https://github.com/EvotecIT/Testimo)**  - Testimo is Powershell module that tests Active Directory against specific set of tests. [*09/28/2024 15:09:49*]
...
+ **[EntraAuth 1.5.28](https://github.com/FriedrichWeinmann/EntraAuth)**  - Get Tokens from Entra ID [*02/14/2025 17:38:30*]
...
+ **[PSOpenAI 4.17.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*02/16/2025 13:53:03*]
...
+ **[ModuleBuilder 3.1.6](https://github.com/PoshCode/ModuleBuilder)**  - A module for authoring and building PowerShell modules [*02/08/2025 21:45:59*]
...
+ **spec.network.management 1.0.2**  - A module to manage windows networking. [*11/26/2024 13:57:37*]
...
+ **[PureStorage.CBS.AVS 1.1.388](https://support.purestorage.com/Pure_Cloud_Block_Store/Azure_VMware_Solution_and_Cloud_Block_Store_Implementation_Guide)**  - Pure Storage FlashArray AVS Plugin. [*12/18/2024 22:15:57*]
...
+ **[NerdFonts 1.0.19](https://github.com/PSModule/NerdFonts)**  - A PowerShell module to download and install fonts from NerdFonts. [*02/18/2025 09:42:55*]
+ **[GoogleFonts 1.0.6](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*02/18/2025 08:53:04*]
+ **[GitHub 0.15.1](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with GitHub, both interactively and via automation. [*02/17/2025 21:15:09*]
+ **[Fonts 1.1.17](https://github.com/PSModule/Fonts)**  - A PowerShell module for managing fonts. [*02/17/2025 13:07:59*]
...
+ **[AST 0.3.0](https://github.com/PSModule/AST)**  - A PowerShell module for using the Abstract Syntax Tree (AST) to analyze any PowerShell code. [*02/17/2025 11:36:32*]
+ **[Uri 1.1.0](https://github.com/PSModule/Uri)**  - A powershell module that works with URIs (RFC3986) [*02/09/2025 23:09:55*]
+ **[Sodium 2.1.2](https://github.com/PSModule/Sodium)**  - A PowerShell module for handling Sodium encrypted secrets. [*02/09/2025 12:26:33*]
+ **[Utilities 0.8.0](https://github.com/PSModule/Utilities)**  - A PowerShell module with a collection of functions that should have been in PowerShell to start with. [*02/05/2025 01:30:49*]
+ **[Web 1.0.0](https://github.com/PSModule/Web)**  - A PowerShell module for working with web based protocols [*02/02/2025 19:41:27*]
+ **[CasingStyle 1.0.2](https://github.com/PSModule/CasingStyle)**  - A PowerShell module that works with casing of text. [*02/02/2025 14:47:55*]
+ **[PSSemVer 1.1.4](https://github.com/PSModule/PSSemVer)**  - A PowerShell module adding a SemVer compatible class and functions. [*12/20/2024 12:35:12*]
...
+ **[Retry 0.1.3](https://github.com/PSModule/Retry)**  - A PowerShell module to create a retry mechanism around functions [*11/02/2024 16:52:37*]
+ **[PowerShellGallery 0.0.14](https://github.com/PSModule/PowerShellGallery)**  - A PowerShell module for interacting with the PowerShell Gallery. [*11/02/2024 16:05:40*]
+ **[PATH 1.0.13](https://github.com/PSModule/PATH)**  - A PowerShell module to manage the PATH environment variable on Windows. [*11/02/2024 15:51:50*]
+ **[OpenAI 0.0.6](https://github.com/PSModule/OpenAI)**  - A PowerShell module for interacting with OpenAI [*11/02/2024 00:37:09*]
...
+ **[UncommonSense.Volkskrant 0.0.59.0](https://github.com/jhoek/UncommonSense.Volkskrant)**  - PowerShell module for listing Volkskrant articles [*02/14/2025 08:32:25*]
...
+ **HybridWorkerToolkit 1.0.3**  - The HybridWorkerToolkit PowerShell module provides various functions that can be called within an Azure Automation runbook when triggered on Hybrid Workers. These activities can assist gathering information about hybrid workers and the runbook runtime environment. It also provides a function to log structured events to the Hybrid Workers Windows Event log. More information can be found at the GitHub repository: https://github.com/tyconsulting/HybridWorkerToolkit [*04/23/2016 12:14:24*]
...
*Updated: Tuesday, 18 February 2025 09:51:27 UTC*
