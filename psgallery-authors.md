...
+ [Hewlett Packard Enterprise](#Hewlett-Packard-Enterprise) (5)
...
+ **[Test-NETHLK 2023.7.12.82](https://github.com/microsoft/Test-NetHLK)**  - Test-NetHLK is a module that compares a NICs driver configuration and switch capabilities against the MSFT documented requirements [*07/12/2023 18:08:48*]
...
+ **[Sampler 0.117.0](https://github.com/gaelcolas/Sampler)**  - Sample Module with Pipeline scripts and its Plaster template to create a module following some of the community accepted practices. [*09/29/2023 18:38:01*]
+ **[datum 0.40.1](https://github.com/gaelcolas/Datum/)**  - Module to manage Hierarchical Configuration Data. [*04/03/2023 19:16:56*]
+ **DscBuildHelpers 0.2.1**  - Build Helpers for DSC Resources and Configurations [*04/16/2022 08:12:45*]
...
+ **[JsonToPowershellClass 1.0.1](https://github.com/trossr32/ps-json-to-powershell-class)**  - A Powershell module that converts JSON to Powershell classes. JSON can be supplied as a string, a file that will be read or a URL that will be downloaded. [*12/09/2022 23:44:12*]
...
+ **[FlattenFolders 1.2.0](https://github.com/trossr32/ps-flatten-folders)**  - A Powershell module that moves files from all sub-directories to the parent directory. [*12/02/2020 19:39:55*]
+ **[VideoResolution 1.0.1](https://github.com/trossr32/ps-video-resolution)**  - A PowerShell Module to probe video files for their resolution and output results to host and optionally to log files. [*06/19/2020 18:43:26*]
...
+ **[ProtectedData 4.1.3](https://github.com/dlwyatt/ProtectedData)**  - Encrypt and share secret data between different users and computers. [*05/19/2015 03:30:31*]
...
*Updated: Tuesday, 03 October 2023 09:51:44 UTC*
