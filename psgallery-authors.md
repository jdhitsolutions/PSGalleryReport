...
+ **IdracRedfishSupport 28.4.0.0**  - Main module used to import all individual iDRAC Redfish modules listed in the Powershell gallery. For more details and examples for each module, execute get-help on the specific module. [*03/31/2026 22:13:49*]
...
+ **Invoke-CreateXauthTokenSessionREDFISH 11.0.0.0**  - iDRAC cmdlet using Redfish API to either view, create or delete iDRAC X-auth token session. [*03/10/2026 13:19:07*]
...
+ **[InformationProtection 1.0.17](https://github.com/FriedrichWeinmann/InformationProtection)**  - Wraps the Microsoft Information Protection SDK [*04/16/2026 08:53:25*]
...
+ **[PkiExtension 1.1.4](https://github.com/FriedrichWeinmann/PkiExtension)**  - Extends the core feature set of the PKI Module [*11/13/2025 13:41:47*]
...
*Updated: Sunday, 19 April 2026 21:59:49 UTC*
