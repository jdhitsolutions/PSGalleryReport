...
+ [Iain Brighton](#Iain-Brighton) (13)
...
+ **[PSWriteHTML 1.25.0](https://github.com/EvotecIT/PSWriteHTML)**  - PSWriteHTML is PowerShell Module to generate beautiful HTML reports, pages, emails without any knowledge of HTML, CSS or JavaScript. To get started basics PowerShell knowledge is required. [*07/02/2024 20:07:27*]
...
+ **[PSSharedGoods 0.0.293](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*06/29/2024 18:12:08*]
+ **[PasswordSolution 1.2.3](https://github.com/EvotecIT/PasswordSolution)**  - This module allows the creation of password expiry emails for users, managers, administrators, and security according to defined templates. It's able to work with different rules allowing to fully customize who gets the email and when. [*06/23/2024 15:28:02*]
+ **[GPOZaurr 1.1.4](https://github.com/EvotecIT/GPOZaurr)**  - Group Policy Eater is a PowerShell module that aims to gather information about Group Policies but also allows fixing issues that you may find in them. [*06/11/2024 15:24:02*]
...
+ **[PSPublishModule 2.0.12](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*05/06/2024 19:04:01*]
...
+ **[PSFramework 1.10.318](http://psframework.org/)**  - General Scripting Framework, providing PowerShell-specific infrastructure for other modules. [*11/10/2023 22:09:15*]
...
+ **[PSScriptTools 2.49.0](https://github.com/jdhitsolutions/PSScriptTools)**  - A collection of PowerShell functions designed to enhance your own functions and scripts or to facilitate working in the console. Most of the commands should work in Windows PowerShell and PowerShell 7, even cross-platform. Any operating system limitations should be handled on a per-command basis. [*06/06/2024 17:46:14*]
...
+ **[PSOpenAI 3.15.1](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*06/19/2024 13:57:41*]
...
+ **[NetApp.ONTAP 9.14.1.2401](https://mysupport.netapp.com/site/tools/tool-eula/ontap-powershell-toolkit)**  - NetApp.ONTAP PowerShell Toolkit. The ONTAP 9.14.1 PowerShell Toolkit provides end-to-end automation and enables more efficient and scalable administration of NetApp storage. This module contains over 2340 PowerShell cmdlets to help you automate ONTAP administration on FAS and AFF systems, commodity hardware, and the cloud. This toolkit also supports REST API with 9.10 and later version of ONTAP. The toolkit also provides cross-platform support for Windows, Ubuntu, Red Hat Enterprise Linux (RHEL), and macOS. [*01/30/2024 10:25:56*]
...
+ **spec.base.utilities 1.2.10**  - Mandatory module for the foundation PowerShell scripts. [*07/04/2024 09:13:10*]
+ **spec.file.utilities 2.0.4**  - A module for efficient file management, enabling seamless file downloads from Azure Blob storage, file hash comparisons, and a suite of essential file operations. [*07/03/2024 11:17:17*]
...
+ **spec.tonoref.management 1.0.7**  - A module to help manage Tonoref URL generation [*03/05/2024 15:49:12*]
...
+ **[AdminToolbox 11.0.166](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*07/03/2024 14:07:17*]
+ **[AdminToolbox.FortiWizard 2.19.13](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*07/03/2024 14:07:05*]
+ **[AdminToolbox.VMWareAutomate 4.8.155](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*07/03/2024 14:05:56*]
+ **[AdminToolbox.Remoting 1.9.158](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*07/03/2024 14:05:53*]
+ **[AdminToolbox.Office365 4.0.18](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*07/03/2024 14:05:50*]
+ **[AdminToolbox.Networking 2.19.11](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*07/03/2024 14:05:47*]
+ **[AdminToolbox.MSGraph 1.3.12](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*07/03/2024 14:05:43*]
+ **[AdminToolbox.Fun 1.6.159](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*07/03/2024 14:05:40*]
+ **[AdminToolbox.FileManagement 1.16.150](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*07/03/2024 14:05:35*]
+ **[AdminToolbox.FFTools 4.16.108](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*07/03/2024 14:05:33*]
+ **[AdminToolbox.Exchange 1.9.159](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*07/03/2024 14:05:25*]
+ **[AdminToolbox.EndpointManagement 4.10.36](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*07/03/2024 14:05:21*]
+ **[AdminToolbox.ActiveDirectory 1.10.20](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*07/03/2024 14:05:15*]
...
+ **[PsDac 1.6.0](https://abbgrade.github.io/PsDac/)**  - PsDac connects DacFx and PowerShell. It gives you PowerShell Cmdlets with the power of Microsoft.SqlServer.DacFx. [*08/24/2023 13:37:32*]
...
*Updated: Thursday, 04 July 2024 09:51:16 UTC*
