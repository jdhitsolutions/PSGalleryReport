...
+ [Broadcom](#Broadcom) (78)
+ [Przemyslaw Klys](#Przemyslaw-Klys) (3)
...
+ [Thomas J. Malkewitz @dotps1 and Ben @beanska](#Thomas-J-Malkewitz-dotps1-and-Ben-beanska) (1)
+ [Stefan Ivemo](#Stefan-Ivemo) (1)
+ [Vadims Podans](#Vadims-Podans) (1)
+ [Michael Grafnetter](#Michael-Grafnetter) (1)
+ [Alex Sarafian](#Alex-Sarafian) (1)
+ [Jan De Dobbeleer](#Jan-De-Dobbeleer) (1)
+ [PowerShell](#PowerShell) (1)
+ [Daniel Scott-Raynsford](#Daniel-Scott-Raynsford) (1)
+ [Bastian Eicher](#Bastian-Eicher) (1)
...
+ [Raimund Andree](#Raimund-Andree) (1)
+ [Caleb Albers](#Caleb-Albers) (1)
+ [Francois Gendron <fg@frgn.ca>](#Francois-Gendron-<fgfrgnca>) (1)
...
+ **[InvokeBuild 5.12.2](https://github.com/nightroman/Invoke-Build)**  - Build and test automation in PowerShell [*03/13/2025 06:00:34*]
...
+ **[Evergreen 2503.1859](https://stealthpuppy.com/evergreen/)**  - Create evergreen Windows image builds with the latest versions of applications. Evergreen is a simple PowerShell module that retrieves the latest version numbers and download URLs for various software products directly from the vendor source. [*03/09/2025 06:25:36*]
...
## Thomas J. Malkewitz @dotps1 and Ben @beanska

+ **[HPWarranty 2.6.2](http://dotps1.github.io/HPWarranty)**  - PowerShell Module designed to retrieve Hewlett-Packard Warranty Information. [*08/22/2016 19:59:24*]

## Stefan Ivemo

+ **[Bicep 2.8.0](https://github.com/PSBicep/PSBicep)**  - A module to run Bicep using PowerShell. The module is a community project built using the Bicep assemblies to provide you with an enhanced Bicep experience directly from PowerShell without having Bicep CLI installed. 
...
https://github.com/Azure/bicep [*02/14/2025 15:38:23*]

## Vadims Podans

+ **[PSPKI 4.2.0](https://www.pkisolutions.com/tools/pspki/)**  - This module contains public key infrastructure and certificate management functions. Support site: https://www.pkisolutions.com/tools/pspki/ [*01/18/2024 10:14:22*]

## Michael Grafnetter

+ **[DSInternals 5.0](https://github.com/MichaelGrafnetter/DSInternals)**  - The DSInternals PowerShell Module exposes several internal features of Active Directory and Azure Active Directory. These include FIDO2 and NGC key auditing, offline ntds.dit file manipulation, password auditing, DC recovery from IFM backups and password hash calculation.

DISCLAIMER: Features exposed through this module are not supported by Microsoft and it is therefore not intended to be used in production environments. Improper use might cause irreversible damage to domain controllers or negatively impact domain security. [*03/03/2025 10:47:01*]

## Alex Sarafian

+ **[SemVerPS 2.1](https://github.com/Sarafian/SemVerPS/)**  - PowerShell module for Semantic Version [*10/06/2021 19:55:40*]

## Jan De Dobbeleer

+ **[oh-my-posh 7.85.2](https://github.com/JanDeDobbeleer/oh-my-posh)**  - A prompt theme engine for any shell [*05/17/2022 07:00:14*]

## PowerShell

+ **[WindowsCompatibility 1.0.0](https://github.com/PowerShell/WindowsCompatibility)**  - This module provides compatibility utilities that allow PowerShell Core sessions to
...
commands much as if they were native to PowerShell Core. [*11/15/2018 01:16:43*]
...
+ **[0install 2.25.12](https://0install.net/)**  - Zero Install is a decentralized cross-platform software-installation system. [*10/02/2024 06:47:34*]
...
+ **[NTFSSecurity 4.2.6](https://github.com/raandree/NTFSSecurity)**  - Windows PowerShell Module for managing file and folder security on NTFS volumes [*07/12/2019 19:07:52*]

## Caleb Albers

+ **[ITGlueAPI 2.2.0](https://github.com/itglue/powershellwrapper)**  - This module provides a PowerShell wrapper for the IT Glue API. [*12/06/2022 06:58:36*]

## Francois Gendron <fg@frgn.ca>

+ **[AudioDeviceCmdlets 3.1.0.2](https://github.com/frgnca/AudioDeviceCmdlets)**  - AudioDeviceCmdlets is a suite of PowerShell Cmdlets to control audio devices on Windows [*05/28/2022 18:44:10*]
