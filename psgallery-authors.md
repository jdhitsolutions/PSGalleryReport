...
+ [Friedrich Weinmann](#Friedrich-Weinmann) (76)
...
+ **PSSailpoint.NERMV2025 2.1.35**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*09/10/2026 08:39:11*]
+ **PSSailpoint.NERM 2.1.35**  - PSSailpoint.NERM - the PowerShell module for NERM API [*09/10/2026 08:39:07*]
+ **PSSailpoint.Workflows 2.1.35**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*09/10/2026 08:39:01*]
+ **PSSailpoint.WorkReassignment 2.1.35**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*09/10/2026 08:38:54*]
+ **PSSailpoint.WorkItems 2.1.35**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*09/10/2026 08:38:48*]
+ **PSSailpoint.UiMetadata 2.1.35**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*09/10/2026 08:38:41*]
+ **PSSailpoint.Triggers 2.1.35**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*09/10/2026 08:38:31*]
+ **PSSailpoint.Transforms 2.1.35**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*09/10/2026 08:38:27*]
+ **PSSailpoint.TenantContext 2.1.35**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*09/10/2026 08:38:22*]
+ **PSSailpoint.Tenant 2.1.35**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*09/10/2026 08:38:18*]
+ **PSSailpoint.TaskManagement 2.1.35**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*09/10/2026 08:38:14*]
+ **PSSailpoint.Tags 2.1.35**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*09/10/2026 08:38:10*]
+ **PSSailpoint.TaggedObjects 2.1.35**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*09/10/2026 08:38:06*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.35**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*09/10/2026 08:38:00*]
+ **PSSailpoint.SpConfig 2.1.35**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*09/10/2026 08:37:56*]
+ **PSSailpoint.Sources 2.1.35**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*09/10/2026 08:37:52*]
+ **PSSailpoint.SourceUsages 2.1.35**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*09/10/2026 08:37:47*]
+ **PSSailpoint.SodViolations 2.1.35**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*09/10/2026 08:37:42*]
+ **PSSailpoint.SodPolicies 2.1.35**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*09/10/2026 08:37:38*]
+ **PSSailpoint.SodControls 2.1.35**  - PSSailpoint.SodControls - the PowerShell module for Identity Security Cloud API - SOD Controls [*09/10/2026 08:37:34*]
+ **PSSailpoint.SimIntegrations 2.1.35**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*09/10/2026 08:37:30*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.35**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*09/10/2026 08:37:26*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.35**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*09/10/2026 08:37:21*]
+ **PSSailpoint.Segments 2.1.35**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*09/10/2026 08:37:17*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.35**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*09/10/2026 08:37:12*]
+ **PSSailpoint.Search 2.1.35**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*09/10/2026 08:37:08*]
+ **PSSailpoint.ScheduledSearch 2.1.35**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*09/10/2026 08:37:03*]
+ **PSSailpoint.SavedSearch 2.1.35**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*09/10/2026 08:36:51*]
+ **PSSailpoint.Roles 2.1.35**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*09/10/2026 08:36:41*]
+ **PSSailpoint.RolePropagation 2.1.35**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*09/10/2026 08:36:25*]
+ **PSSailpoint.RoleInsights 2.1.35**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*09/10/2026 08:36:01*]
+ **PSSailpoint.RequestableObjects 2.1.35**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*09/10/2026 08:35:47*]
+ **PSSailpoint.ReportsDataExtraction 2.1.35**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*09/10/2026 08:35:24*]
+ **PSSailpoint.PublicMachineIdentities 2.1.35**  - PSSailpoint.PublicMachineIdentities - the PowerShell module for Identity Security Cloud API - Public Machine Identities [*09/10/2026 08:35:05*]
+ **PSSailpoint.PublicIdentitiesConfig 2.1.35**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*09/10/2026 08:34:51*]
+ **PSSailpoint.PublicIdentities 2.1.35**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*09/10/2026 08:34:36*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.35**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*09/10/2026 08:34:21*]
+ **PSSailpoint.PrivilegeCriteria 2.1.35**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*09/10/2026 08:34:08*]
+ **PSSailpoint.PersonalAccessTokens 2.1.35**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*09/10/2026 08:33:48*]
+ **PSSailpoint.PasswordSyncGroups 2.1.35**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*09/10/2026 08:33:38*]
+ **PSSailpoint.PasswordPolicies 2.1.35**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*09/10/2026 08:33:20*]
+ **PSSailpoint.PasswordManagement 2.1.35**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*09/10/2026 08:33:06*]
+ **PSSailpoint.PasswordDictionary 2.1.35**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*09/10/2026 08:32:49*]
+ **PSSailpoint.PasswordConfiguration 2.1.35**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*09/10/2026 08:32:36*]
+ **PSSailpoint.ParameterStorage 2.1.35**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*09/10/2026 08:32:18*]
+ **PSSailpoint.OrgConfig 2.1.35**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*09/10/2026 08:32:02*]
+ **PSSailpoint.OauthClients 2.1.35**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*09/10/2026 08:31:53*]
+ **PSSailpoint.Notifications 2.1.35**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*09/10/2026 08:31:35*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.35**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*09/10/2026 08:31:22*]
+ **PSSailpoint.MultiHostIntegration 2.1.35**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*09/10/2026 08:31:09*]
+ **PSSailpoint.MfaConfiguration 2.1.35**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*09/10/2026 08:30:56*]
+ **PSSailpoint.ManagedClusters 2.1.35**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*09/10/2026 08:30:42*]
+ **PSSailpoint.ManagedClusterTypes 2.1.35**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*09/10/2026 08:30:27*]
+ **PSSailpoint.ManagedClients 2.1.35**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*09/10/2026 08:30:10*]
+ **PSSailpoint.MachineIdentitiesLifecycleActions 2.1.35**  - PSSailpoint.MachineIdentitiesLifecycleActions - the PowerShell module for Identity Security Cloud API - Machine Identity Lifecycle Actions [*09/10/2026 08:29:55*]
+ **PSSailpoint.MachineIdentities 2.1.35**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*09/10/2026 08:29:39*]
+ **PSSailpoint.MachineClassificationConfig 2.1.35**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*09/10/2026 08:29:22*]
+ **PSSailpoint.MachineAccounts 2.1.35**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*09/10/2026 08:29:09*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.35**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*09/10/2026 08:28:58*]
+ **PSSailpoint.MachineAccountMappings 2.1.35**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*09/10/2026 08:28:36*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.35**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*09/10/2026 08:28:25*]
+ **PSSailpoint.MachineAccountClassify 2.1.35**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*09/10/2026 08:28:00*]
+ **PSSailpoint.LifecycleStates 2.1.35**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*09/10/2026 08:27:51*]
+ **PSSailpoint.Launchers 2.1.35**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*09/10/2026 08:27:42*]
+ **PSSailpoint.JitActivations 2.1.35**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*09/10/2026 08:27:21*]
+ **PSSailpoint.JitAccess 2.1.35**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*09/10/2026 08:27:11*]
+ **PSSailpoint.Intelligence 2.1.35**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*09/10/2026 08:26:55*]
+ **PSSailpoint.IdentityProfiles 2.1.35**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*09/10/2026 08:26:40*]
+ **PSSailpoint.IdentityHistory 2.1.35**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*09/10/2026 08:26:20*]
+ **PSSailpoint.IdentityAttributes 2.1.35**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*09/10/2026 08:25:55*]
+ **PSSailpoint.Identities 2.1.35**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*09/10/2026 08:25:27*]
+ **PSSailpoint.Icons 2.1.35**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*09/10/2026 08:25:08*]
+ **PSSailpoint.IaiRoleMining 2.1.35**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*09/10/2026 08:24:48*]
+ **PSSailpoint.IaiRecommendations 2.1.35**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*09/10/2026 08:24:31*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.1.35**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*09/10/2026 08:24:17*]
+ **PSSailpoint.IaiOutliers 2.1.35**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*09/10/2026 08:23:59*]
+ **PSSailpoint.IaiCommonAccess 2.1.35**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*09/10/2026 08:23:49*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.35**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*09/10/2026 08:23:35*]
+ **PSSailpoint.GovernanceGroups 2.1.35**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*09/10/2026 08:23:23*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.35**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*09/10/2026 08:23:09*]
+ **PSSailpoint.Entitlements 2.1.35**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*09/10/2026 08:22:51*]
+ **PSSailpoint.EntitlementConnections 2.1.35**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*09/10/2026 08:22:36*]
+ **PSSailpoint.Dimensions 2.1.35**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*09/10/2026 08:22:13*]
+ **PSSailpoint.DeclassifySource 2.1.35**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*09/10/2026 08:21:51*]
+ **PSSailpoint.DataSegmentation 2.1.35**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*09/10/2026 08:21:28*]
+ **PSSailpoint.DataAccessSecurity 2.1.35**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*09/10/2026 08:21:08*]
+ **PSSailpoint.CustomUserLevels 2.1.35**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*09/10/2026 08:20:48*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.35**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*09/10/2026 08:20:32*]
+ **PSSailpoint.Connectors 2.1.35**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*09/10/2026 08:20:00*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.35**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*09/10/2026 08:19:44*]
+ **PSSailpoint.ConnectorCustomizers 2.1.35**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*09/10/2026 08:19:28*]
+ **PSSailpoint.ConfigurationHub 2.1.35**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*09/10/2026 08:19:09*]
+ **PSSailpoint.ClassifySource 2.1.35**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*09/10/2026 08:18:51*]
+ **PSSailpoint.Certifications 2.1.35**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*09/10/2026 08:18:35*]
+ **PSSailpoint.CertificationSummaries 2.1.35**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*09/10/2026 08:18:18*]
+ **PSSailpoint.CertificationCampaigns 2.1.35**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*09/10/2026 08:17:57*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.35**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*09/10/2026 08:17:30*]
+ **PSSailpoint.BusinessApplications 2.1.35**  - PSSailpoint.BusinessApplications - the PowerShell module for Identity Security Cloud API - Business Applications [*09/10/2026 08:17:11*]
+ **PSSailpoint.Branding 2.1.35**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*09/10/2026 08:16:49*]
+ **PSSailpoint.AuthUsers 2.1.35**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*09/10/2026 08:16:31*]
+ **PSSailpoint.AuthProfile 2.1.35**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*09/10/2026 08:16:18*]
+ **PSSailpoint.Apps 2.1.35**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*09/10/2026 08:16:11*]
+ **PSSailpoint.Approvals 2.1.35**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*09/10/2026 08:16:02*]
+ **PSSailpoint.ApplicationDiscovery 2.1.35**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*09/10/2026 08:15:55*]
+ **PSSailpoint.ApiUsage 2.1.35**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*09/10/2026 08:15:48*]
+ **PSSailpoint.Accounts 2.1.35**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*09/10/2026 08:15:40*]
+ **PSSailpoint.AccountUsages 2.1.35**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*09/10/2026 08:15:23*]
+ **PSSailpoint.AccountDeletionRequests 2.1.35**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*09/10/2026 08:15:13*]
+ **PSSailpoint.AccountAggregations 2.1.35**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*09/10/2026 08:15:04*]
+ **PSSailpoint.AccountActivities 2.1.35**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*09/10/2026 08:14:43*]
+ **PSSailpoint.AccessRequests 2.1.35**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*09/10/2026 08:14:32*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.35**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*09/10/2026 08:14:06*]
+ **PSSailpoint.AccessRequestApprovals 2.1.35**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*09/10/2026 08:13:49*]
+ **PSSailpoint.AccessProfiles 2.1.35**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*09/10/2026 08:13:30*]
+ **PSSailpoint.AccessModelMetadata 2.1.35**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*09/10/2026 08:13:08*]
...
+ **[VMware.CloudFoundation.InstanceRecovery 9.1.0.1003](https://vmware.github.io/powershell-module-for-vmware-cloud-foundation-instance-recovery)**  - PowerShell Module for VMware Cloud Foundation Instance Recovery [*07/08/2026 09:31:21*]
...
+ **[PSWriteOffice 3.0.6](https://github.com/EvotecIT/PSWriteOffice)**  - PowerShell module to create, convert, read, inspect, and export Office, PDF, iWork, OneNote, OpenDocument, email, Markdown, AsciiDoc, LaTeX, CSV, Visio, and Confluence content without Microsoft Office installed. Powered by OfficeIMO.*. [*09/09/2026 14:59:45*]
...
+ **[PSDevOpsBackup 1.0.2.0](https://github.com/mgajda83/PSDevOpsBackup)**  - PowerShell module for backup DevOps repos. [*06/26/2026 13:02:12*]
...
*Updated: Thursday, 10 September 2026 23:25:49 UTC*
