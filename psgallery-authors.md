...
+ **PSSailpoint.NERMV2025 2.1.14**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*08/12/2026 08:55:04*]
+ **PSSailpoint.NERM 2.1.14**  - PSSailpoint.NERM - the PowerShell module for NERM API [*08/12/2026 08:54:56*]
+ **PSSailpoint.Workflows 2.1.14**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*08/12/2026 08:54:52*]
+ **PSSailpoint.WorkReassignment 2.1.14**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*08/12/2026 08:54:47*]
+ **PSSailpoint.WorkItems 2.1.14**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*08/12/2026 08:54:41*]
+ **PSSailpoint.UiMetadata 2.1.14**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*08/12/2026 08:54:35*]
+ **PSSailpoint.Triggers 2.1.14**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*08/12/2026 08:54:30*]
+ **PSSailpoint.Transforms 2.1.14**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*08/12/2026 08:54:26*]
+ **PSSailpoint.TenantContext 2.1.14**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*08/12/2026 08:54:22*]
+ **PSSailpoint.Tenant 2.1.14**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*08/12/2026 08:54:17*]
+ **PSSailpoint.TaskManagement 2.1.14**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*08/12/2026 08:54:13*]
+ **PSSailpoint.Tags 2.1.14**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*08/12/2026 08:54:09*]
+ **PSSailpoint.TaggedObjects 2.1.14**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*08/12/2026 08:54:05*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.14**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*08/12/2026 08:54:01*]
+ **PSSailpoint.SpConfig 2.1.14**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*08/12/2026 08:53:56*]
+ **PSSailpoint.Sources 2.1.14**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*08/12/2026 08:53:52*]
+ **PSSailpoint.SourceUsages 2.1.14**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*08/12/2026 08:53:48*]
+ **PSSailpoint.SodViolations 2.1.14**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*08/12/2026 08:53:44*]
+ **PSSailpoint.SodPolicies 2.1.14**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*08/12/2026 08:53:39*]
+ **PSSailpoint.SodControls 2.1.14**  - PSSailpoint.SodControls - the PowerShell module for Identity Security Cloud API - SOD Controls [*08/12/2026 08:53:35*]
+ **PSSailpoint.SimIntegrations 2.1.14**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*08/12/2026 08:53:31*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.14**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*08/12/2026 08:53:22*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.14**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*08/12/2026 08:53:13*]
+ **PSSailpoint.Segments 2.1.14**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*08/12/2026 08:52:57*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.14**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*08/12/2026 08:52:48*]
+ **PSSailpoint.Search 2.1.14**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*08/12/2026 08:52:30*]
+ **PSSailpoint.ScheduledSearch 2.1.14**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*08/12/2026 08:52:15*]
+ **PSSailpoint.SavedSearch 2.1.14**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*08/12/2026 08:52:05*]
+ **PSSailpoint.Roles 2.1.14**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*08/12/2026 08:51:48*]
+ **PSSailpoint.RolePropagation 2.1.14**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*08/12/2026 08:51:35*]
+ **PSSailpoint.RequestableObjects 2.1.14**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*08/12/2026 08:51:08*]
+ **PSSailpoint.ReportsDataExtraction 2.1.14**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*08/12/2026 08:50:49*]
+ **PSSailpoint.PublicMachineIdentities 2.1.14**  - PSSailpoint.PublicMachineIdentities - the PowerShell module for Identity Security Cloud API - Public Machine Identities [*08/12/2026 08:50:21*]
+ **PSSailpoint.PublicIdentities 2.1.14**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*08/12/2026 08:49:29*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.14**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*08/12/2026 08:49:01*]
+ **PSSailpoint.PrivilegeCriteria 2.1.14**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*08/12/2026 08:48:43*]
+ **PSSailpoint.PasswordSyncGroups 2.1.14**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*08/12/2026 08:48:35*]
+ **PSSailpoint.PasswordPolicies 2.1.14**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*08/12/2026 08:48:31*]
+ **PSSailpoint.PasswordManagement 2.1.14**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*08/12/2026 08:48:26*]
+ **PSSailpoint.PasswordDictionary 2.1.14**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*08/12/2026 08:48:22*]
+ **PSSailpoint.PasswordConfiguration 2.1.14**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*08/12/2026 08:48:18*]
+ **PSSailpoint.ParameterStorage 2.1.14**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*08/12/2026 08:48:13*]
+ **PSSailpoint.OrgConfig 2.1.14**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*08/12/2026 08:48:09*]
+ **PSSailpoint.Notifications 2.1.14**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*08/12/2026 08:48:00*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.14**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*08/12/2026 08:47:56*]
+ **PSSailpoint.MultiHostIntegration 2.1.14**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*08/12/2026 08:47:52*]
+ **PSSailpoint.MfaConfiguration 2.1.14**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*08/12/2026 08:47:47*]
+ **PSSailpoint.ManagedClusters 2.1.14**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*08/12/2026 08:47:43*]
+ **PSSailpoint.ManagedClusterTypes 2.1.14**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*08/12/2026 08:47:39*]
+ **PSSailpoint.ManagedClients 2.1.14**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*08/12/2026 08:47:34*]
+ **PSSailpoint.MachineIdentitiesLifecycleActions 2.1.14**  - PSSailpoint.MachineIdentitiesLifecycleActions - the PowerShell module for Identity Security Cloud API - Machine Identity Lifecycle Actions [*08/12/2026 08:47:30*]
+ **PSSailpoint.MachineIdentities 2.1.14**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*08/12/2026 08:47:25*]
+ **PSSailpoint.MachineClassificationConfig 2.1.14**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*08/12/2026 08:47:21*]
+ **PSSailpoint.MachineAccounts 2.1.14**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*08/12/2026 08:47:17*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.14**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*08/12/2026 08:47:12*]
+ **PSSailpoint.MachineAccountMappings 2.1.14**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*08/12/2026 08:47:07*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.14**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*08/12/2026 08:46:49*]
+ **PSSailpoint.MachineAccountClassify 2.1.14**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*08/12/2026 08:46:41*]
+ **PSSailpoint.LifecycleStates 2.1.14**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*08/12/2026 08:46:36*]
+ **PSSailpoint.Launchers 2.1.14**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*08/12/2026 08:46:27*]
+ **PSSailpoint.JitActivations 2.1.14**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*08/12/2026 08:46:13*]
+ **PSSailpoint.JitAccess 2.1.14**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*08/12/2026 08:46:05*]
+ **PSSailpoint.Intelligence 2.1.14**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*08/12/2026 08:45:44*]
+ **PSSailpoint.IdentityProfiles 2.1.14**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*08/12/2026 08:45:28*]
+ **PSSailpoint.IdentityHistory 2.1.14**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*08/12/2026 08:45:10*]
+ **PSSailpoint.IdentityAttributes 2.1.14**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*08/12/2026 08:44:45*]
+ **PSSailpoint.Icons 2.1.14**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*08/12/2026 08:44:07*]
+ **PSSailpoint.IaiRoleMining 2.1.14**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*08/12/2026 08:43:52*]
+ **PSSailpoint.IaiRecommendations 2.1.14**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*08/12/2026 08:43:43*]
+ **PSSailpoint.IaiOutliers 2.1.14**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*08/12/2026 08:43:20*]
+ **PSSailpoint.IaiCommonAccess 2.1.14**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*08/12/2026 08:43:07*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.14**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*08/12/2026 08:42:52*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.14**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*08/12/2026 08:42:30*]
+ **PSSailpoint.EntitlementConnections 2.1.14**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*08/12/2026 08:42:12*]
+ **PSSailpoint.Dimensions 2.1.14**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*08/12/2026 08:42:05*]
+ **PSSailpoint.DeclassifySource 2.1.14**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*08/12/2026 08:41:57*]
+ **PSSailpoint.DataSegmentation 2.1.14**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*08/12/2026 08:41:51*]
+ **PSSailpoint.CustomUserLevels 2.1.14**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*08/12/2026 08:41:22*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.14**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*08/12/2026 08:41:17*]
+ **PSSailpoint.CustomForms 2.1.14**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*08/12/2026 08:41:06*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.14**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*08/12/2026 08:40:57*]
+ **PSSailpoint.ConnectorCustomizers 2.1.14**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*08/12/2026 08:40:46*]
+ **PSSailpoint.ConfigurationHub 2.1.14**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*08/12/2026 08:40:28*]
+ **PSSailpoint.ClassifySource 2.1.14**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*08/12/2026 08:40:14*]
+ **PSSailpoint.Certifications 2.1.14**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*08/12/2026 08:40:07*]
+ **PSSailpoint.CertificationSummaries 2.1.14**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*08/12/2026 08:39:40*]
+ **PSSailpoint.CertificationCampaigns 2.1.14**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*08/12/2026 08:39:30*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.14**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*08/12/2026 08:39:08*]
+ **PSSailpoint.Branding 2.1.14**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*08/12/2026 08:39:04*]
+ **PSSailpoint.AuthUsers 2.1.14**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*08/12/2026 08:38:57*]
+ **PSSailpoint.AuthProfile 2.1.14**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*08/12/2026 08:38:53*]
+ **PSSailpoint.Apps 2.1.14**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*08/12/2026 08:38:39*]
+ **PSSailpoint.Approvals 2.1.14**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*08/12/2026 08:38:34*]
+ **PSSailpoint.ApplicationDiscovery 2.1.14**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*08/12/2026 08:38:29*]
+ **PSSailpoint.ApiUsage 2.1.14**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*08/12/2026 08:38:24*]
+ **PSSailpoint.Accounts 2.1.14**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*08/12/2026 08:38:20*]
+ **PSSailpoint.AccountUsages 2.1.14**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*08/12/2026 08:38:08*]
+ **PSSailpoint.AccountDeletionRequests 2.1.14**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*08/12/2026 08:37:53*]
+ **PSSailpoint.AccountAggregations 2.1.14**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*08/12/2026 08:37:31*]
+ **PSSailpoint.AccountActivities 2.1.14**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*08/12/2026 08:37:07*]
+ **PSSailpoint.AccessRequests 2.1.14**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*08/12/2026 08:36:45*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.14**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*08/12/2026 08:36:20*]
+ **PSSailpoint.AccessRequestApprovals 2.1.14**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*08/12/2026 08:35:51*]
+ **PSSailpoint.AccessProfiles 2.1.14**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*08/12/2026 08:35:21*]
+ **PSSailpoint.AccessModelMetadata 2.1.14**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*08/12/2026 08:34:53*]
...
+ **[PSPublishModule 3.0.105](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*08/12/2026 17:13:05*]
+ **[PSWriteOffice 3.0.4](https://github.com/EvotecIT/PSWriteOffice)**  - PowerShell module to create, convert, read, inspect, and export Office, PDF, OpenDocument, email, Markdown, AsciiDoc, LaTeX, CSV, Visio, and Confluence content without Microsoft Office installed. Powered by OfficeIMO.*. [*08/12/2026 07:06:54*]
...
+ **[DJScratchLooper 1.0.0.4](https://www.youtube.com/shorts/bAkoUGaa8W0)**  - PowerShell module for launching a WPF DJ Scratch Looper interface. [*08/11/2026 17:27:37*]
...
*Updated: Wednesday, 12 August 2026 22:25:24 UTC*
