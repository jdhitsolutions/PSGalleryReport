...
+ [Przemyslaw Klys](#Przemyslaw-Klys) (32)
...
+ **[GoogleFonts 1.0.116](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*03/19/2026 00:37:10*]
...
+ **[chocolatey 0.10.4](https://github.com/chocolatey-community/Chocolatey/)**  - This is an unofficial module with DSC resource to Install and configure Chocolatey. [*12/05/2025 18:25:58*]
...
+ **[NetApp.ONTAP 9.18.1.2601](https://mysupport.netapp.com/site/tools/tool-eula/ontap-powershell-toolkit)**  - NetApp.ONTAP PowerShell Toolkit. The ONTAP 9.18.1 PowerShell Toolkit provides end-to-end automation and enables more efficient and scalable administration of NetApp storage. This module contains over 2340 PowerShell cmdlets to help you automate ONTAP administration on FAS and AFF systems, commodity hardware, and the cloud. This toolkit also supports REST API with 9.10 and later version of ONTAP. The toolkit also provides cross-platform support for Windows, Ubuntu, Red Hat Enterprise Linux (RHEL), and macOS. [*02/02/2026 09:29:03*]
...
+ **[AsBuiltReport.Core 1.6.2](https://github.com/AsBuiltReport/AsBuiltReport.Core)**  - A PowerShell module which provides the core framework for generating As-Built documentation for many common datacentre systems. [*02/18/2026 21:04:47*]
+ **[AsBuiltReport.Microsoft.Azure 0.2.0](https://github.com/AsBuiltReport/AsBuiltReport.Microsoft.Azure)**  - A PowerShell module to generate an as built report on the configuration of Microsoft Azure. [*02/10/2026 23:50:06*]
+ **[AsBuiltReport.VMware.vSphere 1.3.6](https://github.com/AsBuiltReport/AsBuiltReport.VMware.vSphere)**  - A PowerShell module to generate an as built report on the configuration of VMware vSphere. [*08/24/2025 04:49:59*]
+ **[AsBuiltReport.VMware.ESXi 1.1.4](https://github.com/AsBuiltReport/AsBuiltReport.VMware.ESXi)**  - A PowerShell module to generate an as built report on the configuration of VMware ESXi servers. [*08/22/2025 06:44:15*]
...
+ **[PowerShellBuild 0.8.0](https://github.com/psake/PowerShellBuild)**  - A common psake and Invoke-Build task module for PowerShell projects [*02/21/2026 00:43:06*]
...
+ **[AsBuiltReport.Microsoft.AD 0.9.11](https://github.com/AsBuiltReport/AsBuiltReport.Microsoft.AD)**  - A PowerShell module to generate an as built report on the configuration of Microsoft AD. [*02/21/2026 17:42:05*]
+ **[AsBuiltReport.Veeam.VBR 0.8.26](https://github.com/AsBuiltReport/AsBuiltReport.Veeam.VBR)**  - A PowerShell module to generate an as built report on the configuration of Veeam VBR. [*02/20/2026 18:25:00*]
...
+ **[OSDCloud 26.3.12.1](https://github.com/OSDeploy/OSDCloud)**  - OSDCloud PowerShell Module for OS Deployment in the Cloud [*03/12/2026 21:19:53*]
+ **[OSD 26.2.27.1](https://github.com/OSDeploy/OSD)**  - OSD PowerShell Module for Windows Deployment [*02/28/2026 05:27:39*]
...
*Updated: Monday, 23 March 2026 21:57:53 UTC*
