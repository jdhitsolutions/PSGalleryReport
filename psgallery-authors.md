...
+ [Roman Kuzmin](#Roman-Kuzmin) (2)
+ [Eric Jenkins](#Eric-Jenkins) (1)
+ [Mike Roberts](#Mike-Roberts) (1)
+ [Freddy Kristiansen](#Freddy-Kristiansen) (1)
+ [Donovan Brown (@DonovanBrown) Sebastian Schütze (@RazorSPoint)](#Donovan-Brown-(DonovanBrown)-Sebastian-Schütze-(RazorSPoint)) (1)
...
+ [Krisztian Buscsei](#Krisztian-Buscsei) (1)
+ [Ajay Arora](#Ajay-Arora) (1)
+ [Marco van Gaal](#Marco-van-Gaal) (1)
+ [Oliver Lipkau <oliver@lipkau.net>](#Oliver-Lipkau-<oliverlipkaunet>) (1)
+ [Jeff Hicks](#Jeff-Hicks) (1)
+ [Lukasz Burak](#Lukasz-Burak) (1)
+ [Chris Masters](#Chris-Masters) (1)
...
+ **[TableUI 1.9.0](https://github.com/jjcarrier/PS-TableUI)**  - A simple interface for making selections on an array of PS objects [*08/17/2024 22:09:55*]
...
+ **[Evergreen 2409.1419](https://stealthpuppy.com/evergreen/)**  - Create evergreen Windows image builds with the latest versions of applications. Evergreen is a simple PowerShell module that retrieves the latest version numbers and download URLs for various software products directly from the vendor source. [*09/26/2024 01:10:36*]
+ **[VcRedist 4.1.498](https://vcredist.com/)**  - A module for lifecycle management of the Microsoft Visual C++ Redistributables. VcRedist downloads, installs and uninstalls the supported (and unsupported) Redistributables. Use for local install, gold image creation and update, or importing as applications into the Microsoft Deployment Toolkit, Microsoft Configuration Manager or Microsoft Intune. Supports passive and silent installs, and uninstalls of the Visual C++ Redistributables. [*07/25/2024 23:41:44*]
...
+ **[Mdbc 6.7.3](https://github.com/nightroman/Mdbc)**  - Mdbc module - MongoDB Cmdlets for PowerShell [*08/27/2024 12:44:42*]
...
+ **[WindowsDefenderDsc 2.2.0](https://github.com/jcwalker/WindowsDefenderDsc)**  - Manages the security mitigations available in the Windows Defender Security Center [*11/10/2021 21:20:51*]

## Mike Roberts

+ **[PSFolderSize 1.7.1](https://github.com/gngrninja/PSFolderSize/)**  - This module enables you to gather folder size information, and output the results easily in various ways. GitHub Repo: https://github.com/gngrninja/PSFolderSize [*10/10/2020 22:25:06*]

## Freddy Kristiansen

+ **[BcContainerHelper 6.0.24](https://github.com/microsoft/navcontainerhelper)**  - PowerShell module, which makes it easier to work with Business Central Containers on Docker. [*09/25/2024 06:08:33*]

## Donovan Brown (@DonovanBrown) Sebastian Schütze (@RazorSPoint)

+ **[VSTeam 7.15.2](https://github.com/MethodsAndPractices/vsteam)**  - Adds functionality for working with Azure DevOps and Team Foundation Server. [*10/24/2023 08:21:47*]
...
+ **[OSD 24.9.18.1](https://github.com/OSDeploy/OSD)**  - 2024 Workplace Ninjas Update [*09/18/2024 19:14:00*]

## Krisztian Buscsei

+ **[WifiTools 1.8.4](https://github.com/buscseik/WifiTools/)**  - A set of tools that can simplify handle Wi-Fi profiles, connection. Also additional tools that closely related to networking and Wi-Fi. [*12/29/2022 22:01:01*]

## Ajay Arora

+ **TaskRunner 1.0**  - This module can be used to run scheduled tasks and synchronously wait for them to complete. [*02/17/2016 23:35:47*]

## Marco van Gaal

+ **[Proxx.SNMP 1.1.1.6](http://www.proxx.nl/Module/SNMP/)**  - SNMP Functions for Get and Walk both pipeline aware [*12/04/2020 08:45:06*]

## Oliver Lipkau <oliver@lipkau.net>

+ **[PsIni 3.1.3](http://lipkau.github.io/PsIni)**  - Convert hashtable to INI file and back. @ http://lipkau.github.io/PsIni/ [*10/18/2022 10:11:35*]
...
+ **[psyml 1.0.0](https://github.com/bitrut94/psyml)**  - YAML PowerShell module [*02/04/2021 19:30:29*]

## Chris Masters

+ **[core 1.9.4.1](https://github.com/masters274/core)**  - Module with various generic functions that could be used in any script [*09/26/2024 12:51:46*]

*Updated: Sunday, 29 September 2024 02:15:59 UTC*
