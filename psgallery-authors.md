...
+ [Jonathan Colon](#Jonathan-Colon) (6)
+ [Brandon Olin](#Brandon-Olin) (6)
...
+ **[ADEssentials 0.0.266](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*10/15/2025 11:45:09*]
...
+ **[GoogleFonts 1.0.74](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*10/15/2025 08:38:20*]
...
+ **[PSOpenAI 4.40.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*10/12/2025 15:02:08*]
...
+ **[UncommonSense.Nrc 0.1.0.39](https://github.com/jhoek/UncommonSense.Nrc)**  - PowerShell module for listing NRC articles [*10/12/2025 09:16:13*]
...
+ **[AdminToolbox 12.0.0.47](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*10/14/2025 03:22:24*]
+ **[AdminToolbox.SecOps 1.5.0.34](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Security Operations and Investigations [*10/14/2025 03:21:09*]
+ **[AdminToolbox.FortiWizard 2.22.0.59](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*10/14/2025 03:21:06*]
+ **[AdminToolbox.VMWareAutomate 4.9.0.88](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*10/14/2025 03:20:01*]
+ **[AdminToolbox.Remoting 1.10.1.34](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*10/14/2025 03:19:57*]
+ **[AdminToolbox.Office365 5.4.1.13](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*10/14/2025 03:19:53*]
+ **[AdminToolbox.Networking 2.24.0.5](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*10/14/2025 03:19:49*]
+ **[AdminToolbox.MSGraph 1.5.0.85](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*10/14/2025 03:19:44*]
+ **[AdminToolbox.Fun 1.7.0.88](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*10/14/2025 03:19:40*]
+ **[AdminToolbox.FileManagement 1.18.0.6](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*10/14/2025 03:19:37*]
+ **[AdminToolbox.FFTools 4.17.0.88](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*10/14/2025 03:19:33*]
+ **[AdminToolbox.Exchange 1.10.0.88](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*10/14/2025 03:19:29*]
+ **[AdminToolbox.EndpointManagement 4.15.1.15](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*10/14/2025 03:19:24*]
+ **[AdminToolbox.ActiveDirectory 1.12.0.50](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*10/14/2025 03:19:20*]
...
+ **[PSFramework 1.13.414](http://psframework.org/)**  - General Scripting Framework, providing PowerShell-specific infrastructure for other modules. [*10/14/2025 07:18:21*]
...
+ **[AutomatedLabWorker 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - This module encapsulates all the work activities to prepare the lab [*08/18/2025 12:09:43*]
+ **[AutomatedLabTest 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - The module is for testing AutomatedLab [*08/18/2025 12:09:31*]
+ **[AutomatedLabNotifications 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - This module uses pluggable providers to send various kinds of notifications for AutomatedLab [*08/18/2025 12:09:25*]
+ **[AutomatedLabDefinition 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - The module creates the lab and machine definition for the AutomatedLab module saved in XML [*08/18/2025 12:09:19*]
+ **[AutomatedLabCore 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - Automated lab environments with ease - Linux and Windows, Hyper-V and Azure [*08/18/2025 12:09:13*]
+ **[AutomatedLab.Ships 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - The SHiPS module to mount a lab drive containing all lab data [*08/18/2025 12:09:04*]
+ **[AutomatedLab.Recipe 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - This module enables easy to use recipes to create lab environments [*08/18/2025 12:08:58*]
+ **[AutomatedLab 5.59.0](https://github.com/AutomatedLab/AutomatedLab)**  - Automated lab environments with ease - Linux and Windows, Hyper-V and Azure [*08/18/2025 12:08:52*]
...
+ **[chocolatey 0.9.0](https://github.com/chocolatey-community/Chocolatey/)**  - This is an unofficial module with DSC resource to Install and configure Chocolatey. [*10/14/2025 10:46:16*]
...
+ **[Veeam.Diagrammer 0.6.35](https://github.com/rebelinux/Veeam.Diagrammer)**  - A PowerShell module to generate an Veeam Backup & Replication infrastructure diagram [*10/14/2025 00:21:02*]
+ **[Diagrammer.Core 0.2.31](https://github.com/rebelinux/Diagrammer.Core)**  - A PowerShell module which provides the core framework for generating Diagrams for many common datacentre systems. [*10/13/2025 23:29:59*]
+ **[AsBuiltReport.Veeam.VBR 0.8.23](https://github.com/AsBuiltReport/AsBuiltReport.Veeam.VBR)**  - A PowerShell module to generate an as built report on the configuration of Veeam VBR. [*07/30/2025 00:07:33*]
+ **[AsBuiltReport.Microsoft.AD 0.9.6](https://github.com/AsBuiltReport/AsBuiltReport.Microsoft.AD)**  - A PowerShell module to generate an as built report on the configuration of Microsoft AD. [*07/23/2025 21:27:24*]
+ **[Diagrammer.Microsoft.AD 0.2.17](https://github.com/rebelinux/Diagrammer.Microsoft.AD)**  - A PowerShell module to generate an as built report on the configuration of Microsoft AD. [*07/23/2025 21:11:55*]
...
*Updated: Thursday, 16 October 2025 09:51:22 UTC*
