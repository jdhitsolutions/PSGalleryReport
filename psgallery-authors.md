...
+ [James Brundage](#James-Brundage) (27)
+ [Michael Haken](#Michael-Haken) (26)
+ [mkht](#mkht) (23)
+ [Michal Gajda](#Michal-Gajda) (22)
...
+ [Chrissy LeMaire](#Chrissy-LeMaire) (16)
+ [Warren Frame](#Warren-Frame) (16)
+ [Jordan Borean](#Jordan-Borean) (15)
+ [jakub.pawlowski](#jakubpawlowski) (15)
...
+ **[PSEventViewer 3.4.0](https://github.com/EvotecIT/PSEventViewer)**  - Simple module allowing parsing of event logs. Has its own quirks... [*02/21/2026 14:17:04*]
...
+ **GraphEssentials 0.0.54**  - GraphEssentials is a PowerShell module that helps with Office 365 / Azure AD using mostly Graph [*01/22/2026 09:41:40*]
...
+ **[MailDaemon 1.2.14](https://github.com/PowershellFrameworkCollective/MailDaemon)**  - Mail Daemon as PowerShell Module [*02/20/2026 11:17:40*]
...
+ **[GoogleFonts 1.0.114](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*03/06/2026 08:38:11*]
+ **[GitHub 0.42.0](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with GitHub, both interactively and via automation. [*02/26/2026 00:06:08*]
...
+ **[PureStorage.CBS.AVS 1.1.459](https://support.purestorage.com/Pure_Cloud_Block_Store/Azure_VMware_Solution_and_Cloud_Block_Store_Implementation_Guide)**  - Pure Storage FlashArray AVS Plugin. [*02/23/2026 20:16:16*]
...
+ **[UncommonSense.Parool 0.0.21](https://github.com/jhoek/UncommonSense.Parool)**  - PowerShell module for listing Parool articles [*02/13/2026 09:04:26*]
...
+ **[Whiskey 0.64.0](https://github.com/webmd-health-services/Whiskey)**  - Continuous Integration/Continuous Delivery module. [*03/06/2026 18:05:16*]
...
+ **[OpenAuthenticode 0.6.3](https://github.com/jborean93/PowerShell-OpenAuthenticode)**  - Cross platform PowerShell implementation of Authenticode signing and verification [*09/12/2025 00:05:39*]
+ **[Ctypes 0.3.0](https://github.com/jborean93/PowerShell-ctypes)**  - PowerShell implemtation of the Python's ctypes library for PInvoke methods [*06/12/2025 14:24:07*]
+ **[PSToml 0.4.0](https://github.com/jborean93/PSToml)**  - TOML parser and writer for PowerShell [*03/12/2025 02:11:50*]
+ **[PSOpenAD 0.6.0](https://github.com/jborean93/PSOpenAD)**  - Cross platform module that can get/set information in Active Directory.`nSee https://github.com/jborean93/PSOpenAD for more info [*03/11/2025 23:23:39*]
...
+ **[PSIntegrity 0.1.0](https://github.com/jborean93/PSIntegrity)**  - Adds cmdlets to add/get/remote/set the mandatory integrity level on an object.
See https://github.com/jborean93/PSIntegrity for more info [*01/10/2019 01:43:55*]
...
+ **[VirtualEngine.EvergreenDsc 1.7.1](https://dev.azure.com/virtual-engine/PSRepository/_git/VirtualEngine.EvergreenDsc)**  - The VirtualEngine.EvergreenDsc module provides cmdlets and DSC resources for interacting with Virtual Engine Evergreen packages. [*08/07/2025 15:55:58*]
+ **[Lability 0.26.0](https://github.com/VirtualEngine/Lability)**  - The Lability module contains cmdlets for provisioning Hyper-V test lab and development environments. [*04/08/2025 16:26:35*]
+ **[PScribo 0.11.1](http://github.com/iainbrighton/PScribo)**  - PScribo documentation Powershell module/framework. [*03/07/2025 08:55:32*]
...
*Updated: Monday, 09 March 2026 10:06:57 UTC*
