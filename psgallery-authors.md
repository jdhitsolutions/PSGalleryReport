...
+ [Claudio Spizzi](#Claudio-Spizzi) (13)
+ [Douglas Finke](#Douglas-Finke) (13)
+ [Taylor Lee](#Taylor-Lee) (13)
+ [Pure Storage](#Pure-Storage) (13)

## Przemyslaw Klys

+ **[ADEssentials 0.0.190](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*03/07/2024 10:58:07*]
+ **[PSSharedGoods 0.0.278](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*02/29/2024 18:48:24*]
+ **[TheDashboard 0.0.22](https://github.com/EvotecIT/TheDashboard)**  - TheDashboard is a module that allows you to create a dashboard for your HTML reports [*02/29/2024 14:43:17*]
...
+ **[GPOZaurr 1.1.1](https://github.com/EvotecIT/GPOZaurr)**  - Group Policy Eater is a PowerShell module that aims to gather information about Group Policies but also allows fixing issues that you may find in them. [*02/07/2024 13:17:20*]
...
+ **[PSWriteHTML 1.17.0](https://github.com/EvotecIT/PSWriteHTML)**  - PSWriteHTML is PowerShell Module to generate beautiful HTML reports, pages, emails without any knowledge of HTML, CSS or JavaScript. To get started basics PowerShell knowledge is required. [*01/15/2024 14:08:15*]
...
+ **[O365Essentials 0.0.13](https://github.com/EvotecIT/O365Essentials)**  - A module that helps to manage some tasks on Office 365/Azure via undocumented API [*11/16/2023 19:08:42*]
+ **[PSPublishModule 2.0.11](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*11/15/2023 15:48:59*]
...
+ **[MiniGraph 1.3.16](https://github.com/FriedrichWeinmann/MiniGraph)**  - Minimal query infrastructure for interacting with MS Graph [*03/05/2024 21:01:29*]
...
+ **[PSWorkItem 1.9.0](https://github.com/jdhitsolutions/PSWorkItem)**  - A PowerShell 7 module for managing work and personal tasks or to-do items. This module uses a SQLite database to store task and category information. The module is not a full-featured project management solution, but should be fine for personal needs. The module requires a 64-bit Windows or Linux platform. [*02/24/2024 18:37:58*]
...
+ **[PSOpenAI 3.0.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*02/27/2024 09:56:39*]
...
+ **[ugit 0.4.3](https://github.com/StartAutomating/ugit)**  - ugit: Updated Git.  Git gets better with PowerShell and the Object Pipeline.

ugit is a powerful PowerShell wrapper for git that lets you extend git, automate multiple repos, and use the object pipeline. [*02/28/2024 22:30:03*]
...
+ **[EZOut 2.0.4](https://github.com/StartAutomating/EZOut)**  - Easily Author Rich Format Files to Customize PowerShell Output [*02/07/2024 20:35:08*]
+ **[HelpOut 0.5.2](https://github.com/StartAutomating/HelpOut)**  - A Helpful Toolkit for Managing PowerShell Help [*01/27/2024 19:51:13*]
...
+ **[PSAirTable 1.0.30](https://github.com/adbertram/PSAirTable)**  - PSAirTable is a module that allows you to interact with the AirTable services in a number of different ways with PowerShell. [*03/01/2024 15:28:26*]
...
+ **[UncommonSense.Trouw 0.0.26.0](https://github.com/jhoek/UncommonSense.Trouw)**  - PowerShell module for listing Trouw articles [*01/26/2024 19:15:07*]
+ **[UncommonSense.Volkskrant 0.0.46.0](https://github.com/jhoek/UncommonSense.Volkskrant)**  - PowerShell module for listing Volkskrant articles [*01/22/2024 14:21:25*]
...
+ **[UncommonSense.Parool 0.0.13](https://github.com/jhoek/UncommonSense.Parool)**  - PowerShell module for listing Parool articles [*11/05/2023 12:46:50*]
+ **[UncommonSense.Nrc 0.1.0.28](https://github.com/jhoek/UncommonSense.Nrc)**  - PowerShell module for listing NRC articles [*10/27/2023 10:17:02*]
...
+ **[Whiskey 0.60.4](https://github.com/webmd-health-services/Whiskey)**  - Continuous Integration/Continuous Delivery module. [*02/07/2024 20:18:28*]
...
+ **[BuildMasterAutomation 4.0.0](https://github.com/webmd-health-services/BuildMasterAutomation)**  - BuildMasterAutomation is a PowerShell module for working with BuildMaster web APIs. BuildMaster is an application
...
take the pain out of creating the proper web requests. [*11/17/2023 20:53:48*]
...
+ **[VirtualEngine.EvergreenDsc 1.6.0](https://dev.azure.com/virtual-engine/PSRepository/_git/VirtualEngine.EvergreenDsc)**  - The VirtualEngine.EvergreenDsc module provides cmdlets and DSC resources for interacting with Virtual Engine Evergreen packages. [*02/13/2024 10:22:33*]
...
+ **[PowerShellAI 0.9.7](https://github.com/dfinke/PowerShellAI)**  - The PowerShell AI module integrates with the OpenAI API and let's you easily access the GPT models for text completion, image generation and more. [*02/24/2024 21:32:31*]
+ **[PowerShellAIAssistant 0.2.0](https://github.com/dfinke/PowerShellAIAssistant)**  - PowerShellAIAssistant integrates OpenAI's AI Assistants into PowerShell, leveraging advanced AI capabilities in your PowerShell scripts for dynamic, intelligent automation and data processing [*02/17/2024 14:46:59*]
+ **[PowerShellAI.Functions 0.1.5](https://github.com/dfinke/PowerShellAI.Functions)**  - PowerShellAI Functions Module a PowerShell module designed to work as a bridge between PowerShell functions and OpenAI. [*12/28/2023 00:39:36*]
...
+ **[AdminToolbox 11.0.143](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*03/05/2024 14:23:54*]
+ **[AdminToolbox.FortiWizard 2.18.41](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*03/05/2024 14:21:19*]
+ **[AdminToolbox.VMWareAutomate 4.8.132](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*03/05/2024 14:19:28*]
+ **[AdminToolbox.Remoting 1.9.135](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*03/05/2024 14:19:14*]
+ **[AdminToolbox.Office365 3.1.85](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*03/05/2024 14:18:53*]
+ **[AdminToolbox.Networking 2.18.43](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*03/05/2024 14:18:27*]
+ **[AdminToolbox.MSGraph 1.2.135](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*03/05/2024 14:17:32*]
+ **[AdminToolbox.Fun 1.6.136](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*03/05/2024 14:17:20*]
+ **[AdminToolbox.FileManagement 1.16.127](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*03/05/2024 14:16:58*]
+ **[AdminToolbox.FFTools 4.16.85](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*03/05/2024 14:16:46*]
+ **[AdminToolbox.Exchange 1.9.136](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*03/05/2024 14:16:21*]
+ **[AdminToolbox.EndpointManagement 4.10.12](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*03/05/2024 14:15:49*]
+ **[AdminToolbox.ActiveDirectory 1.9.133](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*03/05/2024 14:15:21*]
...
*Updated: Friday, 08 March 2024 01:59:50 UTC*
