...
+ **PSSailpoint.WorkItems 2.0.2**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*06/26/2026 21:05:58*]
+ **PSSailpoint.UiMetadata 2.0.2**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*06/26/2026 21:05:54*]
+ **PSSailpoint.Triggers 2.0.2**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*06/26/2026 21:05:50*]
+ **PSSailpoint.Transforms 2.0.2**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*06/26/2026 21:05:46*]
...
+ **PSSailpoint.Segments 2.0.2**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*06/26/2026 21:04:48*]
+ **PSSailpoint.SearchAttributeConfiguration 2.0.2**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*06/26/2026 21:04:44*]
...
+ **PSSailpoint.PasswordPolicies 2.0.2**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*06/26/2026 21:03:44*]
...
+ **PSSailpoint.IaiRoleMining 2.0.2**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*06/26/2026 21:01:33*]
+ **PSSailpoint.IaiRecommendations 2.0.2**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*06/26/2026 21:01:28*]
...
+ **PSSailpoint.ConnectorRuleManagement 2.0.2**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*06/26/2026 20:59:31*]
...
+ **[VcfPatchScanner 1.0.0.1006](https://github.com/vmware/powershell-module-for-vcf-patch-scanner)**  - VCF Patch Scanner Module [*06/26/2026 13:18:24*]
...
*Updated: Friday, 26 June 2026 22:14:44 UTC*
