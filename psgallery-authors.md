...
+ **[PSWriteHTML 1.1.0](https://github.com/EvotecIT/PSWriteHTML)**  - PSWriteHTML is PowerShell Module to generate beautiful HTML reports, pages, emails without any knowledge of HTML, CSS or JavaScript. To get started basics PowerShell knowledge is required. [*07/25/2023 11:09:48*]
+ **[Mailozaurr 1.0.1](https://github.com/EvotecIT/MailoZaurr)**  - Mailozaurr is a PowerShell module that aims to provide SMTP, POP3, IMAP and few other ways to interact with Email. Underneath it uses MimeKit and MailKit and EmailValidation libraries written by Jeffrey Stedfast. [*07/19/2023 13:27:55*]
...
+ **[PSPublishModule 1.7.0](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*07/17/2023 19:22:53*]
...
+ **[ADEssentials 0.0.161](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*07/02/2023 09:11:18*]
...
+ **[PSTeams 2.3.0](https://github.com/EvotecIT/PSTeams)**  - PSTeams is a PowerShell Module working on Windows / Linux and Mac. It allows sending notifications to Microsoft Teams via WebHook Notifications. It's pretty flexible and provides a bunch of options. Initially, it only supported one sort of Team Cards but since version 2.X.X it supports Adaptive Cards, Hero Cards, List Cards, and Thumbnail Cards. All those new cards have their own cmdlets and the old version of creating Teams Cards stays as-is for compatibility reasons. [*06/18/2023 09:49:23*]
...
+ **[PSSharedGoods 0.0.264](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*05/23/2023 07:48:55*]
...
+ **[7ZipArchiveDsc 1.9.0](https://github.com/mkht/7ZipArchiveDsc)**  - PowerShell DSC Resource to expand an archive file to a specific path. [*06/21/2023 08:08:59*]
...
+ **[Configuration 1.5.1](https://github.com/PoshCode/Configuration)**  - A module for storing and reading configuration values, with full PS Data serialization, automatic configuration for modules and scripts, etc. [*07/18/2022 13:52:18*]
...
+ **[EZOut 2.0](https://github.com/StartAutomating/EZOut)**  - Easily Author Rich Format Files to Customize PowerShell Output [*07/20/2023 05:47:51*]
...
+ **[UncommonSense.Nrc 0.1.0.24](https://github.com/jhoek/UncommonSense.Nrc)**  - PowerShell module for listing NRC articles [*07/13/2023 08:48:22*]
...
+ **[UncommonSense.Trouw 0.0.20.0](https://github.com/jhoek/UncommonSense.Trouw)**  - PowerShell module for listing Trouw articles [*03/24/2023 11:42:28*]
+ **[UncommonSense.Parool 0.0.10](https://github.com/jhoek/UncommonSense.Parool)**  - PowerShell module for listing Parool articles [*02/21/2023 19:28:06*]
...
+ **WebRequest 0.2.0.28**  - This modules provides an overload for Invoke-WebRequest as well as Invoke-RestMethod including basic authentication and response caching [*02/08/2018 21:30:49*]
...
+ **[Arcus.Scripting.Storage.Table 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to interacting with Azure Table Storage [*07/03/2023 08:16:42*]
+ **[Arcus.Scripting.Storage.FileShare 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure file share [*07/03/2023 08:16:41*]
+ **[Arcus.Scripting.Storage.Blob 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to interacting with Azure Blob Storage [*07/03/2023 08:16:39*]
+ **[Arcus.Scripting.Storage.All 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure Storage [*07/03/2023 08:16:37*]
+ **[Arcus.Scripting.Sql 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure SQL Database Migrations [*07/03/2023 08:16:35*]
+ **[Arcus.Scripting.Security 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure security [*07/03/2023 08:16:34*]
+ **[Arcus.Scripting.LogicApps 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure Logic Apps [*07/03/2023 08:16:30*]
+ **[Arcus.Scripting.KeyVault 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure Key Vault [*07/03/2023 08:16:28*]
+ **[Arcus.Scripting.IntegrationAccount 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure Integration Account [*07/03/2023 08:16:26*]
+ **[Arcus.Scripting.DevOps 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure DevOps [*07/03/2023 08:16:25*]
+ **[Arcus.Scripting.DataFactory 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts relates to Azure Data Factory [*07/03/2023 08:16:23*]
+ **[Arcus.Scripting.ARM 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure Resource Manager [*07/03/2023 08:16:21*]
+ **[Arcus.Scripting.ApiManagement 1.1.0](https://scripting.arcus-azure.net/)**  - Scripts related to Azure API Management [*07/03/2023 08:16:16*]

## Taylor Lee

+ **[AdminToolbox 11.0.106](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*08/01/2023 14:21:58*]
+ **[AdminToolbox.FortiWizard 2.18.4](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*08/01/2023 14:20:36*]
+ **[AdminToolbox.VMWareAutomate 4.8.95](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*08/01/2023 14:19:58*]
+ **[AdminToolbox.Remoting 1.9.98](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*08/01/2023 14:19:23*]
+ **[AdminToolbox.Office365 3.1.48](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*08/01/2023 14:18:48*]
+ **[AdminToolbox.Networking 2.18.6](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*08/01/2023 14:18:11*]
+ **[AdminToolbox.MSGraph 1.2.98](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*08/01/2023 14:17:35*]
+ **[AdminToolbox.Fun 1.6.99](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*08/01/2023 14:17:01*]
+ **[AdminToolbox.FileManagement 1.15.89](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*08/01/2023 14:16:25*]
+ **[AdminToolbox.FFTools 4.16.48](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*08/01/2023 14:15:50*]
+ **[AdminToolbox.Exchange 1.9.99](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*08/01/2023 14:15:14*]
+ **[AdminToolbox.EndpointManagement 4.9.91](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*08/01/2023 14:14:38*]
+ **[AdminToolbox.ActiveDirectory 1.9.96](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*08/01/2023 14:14:02*]
...
+ **[Avanade.CoolFunctions 1.3.8](https://github.com/azurefieldnotes/Avanade.CoolFunctions)**  - Potpourri Bundle of Handy Functions [*11/20/2018 18:13:41*]
+ **[Avanade.AzureStorage 1.3.2](https://github.com/azurefieldnotes/Avanade.AzureStorage)**  - Simple wrapper methods for the Azure Storage API [*08/11/2017 06:21:16*]
+ **[IniFileModule 1.0](https://github.com/cspeers/IniFileModule)**  - Provides Reading and Writing functionality for INI files [*08/10/2017 22:24:17*]
+ **Avanade.AzureVault 1.3**  - Simple Wrappers for the Azure Key Vault REST API [*08/07/2017 16:39:19*]
+ **[Avanade.AzureAD.Graph 1.2.2](https://github.com/azurefieldnotes/Avanade.AzureAD.Graph)**  - Helper functions for working with the Azure Active Directory Graph API [*08/04/2017 01:50:47*]
+ **[Avanade.AzureAD 1.3.0](https://github.com/azurefieldnotes/Avanade.AzureAD)**  - Helper functions for obtaining tokens from Azure Active Directory [*07/21/2017 01:50:33*]
+ **[Avanade.ArmTools 1.6.4](https://github.com/azurefieldnotes/Avanade.ArmTools)**  - Simple REST Wrappers for Azure Resource Manager [*07/13/2017 20:36:00*]
+ **Avanade.KuduTools 1.0.2**  - Simple wrapper for the Kudu REST API [*07/13/2017 03:38:19*]
+ **Avanade.AsmTools 1.1**  - Simple REST Wrappers for Azure Service Management [*06/04/2017 21:00:40*]
+ **[Avanade.SecureString 1.1.2](https://github.com/azurefieldnotes/Avanade.SecureString)**  - Simple String Encryption and Decryption Functions [*04/05/2017 20:04:19*]
+ **Avanade.AzureReports 1.0.5**  - Generates a set of reports based on Azure Resource Manager and the Azure Active Directory Graph [*04/04/2017 16:53:44*]
+ **Avanade.Azure.Models 1.0.5**  - Base classes for Azure Resource Manager and Azure Active Directory Entities [*04/04/2017 16:53:21*]

*Updated: Wednesday, 02 August 2023 02:06:18 UTC*
