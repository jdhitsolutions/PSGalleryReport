...
+ [Gabriel Adrian Samfira Alessandro Pilotti](#Gabriel-Adrian-Samfira-Alessandro-Pilotti) (10)
+ [Jan Hoek](#Jan-Hoek) (10)
+ [Patrick Meinecke](#Patrick-Meinecke) (9)
+ [James Brundage](#James-Brundage) (9)
+ [Brandon Olin](#Brandon-Olin) (9)
...
+ **[MiniGraph 1.3.13](https://github.com/FriedrichWeinmann/MiniGraph)**  - Minimal query infrastructure for interacting with MS Graph [*12/03/2023 11:38:56*]
...
+ **[ClassExplorer 2.3.3](https://github.com/SeeminglyScience/ClassExplorer)**  - Quickly search the AppDomain for classes and members. [*05/03/2022 01:57:12*]
+ **[ImpliedReflection 1.0.0](https://github.com/SeeminglyScience/ImpliedReflection)**  - Explore private properties and methods as if they were public. [*01/29/2022 22:12:26*]
+ **[ScriptBlockDisassembler 1.1.0](https://github.com/SeeminglyScience/ScriptBlockDisassembler)**  - Show a C# representation of what the PowerShell compiler generates for a ScriptBlock. [*12/19/2021 21:15:07*]
+ **[ILAssembler 1.0.0](https://github.com/SeeminglyScience/ILAssembler)**  - Generate an invokable delegate from intermediate language (IL) instructions. [*10/18/2020 20:51:48*]
+ **[PSStringTemplate 0.2.0](https://github.com/SeeminglyScience/PSStringTemplate)**  - Create and render templates using the StringTemplate template engine. [*11/11/2017 18:53:13*]
+ **[EditorAstProvider 0.1.0](https://github.com/SeeminglyScience/EditorAstProvider)**  - Browse script structure like a File System. Requires VSCode or other PowerShellEditorServices enabled editor. [*10/22/2017 17:14:21*]
+ **[EditorServicesCommandSuite 0.4.0](https://github.com/SeeminglyScience/EditorServicesCommandSuite)**  - Collection of editor commands for use in PowerShell Editor Services. [*09/26/2017 02:07:30*]
+ **[EditorServicesProcess 0.2.0](https://github.com/SeeminglyScience/EditorServicesProcess)**  - Interact with the integrated console outside of Editor Services. [*07/14/2017 21:09:27*]
+ **[SSPowerShellBoilerplate 0.1.0](https://github.com/SeeminglyScience/SSPowerShellBoilerplate)**  - An opinionated Plaster template for jump starting Open Source PowerShell projects. [*07/08/2017 14:30:06*]
...
*Updated: Monday, 04 December 2023 09:51:26 UTC*
