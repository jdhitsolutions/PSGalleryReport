...
+ [Jeff Hicks](#Jeff-Hicks) (20)
+ [mkht](#mkht) (20)
+ [Friedrich Weinmann](#Friedrich-Weinmann) (16)
+ [Michael Haken](#Michael-Haken) (16)
+ [Jan Hoek](#Jan-Hoek) (15)
+ [owen.heaume](#owenheaume) (14)
+ [Mark5900](#Mark5900) (13)
+ [Taylor Lee](#Taylor-Lee) (13)
+ [Joel Bennett](#Joel-Bennett) (12)
+ [Pure Storage](#Pure-Storage) (12)
+ [Steffen Kampmann](#Steffen-Kampmann) (12)
+ [Michal Gajda](#Michal-Gajda) (11)
+ [James Brundage](#James-Brundage) (11)
+ [PSModule](#PSModule) (11)
+ [Warren Frame](#Warren-Frame) (11)
+ [Jordan Borean](#Jordan-Borean) (10)
+ [Thomas Nieto](#Thomas-Nieto) (10)
+ [Ahmad A. Ousman](#Ahmad-A-Ousman) (10)
+ [Raimund Andree Per Pedersen Jan-Hendrik Peters](#Raimund-Andree-Per-Pedersen-Jan-Hendrik-Peters) (9)
+ [Ethan Bergstrom](#Ethan-Bergstrom) (9)
+ [Adam Bertram](#Adam-Bertram) (9)
...
+ **[PowerBGInfo 0.0.4](https://github.com/EvotecIT/PowerBGInfo)**  - PowerBGInfo is a module that allows you to create background images with information about your environment. [*11/14/2024 18:16:40*]
+ **[ADEssentials 0.0.225](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*11/13/2024 10:28:06*]
+ **[PSSharedGoods 0.0.299](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*11/06/2024 16:55:16*]
...
+ **[PSBlueSky 1.2.0](https://github.com/jdhitsolutions/PSBluesky)**  - A set of PowerShell commands that use the Bluesky API. You can skeet and upload images from a PowerShell prompt. This module is written for PowerShell 7 and uses features like $PSStyle. [*11/13/2024 14:53:12*]
...
+ **[PSOpenAI 4.10.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*11/06/2024 14:45:28*]
...
+ **spec.registry.management 1.0.7**  - A module to help manage the Windows registry [*11/14/2024 13:36:55*]
+ **spec.teamviewer.utilities 1.2.1**  - A module to help manage TeamViewer [*11/14/2024 09:47:14*]
+ **spec.network.management 1.0.0**  - A module to manage windows networking. [*11/08/2024 10:28:38*]
...
+ **[AdminToolbox 11.1.0.14](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*11/13/2024 01:30:46*]
+ **[AdminToolbox.FortiWizard 2.20.1.3](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*11/13/2024 01:30:35*]
+ **[AdminToolbox.VMWareAutomate 4.9.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*11/13/2024 01:29:31*]
+ **[AdminToolbox.Remoting 1.10.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*11/13/2024 01:29:28*]
+ **[AdminToolbox.Office365 4.3.0.13](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*11/13/2024 01:29:24*]
+ **[AdminToolbox.Networking 2.21.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*11/13/2024 01:29:18*]
+ **[AdminToolbox.MSGraph 1.5.0.11](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*11/13/2024 01:29:14*]
+ **[AdminToolbox.Fun 1.7.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*11/13/2024 01:29:11*]
+ **[AdminToolbox.FileManagement 1.17.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*11/13/2024 01:29:08*]
+ **[AdminToolbox.FFTools 4.17.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*11/13/2024 01:29:04*]
+ **[AdminToolbox.Exchange 1.10.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*11/13/2024 01:29:01*]
+ **[AdminToolbox.EndpointManagement 4.11.0.14](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*11/13/2024 01:28:57*]
+ **[AdminToolbox.ActiveDirectory 1.11.1.4](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*11/13/2024 01:28:50*]
...
+ **[PsDataFactory 0.3.1](https://abbgrade.github.io/PsDataFactory/)**  - PowerShell module to generate DataFactory pipelines and datasets. [*11/07/2024 15:49:48*]
...
+ **[GitHub 0.8.14](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with the GitHub API. [*11/14/2024 10:21:11*]
+ **[PSSemVer 1.1.3](https://github.com/PSModule/PSSemVer)**  - A PowerShell module adding a SemVer compatible class and functions. [*11/13/2024 21:33:52*]
...
+ **[ProcessEx 0.4.0](https://github.com/jborean93/ProcessEx)**  - Exposes the Windows Process creation Win32 functions in PowerShell.`nSee https://github.com/jborean93/ProcessEx for more info [*11/07/2024 04:09:54*]
+ **[Yayaml 0.5.0](https://github.com/jborean93/PowerShell-Yayaml)**  - Yet Another YAML parser and writer for PowerShell [*07/11/2024 03:55:19*]
+ **[SecretManagement.DpapiNG 0.4.0](https://github.com/jborean93/SecretManagement.DpapiNG)**  - SecretManagement module for DPAPI-NG [*07/09/2024 19:12:34*]
+ **[PSToml 0.3.1](https://github.com/jborean93/PSToml)**  - TOML parser and writer for PowerShell [*01/29/2024 01:27:12*]
...
+ **[PSDetour 0.4.1](https://github.com/jborean93/PSDetour)**  - Hook Win32 APIs in PowerShell.`nSee https://github.com/jborean93/PSDetour for more info [*08/03/2023 00:25:44*]
...
+ **[AnsibleVault 0.3.0](https://github.com/jborean93/PowerShell-AnsibleVault)**  - Adds cmdlets that can be used to encrypt and decrypt and Ansible Vault in PowerShell.
See https://github.com/jborean93/PowerShell-AnsibleVault for more info [*12/02/2019 09:41:11*]
...
+ **[AnyPackage 0.8.0](https://github.com/anypackage/anypackage)**  - Use various package managers with a single set of commands. [*10/12/2024 03:15:28*]
+ **[AnyPackage.Msu 0.3.2](https://github.com/anypackage/msu)**  - Windows Msu provider for AnyPackage. [*10/11/2024 00:24:23*]
+ **[AnyPackage.Programs 0.3.2](https://github.com/anypackage/programs)**  - Windows programs provider for AnyPackage. [*10/08/2024 00:10:15*]
+ **[Scoop 0.2.1](https://github.com/ThomasNieto/Scoop)**  - An unofficial PowerShell module for Scoop. [*08/27/2024 22:06:36*]
+ **[AnyPackage.PSResourceGet 0.4.0](https://github.com/anypackage/psresourceget)**  - PSResourceGet provider for AnyPackage. [*08/15/2024 16:36:05*]
+ **[AnyPackage.Scoop 0.2.0](https://github.com/anypackage/scoop)**  - Scoop provider for AnyPackage. [*08/15/2024 16:15:45*]
+ **[AnyPackage.DotNet.Tool 0.1.0](https://github.com/anypackage/dotnet-tool)**  - .Net Tool provider for AnyPackage. [*03/25/2024 03:02:31*]
+ **[AnyPackage.ModuleFast 0.1.2](https://github.com/anypackage/modulefast)**  - ModuleFast provider for AnyPackage. [*02/07/2024 02:47:00*]
+ **[AnyPackage.Apt 0.1.0](https://github.com/anypackage/apt)**  - APT provider for AnyPackage. [*07/25/2023 01:54:04*]
+ **[AnyPackageDsc 0.1.2](https://github.com/anypackage/dsc)**  - AnyPackage DSC resources. [*07/14/2023 03:37:18*]
...
+ **[AutomatedLabTest 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - The module is for testing AutomatedLab [*08/16/2024 11:40:28*]
+ **[AutomatedLabNotifications 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - This module uses pluggable providers to send various kinds of notifications for AutomatedLab [*08/16/2024 11:40:23*]
+ **[AutomatedLabDefinition 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - The module creates the lab and machine definition for the AutomatedLab module saved in XML [*08/16/2024 11:40:14*]
+ **[AutomatedLabCore 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - Automated lab environments with ease - Linux and Windows, Hyper-V and Azure [*08/16/2024 11:40:08*]
+ **[AutomatedLab.Ships 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - The SHiPS module to mount a lab drive containing all lab data [*08/16/2024 11:39:57*]
+ **[AutomatedLab.Recipe 5.54.0](https://github.com/AutomatedLab/AutomatedLab)**  - This module enables easy to use recipes to create lab environments [*08/16/2024 11:39:52*]
...
+ **[AnyPackage.Homebrew 0.0.1](https://github.com/anypackage/Homebrew)**  - AnyPackage provider that facilitates installing Homebrew packages from any compatible repository. [*03/16/2024 17:44:27*]
...
+ **[AnyPackage.Chocolatey 0.1.3](https://github.com/AnyPackage/AnyPackage.Chocolatey)**  - AnyPackage provider that facilitates installing Chocolatey packages from any NuGet repository. [*04/06/2023 05:13:07*]
...
*Updated: Friday, 15 November 2024 09:51:10 UTC*
