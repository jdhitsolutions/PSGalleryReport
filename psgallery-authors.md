...
+ [Hewlett Packard Enterprise](#Hewlett-Packard-Enterprise) (4)
+ [nwood](#nwood) (4)
...
+ **[PSPublishModule 3.0.37](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*06/24/2026 15:29:24*]
+ **[PSParseHTML 2.0.16](https://github.com/EvotecIT/PSParseHTML)**  - Module that allows to manipulate, parse, format and optimize HTML, JavaScript and CSS [*06/23/2026 19:46:52*]
+ **[Mailozaurr 2.1.6](https://github.com/EvotecIT/MailoZaurr)**  - Mailozaurr is a PowerShell module that aims to provide SMTP, POP3, IMAP and few other ways to interact with Email. Underneath it uses MimeKit and MailKit and EmailValidation libraries written by Jeffrey Stedfast. [*06/23/2026 19:40:27*]
+ **[Transferetto 2.0.0](https://github.com/EvotecIT/Transferetto)**  - Transferetto is a PowerShell module and reusable .NET library for FTP, FTPS, SFTP, SCP, FXP, SSH commands, SSH shells, and SSH tunnels. [*06/14/2026 18:43:50*]
+ **[PowerBGInfo 1.0.3](https://github.com/EvotecIT/PowerBGInfo)**  - PowerBGInfo is a module that allows you to create background images with information about your environment. [*06/10/2026 06:51:45*]
...
+ **[AdminToolbox 12.1.0.24](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*06/23/2026 04:27:41*]
+ **[AdminToolbox.SecOps 1.6.0.24](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Security Operations and Investigations [*06/23/2026 04:26:22*]
+ **[AdminToolbox.VMWareAutomate 4.10.0.24](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*06/23/2026 04:25:09*]
+ **[AdminToolbox.Remoting 1.11.0.24](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*06/23/2026 04:25:04*]
+ **[AdminToolbox.Office365 5.5.1.18](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*06/23/2026 04:24:58*]
+ **[AdminToolbox.Fun 1.8.0.24](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*06/23/2026 04:24:42*]
+ **[AdminToolbox.FileManagement 1.21.0.7](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*06/23/2026 04:24:36*]
+ **[AdminToolbox.Exchange 1.11.0.24](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*06/23/2026 04:24:24*]
+ **[AdminToolbox.ActiveDirectory 1.14.0.11](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*06/23/2026 04:24:13*]
...
+ **[PSAnthropic 0.1.0](https://github.com/christaylorcodes/PSAnthropic)**  - PowerShell client for the Anthropic Messages API. Works with Ollama, Anthropic Cloud, and any compatible endpoint. Supports messages, streaming, tools, and images. [*03/12/2026 04:21:15*]
...
+ **[PSDepend 0.4.1](https://github.com/PowerShellOrg/PSDepend/)**  - PowerShell Dependency Handler [*06/12/2026 22:50:00*]
...
+ **[HPESmartArrayCmdlets 4.0.0.0](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : Smart Array cmdlets create an interface to HPE Smart Array controller. These cmdlets can be used to configure the Smart Array controller on only HPE ProLiant Gen10 , Gen 10 Plus, Gen 11 and Gen 12 servers. [*04/28/2025 05:19:36*]
+ **[HPEBIOSCmdlets 5.0.0.0](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : BIOS Cmdlets creates an interface to HPE BIOS ROM-Based Setup Utility (RBSU) or UEFI System Utilities. These cmdlets can be used to configure the BIOS settings on HPE ProLiant servers. [*04/28/2025 05:19:08*]
...
+ **AksHci 1.2.167**  - AKS HCI Module [*06/19/2026 23:18:59*]
+ **DownloadSdk 1.1.149**  - Download SDK Module [*06/19/2026 23:18:55*]
+ **Moc 1.2.161**  - MOC Module [*06/19/2026 23:18:43*]
+ **HNS 0.2.4**  - HNS Module [*11/21/2020 00:00:50*]

*Updated: Friday, 26 June 2026 10:44:58 UTC*
