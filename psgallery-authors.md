...
+ [Przemyslaw Klys](#Przemyslaw-Klys) (23)
+ [Warren Frame](#Warren-Frame) (6)
+ [Taylor Lee](#Taylor-Lee) (5)
+ [Dave Wyatt](#Dave-Wyatt) (4)
+ [Joel Bennett](#Joel-Bennett) (4)
...
+ [Manuel](#Manuel) (3)
+ [PSModule](#PSModule) (3)
+ [Anam Navied](#Anam-Navied) (3)
+ [JumpCloud](#JumpCloud) (3)
+ [Jeff Hicks](#Jeff-Hicks) (3)
+ [Michael Haken](#Michael-Haken) (3)
+ [2AT B.V.](#2AT-BV) (3)
+ [Raymond Piller](#Raymond-Piller) (3)
+ [Jon Carrier](#Jon-Carrier) (3)
+ [Ethan Bergstrom](#Ethan-Bergstrom) (3)
+ [Roman Kuzmin](#Roman-Kuzmin) (3)
+ [Markus Scholtes](#Markus-Scholtes) (3)
+ [owen.heaume](#owenheaume) (3)
...
+ **[GitHub 0.14.0](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with GitHub, both interactively and via automation. [*02/05/2025 13:43:54*]
...
+ **PSRedstone 2023.4.25.235**  - PSRedstone is framework designed to streamline third software installation and configuration. It is designed to make endpoint managers more agile with a Configuration Management, DevOps, and Infrastructure as Code (IaC) mentality. [*04/25/2023 02:38:31*]
+ **PSWriteLog 2023.1.13.21953**  - PSWriteLog is a tool to standardize logging without the need to use new function calls in your PowerShell scripts. Just configure the log location (or don't) and start logging with your standard Write functions. [*01/13/2023 06:07:33*]
+ **QuserObject 1.0.50**  - Query `quser.exe` and return a proper PowerShell Object. [*07/06/2021 14:17:37*]

## Jon Carrier

+ **[TableUI 1.9.1](https://github.com/jjcarrier/PS-TableUI)**  - A simple interface for making selections on an array of PS objects [*10/20/2024 16:18:08*]
+ **[WinGet-Essentials 1.12.0](https://github.com/jjcarrier/PS-WinGet-Essentials)**  - Provides cmdlets that compliment the existing WinGet CLI. Primarily, improves the user-experience for software updates and offers a convenient way to install collections of software via WinGet through the use of user-defined tags. [*08/17/2024 17:40:14*]
+ **[TextTable 1.0.2](https://github.com/jjcarrier/PS-TextTable)**  - Provides a generic toolset to convert text-based table output from various CLI programs into PowerShell objects. [*10/03/2023 15:25:39*]
...
+ **[ps2exe 1.0.15](https://github.com/MScholtes/PS2EXE)**  - Compiles Powershell scripts to executables. Overworking of the great script of Ingo Karstein with GUI support.
'Invoke-ps2exe script.ps1' (or 'ps2exe script.ps1') compiles to script.exe. Several control parameters available.
Or use Win-PS2EXE as a graphical front end to the compiler. [*01/05/2025 14:56:47*]
+ **[VirtualDesktop 1.5.9](https://github.com/MScholtes/PSVirtualDesktop)**  - VirtualDesktop is a module that provides commandlets to manage virtual desktops of Windows 10 and 11.
...
and other commandlets [*09/21/2024 08:48:09*]
+ **[Firewall-Manager 1.1.1](https://github.com/MScholtes/Firewall-Manager)**  - Firewall-Manager is a module to manage firewall rules.
...
* Remove-FirewallRules to remove firewall rules according to a CSV or JSON file [*01/04/2022 15:08:32*]
