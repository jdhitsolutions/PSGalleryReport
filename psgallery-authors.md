...
+ **PSSailpoint.Transforms 2.1.15**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*08/13/2026 08:47:40*]
...
+ **PSSailpoint.Segments 2.1.15**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*08/13/2026 08:46:10*]
...
+ **PSSailpoint.Roles 2.1.15**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*08/13/2026 08:45:43*]
...
+ **PSSailpoint.PasswordDictionary 2.1.15**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*08/13/2026 08:44:22*]
...
+ **PSSailpoint.EntitlementConnections 2.1.15**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*08/13/2026 08:39:19*]
...
+ **PSSailpoint.DataAccessSecurity 2.1.15**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*08/13/2026 08:38:33*]
...
+ **PSSailpoint.AuthUsers 2.1.15**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*08/13/2026 08:37:09*]
...
+ **[PSPublishModule 3.0.106](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*08/13/2026 06:52:13*]
...
*Updated: Thursday, 13 August 2026 10:45:38 UTC*
