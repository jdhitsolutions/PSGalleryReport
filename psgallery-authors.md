...
+ [Przemyslaw Klys](#Przemyslaw-Klys) (22)
+ [PSModule](#PSModule) (13)
+ [Anam Navied](#Anam-Navied) (7)
+ [Taylor Lee](#Taylor-Lee) (6)
+ [Warren Frame](#Warren-Frame) (6)
+ [Joel Bennett](#Joel-Bennett) (4)
+ [David Segura](#David-Segura) (4)
+ [2AT B.V.](#2AT-BV) (4)
+ [Raimund Andree Per Pedersen Jan-Hendrik Peters](#Raimund-Andree-Per-Pedersen-Jan-Hendrik-Peters) (4)
...
+ [Dave Wyatt](#Dave-Wyatt) (3)
+ [Jon Carrier](#Jon-Carrier) (3)
+ [Brandon Olin](#Brandon-Olin) (3)
+ [Ethan Bergstrom](#Ethan-Bergstrom) (3)
+ [Nickolaj Andersen](#Nickolaj-Andersen) (3)
+ [Roman Kuzmin](#Roman-Kuzmin) (3)
+ [Mark Wragg](#Mark-Wragg) (3)
...
+ **[DesktopManager 3.6.1](https://github.com/EvotecIT/DesktopManager)**  - Desktop Manager is a PowerShell module that allows easy way to change wallpaper on multiple screens/monitors. [*05/26/2026 11:04:19*]
...
+ **[Mailozaurr 2.1.0](https://github.com/EvotecIT/MailoZaurr)**  - Mailozaurr is a PowerShell module that aims to provide SMTP, POP3, IMAP and few other ways to interact with Email. Underneath it uses MimeKit and MailKit and EmailValidation libraries written by Jeffrey Stedfast. [*05/20/2026 17:28:17*]
...
+ **[AdminToolbox.Exchange 1.11.0.20](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*05/26/2026 04:26:14*]
...
+ **[AdminToolbox.ActiveDirectory 1.14.0.7](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*05/26/2026 04:26:04*]
...
+ **[OSD 26.5.24.1](https://github.com/OSDeploy/OSD)**  - Root module for OSD. [*05/25/2026 07:07:07*]
...
+ **[AutoTaskAPI 1.2.3](https://github.com/KelvinTegelaar/AutotaskAPI)**  - This module allows you to connect to the Autotask REST API. The Autotask REST API was launched with version 2020.2 [*08/12/2025 13:14:06*]
...
+ **AksHci 1.2.131**  - AKS HCI Module [*05/14/2026 19:32:59*]
+ **Moc 1.2.37**  - MOC Module [*12/15/2025 19:36:42*]
...
+ **[IntuneWin32App 1.5.0](https://github.com/MSEndpointMgr/IntuneWin32App)**  - Provides a set of functions to manage Win32 apps in Microsoft Endpoint Manager (Intune). [*01/25/2026 16:43:46*]
+ **[EntraIDDeviceTrust.Client 1.0.1](https://github.com/MSEndpointMgr/EntraIDDeviceTrust)**  - Provides a set of functions to construct a valid header body sent to a Function App for it to validate the request was made by a trusted Entra ID device. [*09/22/2025 12:54:18*]
+ **[PSIntuneAuth 1.2.3](https://github.com/MSEndpointMgr/Intune/tree/master/Modules/PSIntuneAuth)**  - Provides a function to retrieve an authentication token for Intune Graph API calls. [*01/12/2021 12:59:27*]

## Roman Kuzmin

+ **[InvokeBuild 5.14.23](https://github.com/nightroman/Invoke-Build)**  - Build and test automation in PowerShell [*01/28/2026 12:51:49*]
+ **[Mdbc 7.1.0](https://github.com/nightroman/Mdbc)**  - Mdbc module - MongoDB Cmdlets for PowerShell [*01/15/2026 02:01:40*]
+ **[SplitPipeline 2.0.1](https://github.com/nightroman/SplitPipeline)**  - SplitPipeline - Parallel Data Processing in PowerShell [*10/11/2025 07:27:19*]

## Mark Wragg

+ **[Influx 1.0.103](https://github.com/markwragg/Powershell-Influx)**  - A PowerShell module for interacting with the time-series database platform Influx: https://www.influxdata.com/ [*09/07/2024 13:28:01*]
+ **[Watch 1.0.31](https://github.com/markwragg/Powershell-Watch)**  - A watch-command cmdlet for running a scriptblock until there is change. [*08/31/2024 08:01:51*]
...
+ **[JumpCloud.SDK.DirectoryInsights 0.2.0](https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4981_v2EUSupport/SDKs/PowerShell/JumpCloud.SDK.DirectoryInsights/)**  - The JumpCloud DirectoryInsights PowerShell SDK [*05/21/2026 16:12:25*]
+ **[JumpCloud.SDK.V1 0.2.0](https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V1/)**  - The JumpCloud V1 PowerShell SDK [*05/21/2026 16:12:24*]
+ **[JumpCloud.SDK.V2 0.3.0](https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/)**  - The JumpCloud V2 PowerShell SDK [*05/21/2026 16:12:23*]
...
+ **[VirtualDesktop 1.5.11](https://github.com/MScholtes/PSVirtualDesktop)**  - VirtualDesktop is a module that provides commandlets to manage virtual desktops of Windows 10 and 11.
...
and other commandlets [*08/25/2025 16:01:17*]
+ **[ps2exe 1.0.17](https://github.com/MScholtes/PS2EXE)**  - Compiles Powershell scripts to executables. Overworking of the great script of Ingo Karstein with GUI support.
'Invoke-ps2exe script.ps1' (or 'ps2exe script.ps1') compiles to script.exe. Several control parameters available.
Or use Win-PS2EXE as a graphical front end to the compiler. [*08/21/2025 09:29:50*]
...
*Updated: Wednesday, 27 May 2026 22:21:51 UTC*
