...
+ [Arcus](#Arcus) (10)
+ [Dr. Tobias Weltner](#Dr-Tobias-Weltner) (10)
+ [William Lam](#William-Lam) (10)
+ [Taylor Lee](#Taylor-Lee) (10)
+ [Warren Frame](#Warren-Frame) (10)
+ [Hewlett Packard Enterprise](#Hewlett-Packard-Enterprise) (9)
...
+ **[VMware.WorkloadManagement 1.0.14](https://github.com/lamw/VMware.WorkloadManagement)**  - PowerCLI Module for vSphere with Kubernetes Workload Management [*11/30/2022 16:31:41*]
...
+ **[VMware.Community.AppTransformer 1.0.0](https://github.com/lamw/VMware.Community.AppTransformer)**  - PowerShell Module for Application Transformer for VMware Tanzu [*02/03/2022 13:53:49*]
...
+ **[AdminToolbox.EndpointManagement 4.11.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for management of endpoints [*12/03/2024 03:18:56*]
+ **[AdminToolbox.ActiveDirectory 1.11.1.9](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Active Directory [*12/03/2024 03:18:49*]
...
+ **[HPESysInfoCmdlets 1.6.0.1](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : SysInfo Cmdlets provides an in-band tool for system info & health status on Gen10 and newer servers. [*09/25/2024 06:58:45*]
+ **[HPEBIOSCmdlets 4.0.0.0](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : BIOS Cmdlets creates an interface to HPE BIOS ROM-Based Setup Utility (RBSU) or UEFI System Utilities. These cmdlets can be used to configure the BIOS settings on HPE ProLiant servers. [*01/30/2024 03:55:23*]
+ **[HPESmartArrayCmdlets 2.0.0.0](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : Smart Array cmdlets create an interface to HPE Smart Array controller. These cmdlets can be used to configure the Smart Array controller on only HPE ProLiant Gen10 , Gen 10 Plus and Gen 11 servers. [*06/19/2023 10:12:43*]
+ **[HPENVDIMMCmdlets 2.3.0.0](https://www.hpe.com/us/en/servers/persistent-memory.html)**  - HPE NVDIMM PowerShell Cmdlets can get current system NVDIMM management status from the NVDIMM driver.
These cmdlets can get NVDIMM hardware information, health information, status information and configuration information. [*09/10/2020 14:23:13*]
+ **HPERedfishCmdlets 1.1.0.0**  - HPE Redfish PowerShell cmdlets create an interface to HPE Redfish devices such as iLO.
...
There are also advanced functions that can create an index or directory of HPE Redfish data sources. A file with examples called HPERedfishExamples.ps1 is included in this release. [*11/09/2018 21:47:45*]
+ **[HPEMigrationAdvisoryTool 1.1.0.0](https://www.hpe.com/servers/powershell)**  - MigrationAdvisoryTool for HPE PowerShell Cmdlets: MigrationAdvisoryTool provides migration suggestion for existing HPE Cmdlets used in PowerShell scripts to latest HPE Cmdlets module. [*04/25/2018 04:29:48*]
+ **[HPEOSProvisionCmdlets 1.0.0.1](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : OS Provisioning Cmdlets provides an interface to install Windows Server 2012 R2 or Windows Server 2016 using Windows unattended installation on HPE Gen10 servers. [*12/07/2017 06:55:54*]
+ **[HPRESTCmdlets 1.2.0.0](https://www.hpe.com/servers/powershell)**  - HPE REST PowerShell cmdlets create an interface to HPE REST devices such as iLO and Moonshot iLO CM. 
...
There are also advanced functions that can create an index or directory of HPE REST data sources. A file with examples called HPRESTExamples.ps1 is included in this release. [*10/26/2017 20:59:15*]
+ **[HPEVCCmdlets 1.0.0.0](https://www.hpe.com/servers/powershell)**  - Scripting Tools for Windows PowerShell : Virtual Connect (VC) Cmdlets use the VC CLI interface to communicate to VC. These cmdlets can be used to configure and manage VC hardware.
NOTE: Only limited cmdlets are developed in this module. [*03/30/2017 18:56:28*]
...
*Updated: Tuesday, 03 December 2024 17:51:05 UTC*
