...
+ **PSSailpoint.NERMV2025 2.1.12**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*08/10/2026 09:07:41*]
+ **PSSailpoint.NERM 2.1.12**  - PSSailpoint.NERM - the PowerShell module for NERM API [*08/10/2026 09:07:16*]
+ **PSSailpoint.Workflows 2.1.12**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*08/10/2026 09:06:46*]
+ **PSSailpoint.WorkReassignment 2.1.12**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*08/10/2026 09:06:25*]
+ **PSSailpoint.WorkItems 2.1.12**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*08/10/2026 09:06:08*]
+ **PSSailpoint.UiMetadata 2.1.12**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*08/10/2026 09:05:56*]
+ **PSSailpoint.Triggers 2.1.12**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*08/10/2026 09:05:52*]
+ **PSSailpoint.Transforms 2.1.12**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*08/10/2026 09:05:48*]
+ **PSSailpoint.TenantContext 2.1.12**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*08/10/2026 09:05:43*]
+ **PSSailpoint.Tenant 2.1.12**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*08/10/2026 09:05:39*]
+ **PSSailpoint.TaskManagement 2.1.12**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*08/10/2026 09:05:35*]
+ **PSSailpoint.Tags 2.1.12**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*08/10/2026 09:05:31*]
+ **PSSailpoint.TaggedObjects 2.1.12**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*08/10/2026 09:05:26*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.12**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*08/10/2026 09:05:22*]
+ **PSSailpoint.SpConfig 2.1.12**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*08/10/2026 09:05:17*]
+ **PSSailpoint.Sources 2.1.12**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*08/10/2026 09:05:13*]
+ **PSSailpoint.SourceUsages 2.1.12**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*08/10/2026 09:05:08*]
+ **PSSailpoint.SodViolations 2.1.12**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*08/10/2026 09:05:02*]
+ **PSSailpoint.SodPolicies 2.1.12**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*08/10/2026 09:04:33*]
+ **PSSailpoint.SodControls 2.1.12**  - PSSailpoint.SodControls - the PowerShell module for Identity Security Cloud API - SOD Controls [*08/10/2026 09:04:05*]
+ **PSSailpoint.SimIntegrations 2.1.12**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*08/10/2026 09:03:52*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.12**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*08/10/2026 09:03:23*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.12**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*08/10/2026 09:02:54*]
+ **PSSailpoint.Segments 2.1.12**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*08/10/2026 09:02:26*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.12**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*08/10/2026 09:02:00*]
+ **PSSailpoint.Search 2.1.12**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*08/10/2026 09:01:30*]
+ **PSSailpoint.ScheduledSearch 2.1.12**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*08/10/2026 09:01:05*]
+ **PSSailpoint.SavedSearch 2.1.12**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*08/10/2026 09:00:49*]
+ **PSSailpoint.Roles 2.1.12**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*08/10/2026 09:00:22*]
+ **PSSailpoint.RolePropagation 2.1.12**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*08/10/2026 09:00:07*]
+ **PSSailpoint.RoleInsights 2.1.12**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*08/10/2026 09:00:01*]
+ **PSSailpoint.RequestableObjects 2.1.12**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*08/10/2026 08:59:53*]
+ **PSSailpoint.ReportsDataExtraction 2.1.12**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*08/10/2026 08:59:34*]
+ **PSSailpoint.PublicIdentitiesConfig 2.1.12**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*08/10/2026 08:59:14*]
+ **PSSailpoint.PublicIdentities 2.1.12**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*08/10/2026 08:58:45*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.12**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*08/10/2026 08:58:21*]
+ **PSSailpoint.PrivilegeCriteria 2.1.12**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*08/10/2026 08:57:53*]
+ **PSSailpoint.PersonalAccessTokens 2.1.12**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*08/10/2026 08:57:31*]
+ **PSSailpoint.PasswordSyncGroups 2.1.12**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*08/10/2026 08:57:06*]
+ **PSSailpoint.PasswordPolicies 2.1.12**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*08/10/2026 08:56:37*]
+ **PSSailpoint.PasswordManagement 2.1.12**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*08/10/2026 08:56:08*]
+ **PSSailpoint.PasswordDictionary 2.1.12**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*08/10/2026 08:55:40*]
+ **PSSailpoint.PasswordConfiguration 2.1.12**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*08/10/2026 08:55:11*]
+ **PSSailpoint.ParameterStorage 2.1.12**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*08/10/2026 08:54:44*]
+ **PSSailpoint.OrgConfig 2.1.12**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*08/10/2026 08:54:19*]
+ **PSSailpoint.OauthClients 2.1.12**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*08/10/2026 08:53:51*]
+ **PSSailpoint.Notifications 2.1.12**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*08/10/2026 08:53:24*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.12**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*08/10/2026 08:53:01*]
+ **PSSailpoint.MultiHostIntegration 2.1.12**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*08/10/2026 08:52:32*]
+ **PSSailpoint.MfaConfiguration 2.1.12**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*08/10/2026 08:52:02*]
+ **PSSailpoint.ManagedClusters 2.1.12**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*08/10/2026 08:51:33*]
+ **PSSailpoint.ManagedClusterTypes 2.1.12**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*08/10/2026 08:51:03*]
+ **PSSailpoint.ManagedClients 2.1.12**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*08/10/2026 08:50:34*]
+ **PSSailpoint.MachineIdentitiesLifecycleActions 2.1.12**  - PSSailpoint.MachineIdentitiesLifecycleActions - the PowerShell module for Identity Security Cloud API - Machine Identity Lifecycle Actions [*08/10/2026 08:50:06*]
+ **PSSailpoint.MachineIdentities 2.1.12**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*08/10/2026 08:49:38*]
+ **PSSailpoint.MachineClassificationConfig 2.1.12**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*08/10/2026 08:49:09*]
+ **PSSailpoint.MachineAccounts 2.1.12**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*08/10/2026 08:48:45*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.12**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*08/10/2026 08:48:31*]
+ **PSSailpoint.MachineAccountMappings 2.1.12**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*08/10/2026 08:48:02*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.12**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*08/10/2026 08:47:56*]
+ **PSSailpoint.MachineAccountClassify 2.1.12**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*08/10/2026 08:47:36*]
+ **PSSailpoint.LifecycleStates 2.1.12**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*08/10/2026 08:47:27*]
+ **PSSailpoint.Launchers 2.1.12**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*08/10/2026 08:47:23*]
+ **PSSailpoint.JitActivations 2.1.12**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*08/10/2026 08:47:18*]
+ **PSSailpoint.JitAccess 2.1.12**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*08/10/2026 08:47:14*]
+ **PSSailpoint.Intelligence 2.1.12**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*08/10/2026 08:47:10*]
+ **PSSailpoint.IdentityProfiles 2.1.12**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*08/10/2026 08:47:05*]
+ **PSSailpoint.IdentityHistory 2.1.12**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*08/10/2026 08:46:59*]
+ **PSSailpoint.IdentityAttributes 2.1.12**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*08/10/2026 08:46:40*]
+ **PSSailpoint.Identities 2.1.12**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*08/10/2026 08:46:36*]
+ **PSSailpoint.Icons 2.1.12**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*08/10/2026 08:46:30*]
+ **PSSailpoint.IaiRoleMining 2.1.12**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*08/10/2026 08:46:23*]
+ **PSSailpoint.IaiRecommendations 2.1.12**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*08/10/2026 08:46:13*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.1.12**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*08/10/2026 08:46:01*]
+ **PSSailpoint.IaiOutliers 2.1.12**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*08/10/2026 08:45:57*]
+ **PSSailpoint.IaiCommonAccess 2.1.12**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*08/10/2026 08:45:52*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.12**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*08/10/2026 08:45:48*]
+ **PSSailpoint.GovernanceGroups 2.1.12**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*08/10/2026 08:45:44*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.12**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*08/10/2026 08:45:38*]
+ **PSSailpoint.Entitlements 2.1.12**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*08/10/2026 08:45:34*]
+ **PSSailpoint.EntitlementConnections 2.1.12**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*08/10/2026 08:45:29*]
+ **PSSailpoint.DeclassifySource 2.1.12**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*08/10/2026 08:45:20*]
+ **PSSailpoint.DataSegmentation 2.1.12**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*08/10/2026 08:45:15*]
+ **PSSailpoint.DataAccessSecurity 2.1.12**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*08/10/2026 08:45:11*]
+ **PSSailpoint.CustomUserLevels 2.1.12**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*08/10/2026 08:45:05*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.12**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*08/10/2026 08:44:42*]
+ **PSSailpoint.CustomForms 2.1.12**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*08/10/2026 08:44:28*]
+ **PSSailpoint.Connectors 2.1.12**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*08/10/2026 08:44:00*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.12**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*08/10/2026 08:43:42*]
+ **PSSailpoint.ConnectorCustomizers 2.1.12**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*08/10/2026 08:43:21*]
+ **PSSailpoint.ConfigurationHub 2.1.12**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*08/10/2026 08:42:59*]
+ **PSSailpoint.ClassifySource 2.1.12**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*08/10/2026 08:42:38*]
+ **PSSailpoint.Certifications 2.1.12**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*08/10/2026 08:42:21*]
+ **PSSailpoint.CertificationSummaries 2.1.12**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*08/10/2026 08:42:01*]
+ **PSSailpoint.CertificationCampaigns 2.1.12**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*08/10/2026 08:41:43*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.12**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*08/10/2026 08:41:26*]
+ **PSSailpoint.Branding 2.1.12**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*08/10/2026 08:41:13*]
+ **PSSailpoint.AuthUsers 2.1.12**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*08/10/2026 08:41:06*]
+ **PSSailpoint.AuthProfile 2.1.12**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*08/10/2026 08:40:56*]
+ **PSSailpoint.Apps 2.1.12**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*08/10/2026 08:40:41*]
+ **PSSailpoint.Approvals 2.1.12**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*08/10/2026 08:40:37*]
+ **PSSailpoint.ApplicationDiscovery 2.1.12**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*08/10/2026 08:40:32*]
+ **PSSailpoint.ApiUsage 2.1.12**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*08/10/2026 08:40:28*]
+ **PSSailpoint.Accounts 2.1.12**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*08/10/2026 08:40:22*]
+ **PSSailpoint.AccountUsages 2.1.12**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*08/10/2026 08:40:16*]
+ **PSSailpoint.AccountDeletionRequests 2.1.12**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*08/10/2026 08:39:54*]
+ **PSSailpoint.AccountAggregations 2.1.12**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*08/10/2026 08:39:45*]
+ **PSSailpoint.AccountActivities 2.1.12**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*08/10/2026 08:39:22*]
+ **PSSailpoint.AccessRequests 2.1.12**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*08/10/2026 08:39:07*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.12**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*08/10/2026 08:38:36*]
+ **PSSailpoint.AccessRequestApprovals 2.1.12**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*08/10/2026 08:38:23*]
+ **PSSailpoint.AccessProfiles 2.1.12**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*08/10/2026 08:37:59*]
+ **PSSailpoint.AccessModelMetadata 2.1.12**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*08/10/2026 08:37:30*]
...
+ **GraphEssentials 0.0.58**  - GraphEssentials is a PowerShell module that helps with Office 365 / Azure AD using mostly Graph [*08/11/2026 09:45:04*]
+ **[PSPublishModule 3.0.103](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*08/09/2026 14:10:42*]
+ **[PSWriteOffice 3.0.2](https://github.com/EvotecIT/PSWriteOffice)**  - PowerShell module to create, convert, read, inspect, and export Office, PDF, OpenDocument, email, Markdown, AsciiDoc, LaTeX, CSV, Visio, and Confluence content without Microsoft Office installed. Powered by OfficeIMO.*. [*08/09/2026 10:30:51*]
...
+ **[DJScratchLooper 1.0.0.2](https://www.youtube.com/shorts/bAkoUGaa8W0)**  - PowerShell module for launching a WPF DJ Scratch Looper interface. [*08/11/2026 10:14:40*]
...
*Updated: Tuesday, 11 August 2026 10:35:38 UTC*
