...
+ **[TheDashboard 0.0.13](https://github.com/EvotecIT/TheDashboard)**  - TheDashboard is a module that allows you to create a dashboard for your HTML reports [*08/31/2023 06:33:11*]
...
+ **IdracRedfishSupport 22.5.0.0**  - Main module used to import all individual iDRAC Redfish modules listed in the Powershell gallery. For more details and examples for each module, execute get-help on the specific module. [*09/28/2023 21:32:04*]
...
+ **[GitHub 0.2.11](https://github.com/PSModule/GitHub)**  - GitHub PowerShell Module [*10/02/2023 07:12:07*]
...
+ **[Fonts 0.0.25](https://github.com/MariusStorhaug/Fonts)**  - Manage fonts on a Windows system [*09/17/2023 20:47:39*]
+ **[NerdFonts 0.0.13](https://github.com/MariusStorhaug/NerdFonts)**  - A PowerShell module to manage NerdFonts [*09/17/2023 19:23:53*]
+ **[PATH 0.0.12](https://github.com/MariusStorhaug/PATH)**  - A PowerShell module for managing the PATH environment variable. [*09/17/2023 19:23:40*]
+ **[PublicIP 0.0.10](https://github.com/MariusStorhaug/PublicIP)**  - PowerShell Module for Public IP [*09/17/2023 19:09:07*]
...
+ **[poshy-wrap-wget 0.3.13](https://github.com/pwshrc/poshy-wrap-wget)**  - Convenient cmdlets and aliases which wrap `wget`. [*09/26/2023 13:07:05*]
...
+ **[poshy-wrap-vscode 0.2.10](https://github.com/pwshrc/poshy-wrap-vscode)**  - Convenient cmdlets and aliases for interacting with VSCode from within your PowerShell session. [*09/26/2023 13:06:08*]
+ **[poshy-wrap-dnf 0.2.13](https://github.com/pwshrc/poshy-wrap-dnf)**  - Convenient cmdlets and aliases which wrap `dnf`. [*09/26/2023 13:05:45*]
+ **[poshy-wrap-tmux 0.3.13](https://github.com/pwshrc/poshy-wrap-tmux)**  - Convenient cmdlets and aliases which wrap `tmux`. [*09/26/2023 13:05:42*]
+ **[poshy-wrap-ruby 0.3.13](https://github.com/pwshrc/poshy-wrap-ruby)**  - Convenient cmdlets and aliases which wrap `ruby`. [*09/26/2023 13:05:29*]
+ **[poshy-wrap-pip 0.2.12](https://github.com/pwshrc/poshy-wrap-pip)**  - Convenient cmdlets and aliases which wrap `pip3`. [*09/26/2023 13:05:02*]
+ **[poshy-wrap-nginx 0.2.13](https://github.com/pwshrc/poshy-wrap-nginx)**  - Convenient cmdlets and aliases which wrap `nginx`. [*09/26/2023 13:04:25*]
+ **[poshy-wrap-gh 0.2.1](https://github.com/pwshrc/poshy-wrap-gh)**  - Convenient cmdlets which wrap the GitHub CLI `gh`. [*09/26/2023 13:04:24*]
+ **[poshy-notify-send 0.2.13](https://github.com/pwshrc/poshy-notify-send)**  - A unified cross-platform wrapper function for generating desktop toast notifications from within your PowerShell session - using whichever toast notification system you have installed. [*09/26/2023 13:02:48*]
+ **[poshy-env-var 0.5.21](https://github.com/pwshrc/poshy-env-var)**  - Ergonomic cmdlets for assigning, retrieving, and deleting environment variables - including path-munging for arbitrary PATH variables. [*09/26/2023 13:02:21*]
+ **[poshy-ecks 0.5.20](https://github.com/pwshrc/poshy-ecks)**  - Convenient cmdlets for executing arbitrary commands under exotic circumstances, including temporarily-altered environment variables and working directories. [*09/26/2023 13:02:05*]
+ **[poshy-ls-isms 0.2.12](https://github.com/pwshrc/poshy-ls-isms)**  - Convenient functions and aliases for performing directory listings in the style of popular Bash/ZSH aliases for ls. [*09/26/2023 13:01:34*]
+ **[poshy-code-search 0.3.13](https://github.com/pwshrc/poshy-code-search)**  - Convenient cmdlets for text searches against source code files. [*09/26/2023 13:01:15*]
+ **[poshy-wrap-terraform 0.3.14](https://github.com/pwshrc/poshy-wrap-terraform)**  - Convenient cmdlets and aliases which wrap `terraform`. [*09/26/2023 01:03:07*]
+ **[poshy-wrap-wt 0.3.12](https://github.com/pwshrc/poshy-wrap-wt)**  - Convenient cmdlets and aliases for interacting with Windows Terminal from within your PowerShell session. [*09/26/2023 01:02:58*]
+ **[poshy-wrap-vault 0.3.11](https://github.com/pwshrc/poshy-wrap-vault)**  - Convenient cmdlets and aliases which wrap `vault`. [*09/26/2023 01:02:34*]
+ **[poshy-wrap-vagrant 0.3.12](https://github.com/pwshrc/poshy-wrap-vagrant)**  - Convenient cmdlets and aliases which wrap `vagrant`. [*09/26/2023 01:02:08*]
+ **[poshy-wrap-terragrunt 0.3.11](https://github.com/pwshrc/poshy-wrap-terragrunt)**  - Convenient cmdlets and aliases which wrap `terragrunt`. [*09/26/2023 01:02:08*]
+ **[poshy-wrap-systemctl 0.2.12](https://github.com/pwshrc/poshy-wrap-systemctl)**  - Convenient cmdlets and aliases which wrap `systemctl`. [*09/26/2023 01:01:56*]
+ **[poshy-wrap-npm 0.2.13](https://github.com/pwshrc/poshy-wrap-npm)**  - Convenient cmdlets and aliases which wrap `npm`. [*09/26/2023 01:01:52*]
...
+ **[poshy-wrap-pyenv 0.2.12](https://github.com/pwshrc/poshy-wrap-pyenv)**  - Convenient cmdlets and aliases which wrap `pyenv`. [*09/26/2023 01:01:18*]
+ **[poshy-wrap-nmap 0.2.12](https://github.com/pwshrc/poshy-wrap-nmap)**  - Convenient cmdlets and aliases which wrap `nmap`. [*09/26/2023 01:00:51*]
+ **[poshy-wrap-pipenv 0.2.12](https://github.com/pwshrc/poshy-wrap-pipenv)**  - Convenient cmdlets and aliases which wrap `pipenv`. [*09/26/2023 00:59:40*]
+ **[poshy-wrap-golang 0.2.13](https://github.com/pwshrc/poshy-wrap-golang)**  - Convenient cmdlets and aliases which wrap `go`. [*09/26/2023 00:59:18*]
+ **[poshy-wrap-maven 0.2.11](https://github.com/pwshrc/poshy-wrap-maven)**  - Convenient cmdlets and aliases which wrap `maven`. [*09/26/2023 00:59:11*]
+ **[poshy-wrap-kubectl 0.2.12](https://github.com/pwshrc/poshy-wrap-kubectl)**  - Convenient cmdlets and aliases which wrap `kubectl`. [*09/26/2023 00:59:09*]
+ **[poshy-wrap-git 0.2.12](https://github.com/pwshrc/poshy-wrap-git)**  - Convenient cmdlets and aliases which wrap `git`. [*09/26/2023 00:58:51*]
+ **[poshy-wrap-brew 0.2.13](https://github.com/pwshrc/poshy-wrap-brew)**  - Convenient cmdlets and aliases which wrap `brew`. [*09/26/2023 00:58:49*]
+ **[poshy-wrap-helm 0.2.13](https://github.com/pwshrc/poshy-wrap-helm)**  - Convenient cmdlets and aliases which wrap `helm`. [*09/26/2023 00:58:49*]
+ **[poshy-wrap-git-flow 0.2.12](https://github.com/pwshrc/poshy-wrap-git-flow)**  - Convenient cmdlets and aliases which wrap `git-flow`. [*09/26/2023 00:58:46*]
+ **[poshy-wrap-python 0.2.13](https://github.com/pwshrc/poshy-wrap-python)**  - Convenient cmdlets and aliases which wrap `python3`. [*09/26/2023 00:58:40*]
+ **[poshy-wrap-docker 0.2.12](https://github.com/pwshrc/poshy-wrap-docker)**  - Convenient cmdlets and aliases which wrap `docker`. [*09/26/2023 00:58:40*]
+ **[poshy-wrap-dotnet 0.2.13](https://github.com/pwshrc/poshy-wrap-dotnet)**  - Convenient cmdlets and aliases which wrap `dotnet`. [*09/26/2023 00:58:39*]
+ **[poshy-wrap-forgit 0.2.12](https://github.com/pwshrc/poshy-wrap-forgit)**  - Convenient cmdlets and aliases which wrap `forgit`. [*09/26/2023 00:58:37*]
+ **[poshy-wrap-curl 0.2.12](https://github.com/pwshrc/poshy-wrap-curl)**  - Convenient cmdlets and aliases which wrap `curl`. [*09/26/2023 00:58:36*]
+ **[poshy-wrap-docker-compose 0.2.12](https://github.com/pwshrc/poshy-wrap-docker-compose)**  - Convenient cmdlets and aliases which wrap `docker-compose`. [*09/26/2023 00:58:36*]
+ **[poshy-wrap-git-hf 0.2.13](https://github.com/pwshrc/poshy-wrap-git-hf)**  - Convenient cmdlets and aliases which wrap `git-hf`. [*09/26/2023 00:58:30*]
+ **[poshy-viewer-finder 0.2.12](https://github.com/pwshrc/poshy-viewer-finder)**  - An experimental cross-platform library for enumerating the user's installed text viewers & editors, with capability filtering & execution argument configuration all baked in. [*09/26/2023 00:58:29*]
+ **[poshy-wrap-gem 0.2.12](https://github.com/pwshrc/poshy-wrap-gem)**  - Convenient cmdlets and aliases which wrap `gem`. [*09/26/2023 00:58:27*]
+ **[poshy-wrap-git-lfs 0.2.12](https://github.com/pwshrc/poshy-wrap-git-lfs)**  - Convenient cmdlets and aliases which wrap `git-lfs`. [*09/26/2023 00:58:20*]
+ **[poshy-env-proxy 0.5.11](https://github.com/pwshrc/poshy-env-proxy)**  - Convenient cmdlets for enabling, disabling, and configuring HTTP/HTTPS proxy usage - in both environment variables and configuration files for various applications. [*09/26/2023 00:57:35*]
+ **[poshy-wrap-apt 0.2.12](https://github.com/pwshrc/poshy-wrap-apt)**  - Convenient cmdlets and aliases which wrap the `apt-get`, `apt`, and `aptitude` package managers. [*09/26/2023 00:57:28*]
+ **[poshy-sshconfig 0.5.11](https://github.com/pwshrc/poshy-sshconfig)**  - Convnience cmdlets for making changes to your SSH configuration. [*09/26/2023 00:57:15*]
+ **[poshy-colors 0.3.13](https://github.com/pwshrc/poshy-colors)**  - Functions for generating ANSI terminal formatting sequences, including: blinking text, italic text, bold text, underlined text, strike-through text, reversed-color text, hyperlinked text, and 24-bit true color foreground and background coloring in RGB and HSL. [*09/26/2023 00:57:00*]
+ **[poshy-sh-isms 0.3.13](https://github.com/pwshrc/poshy-sh-isms)**  - Convenience functions for emulating certain shell functionality - great for helping you convert those Bash scripts over to PowerShell. [*09/26/2023 00:56:40*]
+ **[poshy-multimedia 0.6.11](https://github.com/pwshrc/poshy-multimedia)**  - Convenient cmdlets for working with various archive, multimedia, and data-encoding formats directly in your PowerShell terminal. [*09/26/2023 00:56:20*]
+ **[poshy-lucidity 0.3.15](https://github.com/pwshrc/poshy-lucidity)**  - Convenient general-purpose cmdlets to help you write your PowerShell scripts - the "batteries" that should have been included in the original packaging. [*09/26/2023 00:56:16*]
+ **[poshy-net 0.3.13](https://github.com/pwshrc/poshy-net)**  - Convenient cmdlets and aliases for performing various network activities, including getting your current external IP address - right from your PowerShell terminal. [*09/26/2023 00:54:54*]
+ **[poshy-dir-nav 0.3.12](https://github.com/pwshrc/poshy-dir-nav)**  - Convenient functions and aliases for changing the current directory in various ways. [*09/26/2023 00:54:06*]
+ **[poshy-coreutils-ish 0.3.12](https://github.com/pwshrc/poshy-coreutils-ish)**  - Cmdlets that are semantically equivalent to GNU coreutils - useful when converting shell scripts to PowerShell. [*09/26/2023 00:52:09*]
...
+ **[PSA 0.1.4](https://github.com/StartAutomating/PSA/)**  - PowerShell Announcements (with AtProtocol).  Shoutout to the Blue Sky! [*09/15/2023 22:59:07*]
...
+ **[ShowDemo 0.1.4](https://github.com/StartAutomating/ShowDemo)**  - A simple tool to showcase your scripts. [*08/18/2023 04:26:38*]
...
+ **[PSWorkItem 1.4.0](https://github.com/jdhitsolutions/PSWorkItem)**  - A PowerShell 7 module for managing work and personal tasks or to-do items. This module uses a SQLite database to store task and category information. The module is not a full-featured project management solution, but should be fine for personal needs. The module requires a 64-bit Windows platform. [*09/29/2023 16:33:42*]
...
+ **[PSOpenAI 1.14.3](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*09/19/2023 13:54:15*]
...
+ **[Yayaml 0.2.0](https://github.com/jborean93/PowerShell-Yayaml)**  - Yet Another YAML parser and writer for PowerShell [*09/25/2023 21:23:19*]
+ **[PSOpenAD 0.4.0](https://github.com/jborean93/PSOpenAD)**  - Cross platform module that can get/set information in Active Directory.`nSee https://github.com/jborean93/PSOpenAD for more info [*09/05/2023 01:13:20*]
...
*Updated: Monday, 02 October 2023 09:53:01 UTC*
