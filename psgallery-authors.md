...
+ [OpenAPI Generator Team](#OpenAPI-Generator-Team) (125)
+ [psdevuk](#psdevuk) (107)
...
+ [James Brundage](#James-Brundage) (75)
...
+ **PSSailpoint.NERMV2025 2.0.12**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*07/10/2026 09:26:17*]
+ **PSSailpoint.NERM 2.0.12**  - PSSailpoint.NERM - the PowerShell module for NERM API [*07/10/2026 09:26:13*]
+ **PSSailpoint.Workflows 2.0.12**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*07/10/2026 09:26:08*]
+ **PSSailpoint.WorkReassignment 2.0.12**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*07/10/2026 09:26:03*]
+ **PSSailpoint.WorkItems 2.0.12**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*07/10/2026 09:25:55*]
+ **PSSailpoint.UiMetadata 2.0.12**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*07/10/2026 09:25:51*]
+ **PSSailpoint.Triggers 2.0.12**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*07/10/2026 09:25:47*]
+ **PSSailpoint.Transforms 2.0.12**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*07/10/2026 09:25:43*]
+ **PSSailpoint.TenantContext 2.0.12**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*07/10/2026 09:25:39*]
+ **PSSailpoint.Tenant 2.0.12**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*07/10/2026 09:25:35*]
+ **PSSailpoint.TaskManagement 2.0.12**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*07/10/2026 09:25:30*]
+ **PSSailpoint.Tags 2.0.12**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*07/10/2026 09:25:26*]
+ **PSSailpoint.TaggedObjects 2.0.12**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*07/10/2026 09:25:22*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.0.12**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*07/10/2026 09:25:17*]
+ **PSSailpoint.SpConfig 2.0.12**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*07/10/2026 09:25:12*]
+ **PSSailpoint.Sources 2.0.12**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*07/10/2026 09:25:07*]
+ **PSSailpoint.SourceUsages 2.0.12**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*07/10/2026 09:25:02*]
+ **PSSailpoint.SodViolations 2.0.12**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*07/10/2026 09:24:58*]
+ **PSSailpoint.SodPolicies 2.0.12**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*07/10/2026 09:24:54*]
+ **PSSailpoint.SimIntegrations 2.0.12**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*07/10/2026 09:24:49*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.0.12**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*07/10/2026 09:24:43*]
+ **PSSailpoint.ServiceDeskIntegration 2.0.12**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*07/10/2026 09:24:35*]
+ **PSSailpoint.Segments 2.0.12**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*07/10/2026 09:24:12*]
+ **PSSailpoint.SearchAttributeConfiguration 2.0.12**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*07/10/2026 09:24:04*]
+ **PSSailpoint.Search 2.0.12**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*07/10/2026 09:24:00*]
+ **PSSailpoint.ScheduledSearch 2.0.12**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*07/10/2026 09:23:54*]
+ **PSSailpoint.SavedSearch 2.0.12**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*07/10/2026 09:23:50*]
+ **PSSailpoint.Roles 2.0.12**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*07/10/2026 09:23:46*]
+ **PSSailpoint.RolePropagation 2.0.12**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*07/10/2026 09:23:42*]
+ **PSSailpoint.RoleInsights 2.0.12**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*07/10/2026 09:23:38*]
+ **PSSailpoint.RequestableObjects 2.0.12**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*07/10/2026 09:23:34*]
+ **PSSailpoint.ReportsDataExtraction 2.0.12**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*07/10/2026 09:23:30*]
+ **PSSailpoint.PublicIdentitiesConfig 2.0.12**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*07/10/2026 09:23:25*]
+ **PSSailpoint.PublicIdentities 2.0.12**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*07/10/2026 09:23:20*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.0.12**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*07/10/2026 09:23:16*]
+ **PSSailpoint.PrivilegeCriteria 2.0.12**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*07/10/2026 09:23:12*]
+ **PSSailpoint.PersonalAccessTokens 2.0.12**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*07/10/2026 09:23:08*]
+ **PSSailpoint.PasswordSyncGroups 2.0.12**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*07/10/2026 09:23:04*]
+ **PSSailpoint.PasswordPolicies 2.0.12**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*07/10/2026 09:23:00*]
+ **PSSailpoint.PasswordManagement 2.0.12**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*07/10/2026 09:22:56*]
+ **PSSailpoint.PasswordDictionary 2.0.12**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*07/10/2026 09:22:52*]
+ **PSSailpoint.PasswordConfiguration 2.0.12**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*07/10/2026 09:22:48*]
+ **PSSailpoint.ParameterStorage 2.0.12**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*07/10/2026 09:22:44*]
+ **PSSailpoint.OrgConfig 2.0.12**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*07/10/2026 09:22:40*]
+ **PSSailpoint.OauthClients 2.0.12**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*07/10/2026 09:22:36*]
+ **PSSailpoint.Notifications 2.0.12**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*07/10/2026 09:22:32*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.0.12**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*07/10/2026 09:22:26*]
+ **PSSailpoint.MultiHostIntegration 2.0.12**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*07/10/2026 09:22:21*]
+ **PSSailpoint.MfaConfiguration 2.0.12**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*07/10/2026 09:22:16*]
+ **PSSailpoint.ManagedClusters 2.0.12**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*07/10/2026 09:22:12*]
+ **PSSailpoint.ManagedClusterTypes 2.0.12**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*07/10/2026 09:22:07*]
+ **PSSailpoint.ManagedClients 2.0.12**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*07/10/2026 09:22:02*]
+ **PSSailpoint.MachineIdentities 2.0.12**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*07/10/2026 09:21:58*]
+ **PSSailpoint.MachineClassificationConfig 2.0.12**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*07/10/2026 09:21:53*]
+ **PSSailpoint.MachineAccounts 2.0.12**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*07/10/2026 09:21:49*]
+ **PSSailpoint.MachineAccountSubtypes 2.0.12**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*07/10/2026 09:21:45*]
+ **PSSailpoint.MachineAccountMappings 2.0.12**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*07/10/2026 09:21:40*]
+ **PSSailpoint.MachineAccountCreationRequest 2.0.12**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*07/10/2026 09:21:36*]
+ **PSSailpoint.MachineAccountClassify 2.0.12**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*07/10/2026 09:21:30*]
+ **PSSailpoint.LifecycleStates 2.0.12**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*07/10/2026 09:21:24*]
+ **PSSailpoint.Launchers 2.0.12**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*07/10/2026 09:21:17*]
+ **PSSailpoint.JitActivations 2.0.12**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*07/10/2026 09:20:51*]
+ **PSSailpoint.JitAccess 2.0.12**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*07/10/2026 09:20:45*]
+ **PSSailpoint.Intelligence 2.0.12**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*07/10/2026 09:20:17*]
+ **PSSailpoint.IdentityProfiles 2.0.12**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*07/10/2026 09:20:06*]
+ **PSSailpoint.IdentityHistory 2.0.12**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*07/10/2026 09:19:41*]
+ **PSSailpoint.IdentityAttributes 2.0.12**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*07/10/2026 09:19:23*]
+ **PSSailpoint.Identities 2.0.12**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*07/10/2026 09:19:13*]
+ **PSSailpoint.Icons 2.0.12**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*07/10/2026 09:19:08*]
+ **PSSailpoint.IaiRoleMining 2.0.12**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*07/10/2026 09:19:04*]
+ **PSSailpoint.IaiRecommendations 2.0.12**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*07/10/2026 09:19:00*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.0.12**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*07/10/2026 09:18:50*]
+ **PSSailpoint.IaiOutliers 2.0.12**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*07/10/2026 09:18:32*]
+ **PSSailpoint.IaiCommonAccess 2.0.12**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*07/10/2026 09:18:18*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.0.12**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*07/10/2026 09:17:59*]
+ **PSSailpoint.GovernanceGroups 2.0.12**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*07/10/2026 09:17:49*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.0.12**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*07/10/2026 09:17:28*]
+ **PSSailpoint.Entitlements 2.0.12**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*07/10/2026 09:17:20*]
+ **PSSailpoint.EntitlementConnections 2.0.12**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*07/10/2026 09:17:09*]
+ **PSSailpoint.Dimensions 2.0.12**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*07/10/2026 09:16:47*]
+ **PSSailpoint.DeclassifySource 2.0.12**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*07/10/2026 09:16:34*]
+ **PSSailpoint.DataSegmentation 2.0.12**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*07/10/2026 09:16:15*]
+ **PSSailpoint.DataAccessSecurity 2.0.12**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*07/10/2026 09:16:07*]
+ **PSSailpoint.CustomUserLevels 2.0.12**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*07/10/2026 09:15:48*]
+ **PSSailpoint.CustomPasswordInstructions 2.0.12**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*07/10/2026 09:15:36*]
+ **PSSailpoint.CustomForms 2.0.12**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*07/10/2026 09:15:16*]
+ **PSSailpoint.Connectors 2.0.12**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*07/10/2026 09:15:06*]
+ **PSSailpoint.ConnectorRuleManagement 2.0.12**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*07/10/2026 09:14:45*]
+ **PSSailpoint.ConnectorCustomizers 2.0.12**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*07/10/2026 09:14:24*]
+ **PSSailpoint.ConfigurationHub 2.0.12**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*07/10/2026 09:14:04*]
+ **PSSailpoint.ClassifySource 2.0.12**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*07/10/2026 09:13:44*]
+ **PSSailpoint.Certifications 2.0.12**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*07/10/2026 09:13:32*]
+ **PSSailpoint.CertificationSummaries 2.0.12**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*07/10/2026 09:13:11*]
+ **PSSailpoint.CertificationCampaigns 2.0.12**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*07/10/2026 09:13:01*]
+ **PSSailpoint.CertificationCampaignFilters 2.0.12**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*07/10/2026 09:12:56*]
+ **PSSailpoint.Branding 2.0.12**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*07/10/2026 09:12:52*]
+ **PSSailpoint.AuthUsers 2.0.12**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*07/10/2026 09:12:47*]
+ **PSSailpoint.AuthProfile 2.0.12**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*07/10/2026 09:12:38*]
+ **PSSailpoint.Apps 2.0.12**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*07/10/2026 09:12:33*]
+ **PSSailpoint.Approvals 2.0.12**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*07/10/2026 09:12:17*]
+ **PSSailpoint.ApplicationDiscovery 2.0.12**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*07/10/2026 09:12:09*]
+ **PSSailpoint.ApiUsage 2.0.12**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*07/10/2026 09:12:00*]
+ **PSSailpoint.Accounts 2.0.12**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*07/10/2026 09:11:48*]
+ **PSSailpoint.AccountUsages 2.0.12**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*07/10/2026 09:11:28*]
+ **PSSailpoint.AccountDeletionRequests 2.0.12**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*07/10/2026 09:11:22*]
+ **PSSailpoint.AccountAggregations 2.0.12**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*07/10/2026 09:10:55*]
+ **PSSailpoint.AccountActivities 2.0.12**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*07/10/2026 09:10:41*]
+ **PSSailpoint.AccessRequests 2.0.12**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*07/10/2026 09:10:12*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.0.12**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*07/10/2026 09:09:43*]
+ **PSSailpoint.AccessRequestApprovals 2.0.12**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*07/10/2026 09:09:15*]
+ **PSSailpoint.AccessProfiles 2.0.12**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*07/10/2026 09:08:57*]
+ **PSSailpoint.AccessModelMetadata 2.0.12**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*07/10/2026 09:08:42*]
...
+ **[VcfPatchScanner 1.0.0.1007](https://github.com/vmware/powershell-module-for-vcf-patch-scanner)**  - VCF Patch Scanner Module [*06/26/2026 23:51:34*]
...
+ **[PSPublishModule 3.0.51](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*07/11/2026 15:54:31*]
+ **[PowerBGInfo 1.0.5](https://github.com/EvotecIT/PowerBGInfo)**  - PowerBGInfo is a module that allows you to create background images with information about your environment. [*07/08/2026 14:47:19*]
...
+ **[PSParseHTML 2.0.17](https://github.com/EvotecIT/PSParseHTML)**  - Module that allows to manipulate, parse, format and optimize HTML, JavaScript and CSS [*07/05/2026 10:53:06*]
+ **[ImagePlayground 2.0.0](https://github.com/EvotecIT/ImagePlayground)**  - ImagePlayground is a PowerShell module that provides a set of functions for image processing. Among other things it can create QRCodes, BarCodes, Charts, and do image processing that can help with daily tasks. [*07/04/2026 18:29:29*]
...
+ **[DbaClientX 1.0.1](https://github.com/EvotecIT/DbaClientX)**  - Simple project to query Sql Server and other databases using PowerShell [*06/22/2026 18:54:26*]
+ **[FileInspectorX 1.0.13](https://github.com/EvotecIT/FileInspectorX)**  - FileInspectorX is PowerShell module that allows you to query files and folders for information. It supports multiple types of file queries and can be used to query local file systems, network shares. [*06/16/2026 08:28:06*]
...
+ **[Template-PSModule 0.0.10](https://github.com/PSModule/Template-PSModule)**  - Template for a PowerShell module repo. [*07/11/2026 16:00:19*]
...
+ **[UncommonSense.Trouw 0.0.61.0](https://github.com/jhoek/UncommonSense.Trouw)**  - PowerShell module for listing Trouw articles [*06/19/2026 07:51:56*]
...
+ **[Universal 2026.2.2](https://ironmansoftware.com/powershell-universal)**  - Module for PowerShell Universal. [*07/02/2026 20:56:49*]
...
+ **[rhubarb-geek-nz.PSCPreProcessor 1.0.2](https://github.com/rhubarb-geek-nz/cpp)**  - Implements C preprocessor as a pipeline allowing direct usage in PowerShell [*06/28/2026 08:28:25*]
+ **[rhubarb-geek-nz.ItEscapesMe 1.0.1](https://github.com/rhubarb-geek-nz/ItEscapesMe)**  - EscapeString Cmdlets for PowerShell [*06/16/2026 12:19:19*]
...
+ **[PSMSAL 4.84.2.8](https://github.com/mgajda83/PSMSAL)**  - PowerShell module for MSAL Tokens. [*06/10/2026 06:34:45*]
+ **[PSSDPAPI 1.0.2.6](https://github.com/mgajda83/PSSDPAPI)**  - Modul PowerShell do obslugi API ServiceDesk Plus. [*05/29/2026 10:39:14*]
+ **[Automatron 1.0.0.21](https://github.com/mgajda83/Automatron)**  - Basic automation info for scripts in Azure Automation [*05/20/2026 11:27:32*]
...
*Updated: Saturday, 11 July 2026 22:31:55 UTC*
