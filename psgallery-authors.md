...
+ **[PasswordSolution 2.0.0](https://github.com/EvotecIT/PasswordSolution)**  - This module allows the creation of password expiry emails for users, managers, administrators, and security according to defined templates. It's able to work with different rules allowing to fully customize who gets the email and when. [*09/08/2024 11:52:23*]
+ **[CleanupMonster 2.8.6](https://github.com/EvotecIT/CleanupMonster)**  - This module provides an easy way to cleanup Active Directory from dead/old objects based on various criteria. It can also disable, move or delete objects. It can utilize Azure AD, Intune and Jamf to get additional information about objects before deleting them. [*09/02/2024 09:54:45*]
+ **[PSEventViewer 2.1.0](https://github.com/EvotecIT/PSEventViewer)**  - Simple module allowing parsing of event logs. Has its own quirks... [*08/30/2024 17:47:41*]
...
+ **[PSOpenAI 4.3.0](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*09/06/2024 16:48:34*]
...
+ **[UncommonSense.Volkskrant 0.0.55.0](https://github.com/jhoek/UncommonSense.Volkskrant)**  - PowerShell module for listing Volkskrant articles [*09/08/2024 18:30:51*]
+ **[UncommonSense.Nrc 0.1.0.32](https://github.com/jhoek/UncommonSense.Nrc)**  - PowerShell module for listing NRC articles [*09/02/2024 15:39:06*]
+ **[UncommonSense.Cinema 0.0.27](https://github.com/jhoek/UncommonSense.Cinema)**  - Film listing for my favorite cinemas [*09/01/2024 06:33:02*]
...
+ **spec.file.utilities 2.0.7**  - A module for efficient file management, enabling seamless file downloads from Azure Blob storage, file hash comparisons, and a suite of essential file operations. [*09/10/2024 10:21:15*]
+ **spec.azure.tables 2.0.0**  - A module for interacting with Azure Tables [*09/06/2024 12:12:03*]
+ **spec.registry.management 1.0.4**  - A module to help manage the Windows registry [*08/21/2024 11:15:34*]
...
+ **[Rivet 0.23.0](http://get-rivet.org/)**  - Rivet is a database migration/change management/versioning tool inspired by Ruby on Rails' Migrations. It creates and applies migration scripts for SQL Server databases. Migration scripts describe changes to make to your database, e.g. add a table, add a column, remove an index, etc. Migrations scripts should get added to your version control system so they can be packaged and deployed with your application's code. [*09/10/2024 19:06:33*]
...
*Updated: Thursday, 12 September 2024 09:51:35 UTC*
