...
+ **PSSailpoint.NERMV2025 2.1.6**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*07/28/2026 09:14:37*]
+ **PSSailpoint.NERM 2.1.6**  - PSSailpoint.NERM - the PowerShell module for NERM API [*07/28/2026 09:14:32*]
+ **PSSailpoint.Workflows 2.1.6**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*07/28/2026 09:14:27*]
+ **PSSailpoint.WorkReassignment 2.1.6**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*07/28/2026 09:14:22*]
+ **PSSailpoint.WorkItems 2.1.6**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*07/28/2026 09:14:17*]
+ **PSSailpoint.UiMetadata 2.1.6**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*07/28/2026 09:14:12*]
+ **PSSailpoint.Triggers 2.1.6**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*07/28/2026 09:14:06*]
+ **PSSailpoint.Transforms 2.1.6**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*07/28/2026 09:14:00*]
+ **PSSailpoint.TenantContext 2.1.6**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*07/28/2026 09:13:55*]
+ **PSSailpoint.Tenant 2.1.6**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*07/28/2026 09:13:50*]
+ **PSSailpoint.TaskManagement 2.1.6**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*07/28/2026 09:13:44*]
+ **PSSailpoint.Tags 2.1.6**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*07/28/2026 09:13:38*]
+ **PSSailpoint.TaggedObjects 2.1.6**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*07/28/2026 09:13:34*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.6**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*07/28/2026 09:13:28*]
+ **PSSailpoint.SpConfig 2.1.6**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*07/28/2026 09:13:23*]
+ **PSSailpoint.Sources 2.1.6**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*07/28/2026 09:13:15*]
+ **PSSailpoint.SourceUsages 2.1.6**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*07/28/2026 09:13:10*]
+ **PSSailpoint.SodViolations 2.1.6**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*07/28/2026 09:13:05*]
+ **PSSailpoint.SodPolicies 2.1.6**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*07/28/2026 09:12:59*]
+ **PSSailpoint.SimIntegrations 2.1.6**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*07/28/2026 09:12:54*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.6**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*07/28/2026 09:12:48*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.6**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*07/28/2026 09:12:40*]
+ **PSSailpoint.Segments 2.1.6**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*07/28/2026 09:12:34*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.6**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*07/28/2026 09:12:29*]
+ **PSSailpoint.Search 2.1.6**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*07/28/2026 09:12:24*]
+ **PSSailpoint.ScheduledSearch 2.1.6**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*07/28/2026 09:12:18*]
+ **PSSailpoint.SavedSearch 2.1.6**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*07/28/2026 09:12:13*]
+ **PSSailpoint.Roles 2.1.6**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*07/28/2026 09:12:06*]
+ **PSSailpoint.RolePropagation 2.1.6**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*07/28/2026 09:11:58*]
+ **PSSailpoint.RoleInsights 2.1.6**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*07/28/2026 09:11:51*]
+ **PSSailpoint.RequestableObjects 2.1.6**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*07/28/2026 09:11:46*]
+ **PSSailpoint.ReportsDataExtraction 2.1.6**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*07/28/2026 09:11:39*]
+ **PSSailpoint.PublicIdentitiesConfig 2.1.6**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*07/28/2026 09:11:34*]
+ **PSSailpoint.PublicIdentities 2.1.6**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*07/28/2026 09:11:23*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.6**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*07/28/2026 09:11:16*]
+ **PSSailpoint.PrivilegeCriteria 2.1.6**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*07/28/2026 09:11:03*]
+ **PSSailpoint.PersonalAccessTokens 2.1.6**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*07/28/2026 09:10:58*]
+ **PSSailpoint.PasswordSyncGroups 2.1.6**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*07/28/2026 09:10:51*]
+ **PSSailpoint.PasswordPolicies 2.1.6**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*07/28/2026 09:10:44*]
+ **PSSailpoint.PasswordManagement 2.1.6**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*07/28/2026 09:10:35*]
+ **PSSailpoint.PasswordDictionary 2.1.6**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*07/28/2026 09:10:30*]
+ **PSSailpoint.PasswordConfiguration 2.1.6**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*07/28/2026 09:10:22*]
+ **PSSailpoint.ParameterStorage 2.1.6**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*07/28/2026 09:10:16*]
+ **PSSailpoint.OrgConfig 2.1.6**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*07/28/2026 09:10:09*]
+ **PSSailpoint.OauthClients 2.1.6**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*07/28/2026 09:10:04*]
+ **PSSailpoint.Notifications 2.1.6**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*07/28/2026 09:09:58*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.6**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*07/28/2026 09:09:49*]
+ **PSSailpoint.MultiHostIntegration 2.1.6**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*07/28/2026 09:09:40*]
+ **PSSailpoint.MfaConfiguration 2.1.6**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*07/28/2026 09:09:33*]
+ **PSSailpoint.ManagedClusters 2.1.6**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*07/28/2026 09:09:26*]
+ **PSSailpoint.ManagedClusterTypes 2.1.6**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*07/28/2026 09:09:15*]
+ **PSSailpoint.ManagedClients 2.1.6**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*07/28/2026 09:09:09*]
+ **PSSailpoint.MachineIdentities 2.1.6**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*07/28/2026 09:09:03*]
+ **PSSailpoint.MachineClassificationConfig 2.1.6**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*07/28/2026 09:08:57*]
+ **PSSailpoint.MachineAccounts 2.1.6**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*07/28/2026 09:08:49*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.6**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*07/28/2026 09:08:40*]
+ **PSSailpoint.MachineAccountMappings 2.1.6**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*07/28/2026 09:08:34*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.6**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*07/28/2026 09:08:28*]
+ **PSSailpoint.MachineAccountClassify 2.1.6**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*07/28/2026 09:08:21*]
+ **PSSailpoint.LifecycleStates 2.1.6**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*07/28/2026 09:08:10*]
+ **PSSailpoint.Launchers 2.1.6**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*07/28/2026 09:08:04*]
+ **PSSailpoint.JitActivations 2.1.6**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*07/28/2026 09:07:57*]
+ **PSSailpoint.JitAccess 2.1.6**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*07/28/2026 09:07:51*]
+ **PSSailpoint.Intelligence 2.1.6**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*07/28/2026 09:07:42*]
+ **PSSailpoint.IdentityProfiles 2.1.6**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*07/28/2026 09:07:33*]
+ **PSSailpoint.IdentityHistory 2.1.6**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*07/28/2026 09:07:26*]
+ **PSSailpoint.IdentityAttributes 2.1.6**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*07/28/2026 09:07:18*]
+ **PSSailpoint.Identities 2.1.6**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*07/28/2026 09:07:12*]
+ **PSSailpoint.Icons 2.1.6**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*07/28/2026 09:07:04*]
+ **PSSailpoint.IaiRoleMining 2.1.6**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*07/28/2026 09:06:58*]
+ **PSSailpoint.IaiRecommendations 2.1.6**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*07/28/2026 09:06:50*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.1.6**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*07/28/2026 09:06:44*]
+ **PSSailpoint.IaiOutliers 2.1.6**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*07/28/2026 09:06:35*]
+ **PSSailpoint.IaiCommonAccess 2.1.6**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*07/28/2026 09:06:29*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.6**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*07/28/2026 09:06:23*]
+ **PSSailpoint.GovernanceGroups 2.1.6**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*07/28/2026 09:06:15*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.6**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*07/28/2026 09:06:08*]
+ **PSSailpoint.Entitlements 2.1.6**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*07/28/2026 09:06:01*]
+ **PSSailpoint.EntitlementConnections 2.1.6**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*07/28/2026 09:05:53*]
+ **PSSailpoint.Dimensions 2.1.6**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*07/28/2026 09:05:44*]
+ **PSSailpoint.DeclassifySource 2.1.6**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*07/28/2026 09:05:34*]
+ **PSSailpoint.DataSegmentation 2.1.6**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*07/28/2026 09:05:28*]
+ **PSSailpoint.DataAccessSecurity 2.1.6**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*07/28/2026 09:05:21*]
+ **PSSailpoint.CustomUserLevels 2.1.6**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*07/28/2026 09:05:13*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.6**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*07/28/2026 09:05:04*]
+ **PSSailpoint.CustomForms 2.1.6**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*07/28/2026 09:04:58*]
+ **PSSailpoint.Connectors 2.1.6**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*07/28/2026 09:04:49*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.6**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*07/28/2026 09:04:39*]
+ **PSSailpoint.ConnectorCustomizers 2.1.6**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*07/28/2026 09:04:32*]
+ **PSSailpoint.ConfigurationHub 2.1.6**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*07/28/2026 09:04:27*]
+ **PSSailpoint.ClassifySource 2.1.6**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*07/28/2026 09:04:22*]
+ **PSSailpoint.Certifications 2.1.6**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*07/28/2026 09:04:15*]
+ **PSSailpoint.CertificationSummaries 2.1.6**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*07/28/2026 09:04:04*]
+ **PSSailpoint.CertificationCampaigns 2.1.6**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*07/28/2026 09:04:00*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.6**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*07/28/2026 09:03:55*]
+ **PSSailpoint.Branding 2.1.6**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*07/28/2026 09:03:51*]
+ **PSSailpoint.AuthUsers 2.1.6**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*07/28/2026 09:03:42*]
+ **PSSailpoint.AuthProfile 2.1.6**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*07/28/2026 09:03:33*]
+ **PSSailpoint.Apps 2.1.6**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*07/28/2026 09:03:27*]
+ **PSSailpoint.Approvals 2.1.6**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*07/28/2026 09:03:21*]
+ **PSSailpoint.ApplicationDiscovery 2.1.6**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*07/28/2026 09:03:14*]
+ **PSSailpoint.ApiUsage 2.1.6**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*07/28/2026 09:03:01*]
+ **PSSailpoint.Accounts 2.1.6**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*07/28/2026 09:02:54*]
+ **PSSailpoint.AccountUsages 2.1.6**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*07/28/2026 09:02:48*]
+ **PSSailpoint.AccountDeletionRequests 2.1.6**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*07/28/2026 09:02:41*]
+ **PSSailpoint.AccountAggregations 2.1.6**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*07/28/2026 09:02:34*]
+ **PSSailpoint.AccountActivities 2.1.6**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*07/28/2026 09:02:27*]
+ **PSSailpoint.AccessRequests 2.1.6**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*07/28/2026 09:02:19*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.6**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*07/28/2026 09:02:12*]
+ **PSSailpoint.AccessRequestApprovals 2.1.6**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*07/28/2026 09:02:04*]
+ **PSSailpoint.AccessProfiles 2.1.6**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*07/28/2026 09:01:54*]
+ **PSSailpoint.AccessModelMetadata 2.1.6**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*07/28/2026 09:01:47*]
...
+ **[PSPublishModule 3.0.80](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*07/27/2026 21:40:59*]
...
+ **[Template-PSModule 0.0.12](https://github.com/PSModule/Template-PSModule)**  - Template for a PowerShell module repo. [*07/25/2026 16:32:53*]
...
+ **[Toml 0.0.2](https://github.com/PSModule/Toml)**  - A PowerShell module to manage conversion of Toml to objects and objects to Toml [*07/23/2026 15:57:32*]
...
+ **[PSAzTable 1.0.0.1](https://github.com/mgajda83/PSAzTable)**  - Read and write data in Azure Table Storage using REST API and OAuth2 authentication. [*07/28/2026 09:51:42*]
+ **[PSAzBlob 1.0.0.0](https://github.com/mgajda83/PSAzBlob)**  - Read and write data in Azure Blob Storage using REST API and OAuth2 authentication. [*07/27/2026 11:42:24*]
...
*Updated: Tuesday, 28 July 2026 11:46:27 UTC*
