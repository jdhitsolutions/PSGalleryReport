...
+ [James Brundage](#James-Brundage) (60)
...
+ **Invoke-IdracRemoteKvmHtmlSessionREDFISH 11.0.0**  - iDRAC cmdlet using Redfish API with OEM extension to launch virtual console KVM session using your default browser. [*10/31/2025 14:35:01*]
...
+ **Invoke-ChangeIdracUserPasswordREDFISH 11.0.0**  - iDRAC cmdlet using Redfish API to change iDRAC user password. Once the iDRAC user password has changed, cmdlet will execute GET command to validate the new password was set. If using dash or single quote in your current or new password, make sure to surround the password value with double quotes. [*10/31/2025 14:29:30*]
...
+ **IdracRedfishSupport 25.0.0.0**  - Main module used to import all individual iDRAC Redfish modules listed in the Powershell gallery. For more details and examples for each module, execute get-help on the specific module. [*10/31/2025 14:28:29*]
...
+ **[PSFramework 1.13.419](http://psframework.org/)**  - General Scripting Framework, providing PowerShell-specific infrastructure for other modules. [*11/24/2025 13:08:19*]
...
+ **[UncommonSense.Trouw 0.0.39.0](https://github.com/jhoek/UncommonSense.Trouw)**  - PowerShell module for listing Trouw articles [*12/03/2025 12:49:12*]
...
+ **[Servers101 0.1](https://github.com/PowerShellWeb/Servers101)**  - Simple Servers in PowerShell [*12/08/2025 20:05:23*]
...
+ **[GoogleFonts 1.0.92](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*12/09/2025 07:29:55*]
...
+ **[Universal 5.6.11](https://ironmansoftware.com/powershell-universal)**  - Module for PowerShell Universal. [*11/20/2025 00:23:08*]
...
+ **[PSIntro 1.0.1](https://github.com/jdhitsolutions/PSIntro)**  - A welcome screen for PowerShell and a set of brief tutorials designed for absolute beginners. The module also includes a few commands to help absolute PowerShell beginners manage their environment. [*12/01/2025 16:34:01*]
...
*Updated: Tuesday, 09 December 2025 09:53:49 UTC*
