...
+ **[ADEssentials 0.0.222](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*10/30/2024 10:57:01*]
...
+ **[PSSharedGoods 0.0.298](https://github.com/EvotecIT/PSSharedGoods)**  - Module covering functions that are shared within multiple projects [*10/27/2024 08:52:43*]
...
+ **[GPOZaurr 1.1.6](https://github.com/EvotecIT/GPOZaurr)**  - Group Policy Eater is a PowerShell module that aims to gather information about Group Policies but also allows fixing issues that you may find in them. [*10/17/2024 17:47:04*]
+ **[TheDashboard 0.0.29](https://github.com/EvotecIT/TheDashboard)**  - TheDashboard is a module that allows you to create a dashboard for your HTML reports [*10/08/2024 07:02:44*]
...
+ **[DomainManagement 1.8.205](https://admf.one/)**  - Module to manage domain configuration [*10/23/2024 07:27:31*]
+ **[EntraAuth 1.3.19](https://github.com/FriedrichWeinmann/EntraAuth)**  - Get Tokens from Entra ID [*10/13/2024 13:21:01*]
...
+ **[ugit 0.4.5](https://github.com/StartAutomating/ugit)**  - ugit: git, updated with PowerShell [*10/16/2024 02:17:12*]
...
+ **[PSOpenAI 4.9.1](https://github.com/mkht/PSOpenAI)**  - PowerShell module for OpenAI API [*11/01/2024 17:28:12*]
...
+ **spec.base.utilities 1.2.13**  - Mandatory module for the foundation PowerShell scripts. [*11/01/2024 13:26:41*]
+ **spec.teamviewer.utilities 1.1.9**  - A module to help manage TeamViewer [*11/01/2024 09:05:58*]
...
+ **[PureStorage.CBS.AVS 1.1.370](https://support.purestorage.com/Pure_Cloud_Block_Store/Azure_VMware_Solution_and_Cloud_Block_Store_Implementation_Guide)**  - Pure Storage FlashArray AVS Plugin. [*10/21/2024 18:50:16*]
...
+ **[UncommonSense.Cinema 0.1.0](https://github.com/jhoek/UncommonSense.Cinema)**  - Film listing for my favorite cinemas [*10/31/2024 13:29:17*]
...
+ **[UncommonSense.Volkskrant 0.0.56.0](https://github.com/jhoek/UncommonSense.Volkskrant)**  - PowerShell module for listing Volkskrant articles [*09/22/2024 11:46:04*]
...
+ **[PSAI 0.3.0](https://github.com/dfinke/PSAI)**  - PSAI brings OpenAI ChatGPT to PowerShell, leveraging advanced AI capabilities in your PowerShell scripts for dynamic, intelligent automation and data processing [*11/03/2024 15:05:43*]
...
*Updated: Wednesday, 06 November 2024 02:14:30 UTC*
