...
+ **[Dargslan.PostgresHealth 1.0.0](https://dargslan.com/)**  - Check PostgreSQL database server health on Windows — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:12*]
+ **[Dargslan.PortMonitor 1.0.0](https://dargslan.com/)**  - Monitor open TCP/UDP ports and listening services — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:11*]
+ **[Dargslan.PamAudit 1.0.0](https://dargslan.com/)**  - Audit Windows authentication policies and credential providers — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:08*]
+ **[Dargslan.PasswdAudit 1.0.0](https://dargslan.com/)**  - Audit local user password policies and expiration — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:08*]
+ **[Dargslan.PackageAudit 1.0.0](https://dargslan.com/)**  - Audit installed software packages and versions — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:07*]
+ **[Dargslan.NumaCheck 1.0.0](https://dargslan.com/)**  - Check NUMA topology and memory node configuration — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:04*]
+ **[Dargslan.NtpCheck 1.0.0](https://dargslan.com/)**  - Check time synchronization and NTP configuration — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:19:02*]
...
+ **[Dargslan.JournaldAnalyzer 1.0.0](https://dargslan.com/)**  - Analyze Windows Event Log patterns and anomalies — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:18:19*]
+ **[Dargslan.WinFirewallAudit 1.0.0](https://dargslan.com/blog/windows-firewall-audit-powershell-2026)**  - Audit Windows Firewall profiles and rules. Detect risky Allow Any Any rules, disabled profiles and GPO overrides. JSON / HTML compliance report. [*04/18/2026 19:18:18*]
+ **[Dargslan.JournalExport 1.0.0](https://dargslan.com/)**  - Export Windows Event Log entries to various formats — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:18:17*]
...
+ **[Dargslan.IptablesExport 1.0.0](https://dargslan.com/)**  - Export Windows Firewall rules to file for backup — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:18:13*]
...
+ **[Dargslan.EntropyCheck 1.0.0](https://dargslan.com/)**  - Check system randomness and cryptographic entropy sources — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:17:44*]
+ **[Dargslan.DockerHealth 1.0.0](https://dargslan.com/)**  - Check Docker Desktop and container engine health on Windows — Part of the Dargslan Windows Admin Tools collection. More at https://dargslan.com [*04/18/2026 19:17:42*]
...
+ **[Dargslan.WinPowerPlan 2.0.0](https://dargslan.com/)**  - Windows power plan optimization toolkit — active plan analysis, custom plan detection, battery health, thermal monitoring, and energy efficiency scoring [*04/14/2026 17:35:47*]
...
+ **[Dargslan.WinDeviceEncryption 2.0.0](https://dargslan.com/)**  - Windows device encryption audit toolkit — encryption status across all drives, recovery key backup, encryption method, and compliance status [*04/14/2026 17:32:39*]
...
+ **[Dargslan.WinClipboardAudit 2.0.0](https://dargslan.com/)**  - Windows clipboard and data transfer security toolkit — clipboard history, cloud clipboard, cross-device sync, and data leakage prevention [*04/14/2026 17:31:52*]
...
+ **[Dargslan.WinRegistryAudit 1.0.0](https://dargslan.com/)**  - Windows Registry auditing toolkit — registry key analysis, security assessment, startup entries, autorun detection, and registry backup [*04/14/2026 16:38:03*]
...
+ **PSSailpoint.NERMV2025 2.1.44**  - PSSailpoint.NERMV2025 - the PowerShell module for NERM API v2025 [*09/23/2026 08:36:21*]
+ **PSSailpoint.NERM 2.1.44**  - PSSailpoint.NERM - the PowerShell module for NERM API [*09/23/2026 08:36:12*]
+ **PSSailpoint.Workflows 2.1.44**  - PSSailpoint.Workflows - the PowerShell module for Identity Security Cloud API - Workflows [*09/23/2026 08:35:50*]
+ **PSSailpoint.WorkReassignment 2.1.44**  - PSSailpoint.WorkReassignment - the PowerShell module for Identity Security Cloud API - Work Reassignment [*09/23/2026 08:35:44*]
+ **PSSailpoint.WorkItems 2.1.44**  - PSSailpoint.WorkItems - the PowerShell module for Identity Security Cloud API - Work Items [*09/23/2026 08:35:39*]
+ **PSSailpoint.UiMetadata 2.1.44**  - PSSailpoint.UiMetadata - the PowerShell module for Identity Security Cloud API - UI Metadata [*09/23/2026 08:35:34*]
+ **PSSailpoint.Triggers 2.1.44**  - PSSailpoint.Triggers - the PowerShell module for Identity Security Cloud API - Triggers [*09/23/2026 08:35:29*]
+ **PSSailpoint.Transforms 2.1.44**  - PSSailpoint.Transforms - the PowerShell module for Identity Security Cloud API - Transforms [*09/23/2026 08:35:17*]
+ **PSSailpoint.TenantContext 2.1.44**  - PSSailpoint.TenantContext - the PowerShell module for Identity Security Cloud API - Tenant Context [*09/23/2026 08:35:11*]
+ **PSSailpoint.Tenant 2.1.44**  - PSSailpoint.Tenant - the PowerShell module for Identity Security Cloud API - Tenant [*09/23/2026 08:35:06*]
+ **PSSailpoint.TaskManagement 2.1.44**  - PSSailpoint.TaskManagement - the PowerShell module for Identity Security Cloud API - Task Management [*09/23/2026 08:34:56*]
+ **PSSailpoint.Tags 2.1.44**  - PSSailpoint.Tags - the PowerShell module for Identity Security Cloud API - Tags [*09/23/2026 08:34:46*]
+ **PSSailpoint.TaggedObjects 2.1.44**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*09/23/2026 08:34:37*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.44**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*09/23/2026 08:34:32*]
+ **PSSailpoint.SpConfig 2.1.44**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*09/23/2026 08:34:26*]
+ **PSSailpoint.Sources 2.1.44**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*09/23/2026 08:34:21*]
+ **PSSailpoint.SourceUsages 2.1.44**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*09/23/2026 08:34:15*]
+ **PSSailpoint.SodViolations 2.1.44**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*09/23/2026 08:34:09*]
+ **PSSailpoint.SodPolicies 2.1.44**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*09/23/2026 08:33:56*]
+ **PSSailpoint.SodControls 2.1.44**  - PSSailpoint.SodControls - the PowerShell module for Identity Security Cloud API - SOD Controls [*09/23/2026 08:33:36*]
+ **PSSailpoint.SimIntegrations 2.1.44**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*09/23/2026 08:33:19*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.44**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*09/23/2026 08:33:05*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.44**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*09/23/2026 08:32:46*]
+ **PSSailpoint.Segments 2.1.44**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*09/23/2026 08:32:31*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.44**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*09/23/2026 08:32:12*]
+ **PSSailpoint.Search 2.1.44**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*09/23/2026 08:31:56*]
+ **PSSailpoint.ScheduledSearch 2.1.44**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*09/23/2026 08:31:48*]
+ **PSSailpoint.SavedSearch 2.1.44**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*09/23/2026 08:31:39*]
+ **PSSailpoint.Roles 2.1.44**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*09/23/2026 08:31:25*]
+ **PSSailpoint.RolePropagation 2.1.44**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*09/23/2026 08:31:12*]
+ **PSSailpoint.RoleInsights 2.1.44**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*09/23/2026 08:30:59*]
+ **PSSailpoint.RequestableObjects 2.1.44**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*09/23/2026 08:30:46*]
+ **PSSailpoint.ReportsDataExtraction 2.1.44**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*09/23/2026 08:30:36*]
+ **PSSailpoint.PublicMachineIdentities 2.1.44**  - PSSailpoint.PublicMachineIdentities - the PowerShell module for Identity Security Cloud API - Public Machine Identities [*09/23/2026 08:30:31*]
+ **PSSailpoint.PublicIdentitiesConfig 2.1.44**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*09/23/2026 08:30:26*]
+ **PSSailpoint.PublicIdentities 2.1.44**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*09/23/2026 08:30:21*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.44**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*09/23/2026 08:30:16*]
+ **PSSailpoint.PrivilegeCriteria 2.1.44**  - PSSailpoint.PrivilegeCriteria - the PowerShell module for Identity Security Cloud API - Privilege Criteria [*09/23/2026 08:30:10*]
+ **PSSailpoint.PersonalAccessTokens 2.1.44**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*09/23/2026 08:30:04*]
+ **PSSailpoint.PasswordSyncGroups 2.1.44**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*09/23/2026 08:29:52*]
+ **PSSailpoint.PasswordPolicies 2.1.44**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*09/23/2026 08:29:47*]
+ **PSSailpoint.PasswordManagement 2.1.44**  - PSSailpoint.PasswordManagement - the PowerShell module for Identity Security Cloud API - Password Management [*09/23/2026 08:29:41*]
+ **PSSailpoint.PasswordDictionary 2.1.44**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*09/23/2026 08:29:35*]
+ **PSSailpoint.PasswordConfiguration 2.1.44**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*09/23/2026 08:29:25*]
+ **PSSailpoint.ParameterStorage 2.1.44**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*09/23/2026 08:29:09*]
+ **PSSailpoint.OrgConfig 2.1.44**  - PSSailpoint.OrgConfig - the PowerShell module for Identity Security Cloud API - Org Config [*09/23/2026 08:28:58*]
+ **PSSailpoint.OauthClients 2.1.44**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*09/23/2026 08:28:44*]
+ **PSSailpoint.Notifications 2.1.44**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*09/23/2026 08:28:33*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.44**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*09/23/2026 08:28:14*]
+ **PSSailpoint.MultiHostIntegration 2.1.44**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*09/23/2026 08:28:05*]
+ **PSSailpoint.MfaConfiguration 2.1.44**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*09/23/2026 08:27:53*]
+ **PSSailpoint.ManagedClusters 2.1.44**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*09/23/2026 08:27:39*]
+ **PSSailpoint.ManagedClusterTypes 2.1.44**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*09/23/2026 08:27:26*]
+ **PSSailpoint.ManagedClients 2.1.44**  - PSSailpoint.ManagedClients - the PowerShell module for Identity Security Cloud API - Managed Clients [*09/23/2026 08:27:06*]
+ **PSSailpoint.MachineIdentitiesLifecycleActions 2.1.44**  - PSSailpoint.MachineIdentitiesLifecycleActions - the PowerShell module for Identity Security Cloud API - Machine Identity Lifecycle Actions [*09/23/2026 08:26:50*]
+ **PSSailpoint.MachineIdentities 2.1.44**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*09/23/2026 08:26:35*]
+ **PSSailpoint.MachineClassificationConfig 2.1.44**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*09/23/2026 08:26:26*]
+ **PSSailpoint.MachineAccounts 2.1.44**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*09/23/2026 08:26:05*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.44**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*09/23/2026 08:25:53*]
+ **PSSailpoint.MachineAccountMappings 2.1.44**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*09/23/2026 08:25:41*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.44**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*09/23/2026 08:25:28*]
+ **PSSailpoint.MachineAccountClassify 2.1.44**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*09/23/2026 08:25:21*]
+ **PSSailpoint.LifecycleStates 2.1.44**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*09/23/2026 08:25:13*]
+ **PSSailpoint.Launchers 2.1.44**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*09/23/2026 08:25:05*]
+ **PSSailpoint.JitActivations 2.1.44**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*09/23/2026 08:24:54*]
+ **PSSailpoint.JitAccess 2.1.44**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*09/23/2026 08:24:37*]
+ **PSSailpoint.Intelligence 2.1.44**  - PSSailpoint.Intelligence - the PowerShell module for Identity Security Cloud API - Intelligence [*09/23/2026 08:24:31*]
+ **PSSailpoint.IdentityProfiles 2.1.44**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*09/23/2026 08:24:21*]
+ **PSSailpoint.IdentityHistory 2.1.44**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*09/23/2026 08:24:06*]
+ **PSSailpoint.IdentityAttributes 2.1.44**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*09/23/2026 08:23:57*]
+ **PSSailpoint.Identities 2.1.44**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*09/23/2026 08:23:42*]
+ **PSSailpoint.Icons 2.1.44**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*09/23/2026 08:23:24*]
+ **PSSailpoint.IaiRoleMining 2.1.44**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*09/23/2026 08:23:08*]
+ **PSSailpoint.IaiRecommendations 2.1.44**  - PSSailpoint.IaiRecommendations - the PowerShell module for Identity Security Cloud API - IAI Recommendations [*09/23/2026 08:22:54*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.1.44**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*09/23/2026 08:22:35*]
+ **PSSailpoint.IaiOutliers 2.1.44**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*09/23/2026 08:22:18*]
+ **PSSailpoint.IaiCommonAccess 2.1.44**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*09/23/2026 08:21:59*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.44**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*09/23/2026 08:21:45*]
+ **PSSailpoint.GovernanceGroups 2.1.44**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*09/23/2026 08:21:30*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.44**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*09/23/2026 08:21:12*]
+ **PSSailpoint.Entitlements 2.1.44**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*09/23/2026 08:21:03*]
+ **PSSailpoint.EntitlementConnections 2.1.44**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*09/23/2026 08:20:47*]
+ **PSSailpoint.Dimensions 2.1.44**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*09/23/2026 08:20:35*]
+ **PSSailpoint.DeclassifySource 2.1.44**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*09/23/2026 08:20:17*]
+ **PSSailpoint.DataSegmentation 2.1.44**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*09/23/2026 08:20:03*]
+ **PSSailpoint.DataAccessSecurity 2.1.44**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*09/23/2026 08:19:40*]
+ **PSSailpoint.CustomUserLevels 2.1.44**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*09/23/2026 08:19:25*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.44**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*09/23/2026 08:19:09*]
+ **PSSailpoint.CustomForms 2.1.44**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*09/23/2026 08:19:01*]
+ **PSSailpoint.Connectors 2.1.44**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*09/23/2026 08:18:46*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.44**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*09/23/2026 08:18:34*]
+ **PSSailpoint.ConnectorCustomizers 2.1.44**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*09/23/2026 08:18:17*]
+ **PSSailpoint.ConfigurationHub 2.1.44**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*09/23/2026 08:18:04*]
+ **PSSailpoint.ClassifySource 2.1.44**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*09/23/2026 08:17:43*]
+ **PSSailpoint.Certifications 2.1.44**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*09/23/2026 08:17:30*]
+ **PSSailpoint.CertificationSummaries 2.1.44**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*09/23/2026 08:17:10*]
+ **PSSailpoint.CertificationCampaigns 2.1.44**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*09/23/2026 08:16:46*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.44**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*09/23/2026 08:16:34*]
+ **PSSailpoint.BusinessApplications 2.1.44**  - PSSailpoint.BusinessApplications - the PowerShell module for Identity Security Cloud API - Business Applications [*09/23/2026 08:16:17*]
+ **PSSailpoint.Branding 2.1.44**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*09/23/2026 08:16:06*]
+ **PSSailpoint.AuthUsers 2.1.44**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*09/23/2026 08:15:54*]
+ **PSSailpoint.AuthProfile 2.1.44**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*09/23/2026 08:15:40*]
+ **PSSailpoint.Apps 2.1.44**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*09/23/2026 08:15:31*]
+ **PSSailpoint.Approvals 2.1.44**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*09/23/2026 08:15:15*]
+ **PSSailpoint.ApplicationDiscovery 2.1.44**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*09/23/2026 08:15:05*]
+ **PSSailpoint.ApiUsage 2.1.44**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*09/23/2026 08:14:59*]
+ **PSSailpoint.Accounts 2.1.44**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*09/23/2026 08:14:51*]
+ **PSSailpoint.AccountUsages 2.1.44**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*09/23/2026 08:14:35*]
+ **PSSailpoint.AccountDeletionRequests 2.1.44**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*09/23/2026 08:14:24*]
+ **PSSailpoint.AccountAggregations 2.1.44**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*09/23/2026 08:14:09*]
+ **PSSailpoint.AccountActivities 2.1.44**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*09/23/2026 08:13:53*]
+ **PSSailpoint.AccessRequests 2.1.44**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*09/23/2026 08:13:45*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.44**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*09/23/2026 08:13:39*]
+ **PSSailpoint.AccessRequestApprovals 2.1.44**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*09/23/2026 08:13:23*]
+ **PSSailpoint.AccessProfiles 2.1.44**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*09/23/2026 08:13:17*]
+ **PSSailpoint.AccessModelMetadata 2.1.44**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*09/23/2026 08:13:08*]
...
+ **[VMware.CloudFoundation.InstanceRecovery 9.1.1.1002](https://vmware.github.io/powershell-module-for-vmware-cloud-foundation-instance-recovery)**  - PowerShell Module for VMware Cloud Foundation Instance Recovery [*09/23/2026 08:33:35*]
+ **[VCF.PowerCLI 9.1.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains commands for managing services part of VMware Cloud Foundation. This module is a continuation of the module VMware.PowerCLI. As part of our ongoing commitment to align more closely with VMware Cloud Foundation (VCF) and to better reflect the focus of our automation tooling, VMware PowerCLI has been renamed to VCF PowerCLI. This change reinforces our direction to deliver a more tailored and streamlined automation experience specifically for VCF environments. While the name has changed, the functionality and powerful capabilities you rely on remain intact. All existing cmdlets, modules, and automation scripts continue to work as expected.

For more information on how to install the module and troubleshooting see:
https://developer.broadcom.com/powercli/installation-guide [*09/10/2026 11:26:45*]
+ **[VMware.VimAutomation.Hcx 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This Windows PowerShell module contains PowerCLI HCX cmdlets. [*09/10/2026 11:26:04*]
+ **[VMware.DeployAutomation 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI Auto Deploy cmdlets. [*09/10/2026 11:25:46*]
+ **[VMware.Sdk.Nsx.Policy 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy API. [*09/10/2026 11:25:30*]
+ **[VMware.Sdk.Srm 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Srm API. [*09/10/2026 11:25:11*]
+ **[VMware.Sdk.Vcf.CloudBuilder 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Vcf.CloudBuilder API. [*09/10/2026 11:24:54*]
+ **[VMware.Sdk.Vcf.Installer 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Vcf.Installer API. [*09/10/2026 11:24:38*]
+ **[VMware.Sdk.Vcf.Ops 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Vcf.Ops API. [*09/10/2026 11:24:21*]
+ **[VMware.Sdk.Vr 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Vr API. [*09/10/2026 11:24:04*]
+ **[VMware.Sdk.vSphere 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.vSphere API. [*09/10/2026 11:23:47*]
+ **[VMware.Vcf.SddcManager 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - PowerCLI VCF SDDC manager module. [*09/10/2026 11:23:28*]
+ **[VMware.VimAutomation.WorkloadManagement 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - PowerShell commands for automation of workloads related functionality in vSphere. [*09/10/2026 11:23:11*]
+ **[VMware.VimAutomation.Cloud 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI Cloud cmdlets. [*09/10/2026 11:22:54*]
+ **[VMware.VumAutomation 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI VUM cmdlets. [*09/10/2026 11:22:36*]
+ **[VMware.VimAutomation.License 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI cmdlets for managing VMware product licenses. [*09/10/2026 11:22:05*]
+ **[VMware.VimAutomation.Nsxt 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI NSXT cmdlets. [*09/10/2026 11:21:48*]
+ **[VMware.VimAutomation.vROps 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI vROps cmdlets. [*09/10/2026 11:21:31*]
+ **[VMware.VimAutomation.Security 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI security management cmdlets. [*09/10/2026 11:21:13*]
+ **[VMware.VimAutomation.Srm 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI SRM cmdlets. [*09/10/2026 11:20:57*]
+ **[VMware.VimAutomation.Vpc 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI NSX VPC cmdlets. [*09/10/2026 11:20:38*]
+ **[VMware.VimAutomation.Vmc 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI VMC cmdlets. [*09/10/2026 11:20:21*]
+ **[VMware.CloudServices 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - PowerShell module that contains command for VMware Cloud Services. [*09/10/2026 11:20:04*]
+ **[VMware.ImageBuilder 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI ImageBuilder cmdlets. [*09/10/2026 11:19:46*]
+ **[VMware.Sdk.Vcf.SddcManager 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Vcf.SddcManager API. [*09/10/2026 11:18:29*]
+ **[VMware.VimAutomation.Vds 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI VDS cmdlets. [*09/10/2026 11:18:11*]
+ **[VMware.Sdk.Nsx.Policy.GlobalInfra 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy.GlobalInfra API. [*09/10/2026 11:17:54*]
+ **[VMware.Sdk.Nsx.Policy.Infra 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy.Infra API. [*09/10/2026 11:17:37*]
+ **[VMware.VimAutomation.Storage 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This Windows PowerShell module contains PowerCLI storage management cmdlets. [*09/10/2026 11:17:18*]
+ **[VMware.VimAutomation.Core 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains Windows PowerShell cmdlets for managing vSphere. [*09/10/2026 11:16:54*]
+ **[VMware.Sdk.Nsx.Policy.Initialize 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains cmdlets for managing VMware.Sdk.Nsx.Policy.Initialize API. [*09/10/2026 11:16:35*]
+ **[VMware.VimAutomation.Cis.Core 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI Cloud Infrastructure Suite cmdlets. [*09/10/2026 11:16:17*]
+ **[VMware.OpenAPI 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI OpenAPI bindings. [*09/10/2026 11:15:57*]
+ **[VMware.Vim 9.1.0.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI Vim. [*09/10/2026 11:15:30*]
+ **[VMware.Vcf.Sso 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - PowerCLI VCF SSO module. [*09/10/2026 11:15:05*]
+ **[VMware.VimAutomation.Common 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains functionality required by multiple PowerCLI modules. [*09/10/2026 11:14:47*]
+ **[VMware.VimAutomation.Sdk 13.5.1.25718932](https://developer.broadcom.com/powercli)**  - This PowerShell module contains PowerCLI Sdk. [*09/10/2026 11:14:29*]
+ **[VcfPatchScanner 1.0.0.1008](https://github.com/vmware/powershell-module-for-vcf-patch-scanner)**  - VCF Patch Scanner Module [*07/13/2026 13:55:04*]
+ **[VcfEdgeAtScale 1.0.3.1023](https://github.com/vmware/powershell-module-for-vcf-edge-at-scale)**  - VcfEdgeAtScale automates end-to-end vSphere Supervisor deployment in VMware Cloud Foundation 9.x,
...
Requires VCF PowerCLI 9.0+, kubectl, and the VCF CLI. [*06/05/2026 01:37:48*]
...
+ **[CleanupMonster 3.1.15](https://github.com/EvotecIT/CleanupMonster)**  - This module provides an easy way to cleanup Active Directory and cloud devices from dead/old objects based on various criteria. It can also disable, move, retire or delete objects. It can utilize Azure AD, Intune and Jamf to get additional information about objects before deleting them. [*09/22/2026 18:31:11*]
+ **GraphEssentials 0.0.63**  - GraphEssentials is a PowerShell module that helps with Office 365 / Azure AD using mostly Graph [*09/22/2026 18:23:39*]
+ **[PSPublishModule 3.0.150](https://github.com/EvotecIT/PSPublishModule)**  - Simple project allowing preparing, managing, building and publishing modules to PowerShellGallery [*09/22/2026 14:01:30*]
...
+ **[GPOZaurr 1.1.11](https://github.com/EvotecIT/GPOZaurr)**  - Group Policy Eater is a PowerShell module that aims to gather information about Group Policies but also allows fixing issues that you may find in them. [*09/20/2026 18:05:37*]
+ **[ADEssentials 1.0.5](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*09/20/2026 17:38:00*]
+ **[Testimo 0.0.92](https://github.com/EvotecIT/Testimo)**  - Testimo is Powershell module that tests Active Directory against specific set of tests. [*09/20/2026 17:22:14*]
+ **[PSWriteColor 1.0.4](https://github.com/EvotecIT/PSWriteColor)**  - Write-Color is a wrapper around Write-Host allowing you to create nice looking scripts, with colorized output. It provides easy manipulation of colors, logging output to file (log) and nice formatting options out of the box. [*09/20/2026 16:50:35*]
+ **[PSEventViewer 4.0.0](https://github.com/EvotecIT/EventViewerX)**  - High-performance typed Windows Event Log queries, reports, exports, watchers, WEC, custom providers, diagnostics, and administration for PowerShell. [*09/20/2026 16:30:37*]
...
+ **[PSWinReporting 1.8.1.8](https://github.com/EvotecIT/EventViewerX)**  - This PowerShell Module, which started as an event library (Get-EventsLibrary.ps1), has now grown up and became full fledged PowerShell Module. This module has multiple functionalities but one of the signature features of this module is ability to parse Security (mostly) logs on Domain Controllers. [*09/04/2026 11:58:03*]
+ **[O365Synchronizer 1.0.4](https://github.com/EvotecIT/O365Synchronizer)**  - This module allows to synchronize users to/from Office 365. You can synchronize users information to personal contacts or synchronize tenants between each other. [*09/02/2026 16:12:57*]
+ **[PowerBGInfo 2.0.3](https://github.com/EvotecIT/PowerBGInfo)**  - PowerBGInfo is a module that allows you to create background images with information about your environment. [*09/02/2026 13:43:48*]
+ **[DesktopManager 4.4.0](https://github.com/EvotecIT/DesktopManager)**  - Desktop Manager is a PowerShell module that allows easy way to change wallpaper on multiple screens/monitors. [*09/02/2026 10:20:15*]
+ **[FileInspectorX 1.1.3](https://github.com/EvotecIT/FileInspectorX)**  - FileInspectorX is PowerShell module that allows you to query files and folders for information. It supports multiple types of file queries and can be used to query local file systems, network shares. [*09/01/2026 18:07:37*]
+ **[Transferetto 2.0.1](https://github.com/EvotecIT/Transferetto)**  - Transferetto provides reusable .NET and PowerShell data transfer across filesystems, FTP, FTPS, SFTP, SCP, FXP, Amazon S3 and S3-compatible storage, Azure Blob Storage, and SSH operations. [*08/31/2026 21:20:44*]
+ **[PSParseHTML 3.0.1](https://github.com/EvotecIT/HtmlTinkerX)**  - Module that allows to manipulate, parse, format and optimize HTML, JavaScript and CSS [*08/24/2026 11:09:18*]
+ **[ImagePlayground 3.2.7](https://github.com/EvotecIT/ImagePlayground)**  - Unified PowerShell commands for image processing, charts, topology diagrams, visual stories, QR codes, and barcodes. [*08/20/2026 12:37:26*]
+ **[VirusTotalAnalyzer 1.0.0](https://github.com/EvotecIT/VirusTotalAnalyzer)**  - VirusTotal API v3 module for reports, submissions, community data, and publisher Monitor workflows. [*08/13/2026 09:08:55*]
+ **[PSPGP 1.0.1](https://github.com/EvotecIT/PSPGP)**  - PSPGP is a PowerShell module that provides PGP functionality in PowerShell. It allows encrypting and decrypting files/folders and strings using PGP. [*07/08/2026 08:20:58*]
...
+ **Set-NextOneTimeBootDeviceREDFISH 8.0.0**  - iDRAC cmdlet using Redfish API to either get current next boot onetime boot device value / supported possible values or set next onetime boot device with reboot now or no reboot but still set next onetime boot device. [*03/24/2026 13:23:06*]
...
+ **Set-MultipleBIOSAttributesREDFISH 9.0.0**  - iDRAC cmdlet using Redfish API to either get current BIOS attribute settings, get specific BIOS attribute current value, get BIOS attribute registry or set mulitple BIOS attributes. [*10/31/2025 14:46:58*]
+ **Set-ImportServerConfigurationProfileLocalREDFISH 5.0.0**  - Cmdlet using iDRAC with Redfish OEM extension to import server configuration profile (SCP) file locally using ImportBuffer property. The SCP file contents will be passed directly in the script. [*10/31/2025 14:46:40*]
+ **Set-IdracLcSystemAttributesREDFISH 10.0.0**  - iDRAC cmdlet using Redfish API with OEM extension to either get iDRAC, Lifecycle Controller(LC) or System attributes or set one or multiple iDRAC, LC or System attributes. [*10/31/2025 14:46:07*]
...
+ **[EntraAuth.Azure 1.0.0](https://github.com/FriedrichWeinmann/EntraAuth.Azure)**  - EntraAuth-based core tooling for working with the Azure Resource Manager API [*09/16/2026 15:54:56*]
...
+ **ProductivityTools.RemoveEmptyDirectories 1.1.10**  - Provides a function to recursively find and remove empty directories, with an option to handle directories containing only Thumbs.db. [*05/26/2026 18:50:25*]
+ **[ProductivityTools.StartApplication 0.0.11](http://www.productivitytools.tech/start-application/)**  - Not working currently [*02/06/2026 18:53:51*]
+ **ProductivityTools.Backup 0.0.5**  - Simple backup script [*01/18/2026 17:58:11*]
+ **ProductivityTools.DirectoryReverseOrder 0.0.5**  - Set the leading number to the directory [*09/09/2025 16:30:39*]
+ **[ProductivityTools.RemoveModules 0.0.17](https://github.com/pwujczyk/ProductivityTools.RemoveModules)**  - Module allows to remove modules [*06/09/2025 20:51:18*]
...
+ **[ProductivityTools.CloudItems 0.0.10](http://productivitytools.tech/cloud-blobs/)**  - Module allows to push directories and files to azure in the simplest way possible [*06/09/2025 20:37:23*]
+ **ProductivityTools.FindPhotographDuplicates 0.0.14**  - It finds all photographs in the master and the slave directory, after this it compares them by date and time taken and optionally by size and name. It can then remove all duplicates or return paths to duplicates. Before removing pictures can be checked in compare directory [*06/09/2025 06:43:14*]
...
+ **[PSMSAL 4.87.0.8](https://github.com/mgajda83/PSMSAL)**  - PowerShell module for MSAL Tokens. [*07/28/2026 10:56:15*]
...
*Updated: Wednesday, 23 September 2026 14:28:02 UTC*
