...
+ [Przemyslaw Klys](#Przemyslaw-Klys) (57)
+ [Adam Driscoll](#Adam-Driscoll) (42)
+ [Friedrich Weinmann](#Friedrich-Weinmann) (36)
+ [Jeff Hicks](#Jeff-Hicks) (34)
+ [Michael Haken](#Michael-Haken) (30)
+ [Akamai Technologies Ltd.](#Akamai-Technologies-Ltd) (27)
+ [mkht](#mkht) (23)
+ [James Brundage](#James-Brundage) (22)
+ [Christos Polydorou](#Christos-Polydorou) (21)
+ [Jan Hoek](#Jan-Hoek) (21)
+ [Joel Bennett](#Joel-Bennett) (20)
+ [Pure Storage](#Pure-Storage) (19)
+ [Warren Frame](#Warren-Frame) (18)
+ [Adam Bertram](#Adam-Bertram) (18)
+ [EPRSBuildTeam](#EPRSBuildTeam) (18)
+ [Brandon Olin](#Brandon-Olin) (17)
+ [owen.heaume](#owenheaume) (17)
+ [Chris Clohosy](#Chris-Clohosy) (17)
+ [Douglas Finke](#Douglas-Finke) (17)
+ [Chrissy LeMaire](#Chrissy-LeMaire) (17)
+ [strike](#strike) (16)
+ [Gabriel Adrian Samfira Alessandro Pilotti](#Gabriel-Adrian-Samfira-Alessandro-Pilotti) (16)
+ [WebMD Health Services](#WebMD-Health-Services) (16)
+ [jakub.pawlowski](#jakubpawlowski) (16)
...
+ **[PasswordSolution 1.2.8](https://github.com/EvotecIT/PasswordSolution)**  - This module allows the creation of password expiry emails for users, managers, administrators, and security according to defined templates. It's able to work with different rules allowing to fully customize who gets the email and when. [*08/22/2024 08:57:33*]
...
+ **[mySQLite 0.13.0](https://github.com/jdhitsolutions/MySQLite)**  - A set of PowerShell commands for working with SQLite database files. This is a simple alternative to installing any version of SQL Server on your desktop. Note that this module will only work on x64 versions Windows and Linux platforms. [*02/22/2024 15:48:50*]
...
+ **spec.file.utilities 2.0.6**  - A module for efficient file management, enabling seamless file downloads from Azure Blob storage, file hash comparisons, and a suite of essential file operations. [*08/19/2024 11:26:39*]
...
+ **spec.base.utilities 1.2.11**  - Mandatory module for the foundation PowerShell scripts. [*07/09/2024 14:10:51*]
+ **spec.psengine 1.0.3**  - A module required by PSEngine base script. [*07/04/2024 14:01:56*]
+ **spec.azure.tables 1.1.2**  - A module for interacting with Azure Tables [*07/03/2024 09:28:17*]
...
+ **spec.comport.management 1.0.2**  - PowerShell module for efficient management of COM ports, allowing the ability to set a new comport. [*02/29/2024 11:30:59*]
+ **spec.module.management 1.0.3**  - Provides advanced functions for installing, importing, checking, and uninstalling PowerShell modules. [*02/20/2024 19:54:45*]
+ **spec.teamviewer.utilities 1.1.4**  - A module to help manage TeamViewer [*01/29/2024 14:42:12*]
...
+ **[Prism 0.6.1](https://github.com/webmd-health-services/Prism)**  - Prism is a PowerShell module manager inspired by NuGet. Run `prism install` in a source code repository, and Prism will
...
get modules installed. [*01/30/2024 18:49:06*]
...
*Updated: Thursday, 22 August 2024 09:51:23 UTC*
