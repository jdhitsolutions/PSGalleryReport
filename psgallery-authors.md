...
+ **[ADEssentials 0.0.260](https://github.com/EvotecIT/ADEssentials)**  - Helper module for Active Directory with lots of useful functions that simplify supporting Active Directory. [*09/29/2025 09:42:58*]
...
+ **[ADMF 1.13.110](https://admf.one/)**  - Central Management Component of the Active Directory Management Framework [*10/02/2025 11:49:47*]
+ **[ForestManagement 1.5.81](https://admf.one/)**  - Infrastructure module to build and maintain forest configuration [*10/02/2025 10:55:22*]
+ **[DomainManagement 1.9.228](https://admf.one/)**  - Module to manage domain configuration [*10/02/2025 10:52:56*]
+ **[PkiExtension 1.1.3](https://github.com/FriedrichWeinmann/PkiExtension)**  - Extends the core feature set of the PKI Module [*09/25/2025 11:59:50*]
+ **[InformationProtection 0.9.2](https://github.com/FriedrichWeinmann/InformationProtection)**  - Wraps the Microsoft Information Protection SDK [*09/12/2025 14:34:47*]
...
+ **[Domeneshop 0.0.1](https://github.com/PSModule/Domeneshop)**  - A PowerShell module for interacting with the Domeneshop APIs [*10/05/2025 10:06:42*]
+ **[Yaml 0.0.4](https://github.com/PSModule/Yaml)**  - A PowerShell module for working with Yaml. [*10/05/2025 07:58:38*]
+ **[WoW 0.0.25](https://github.com/PSModule/WoW)**  - A PowerShell module containing utilities for World of Warcraft. [*10/05/2025 07:58:15*]
+ **[Utilities 0.10.5](https://github.com/PSModule/Utilities)**  - A PowerShell module with a collection of functions that should have been in PowerShell to start with. [*10/05/2025 07:58:13*]
+ **[Uri 1.1.3](https://github.com/PSModule/Uri)**  - A powershell module that works with URIs (RFC3986) [*10/05/2025 07:58:13*]
+ **[Twitch 0.0.4](https://github.com/PSModule/Twitch)**  - A PowerShell module for interacting with Twitch. [*10/05/2025 07:58:03*]
+ **[Tls 1.0.4](https://github.com/PSModule/Tls)**  - A module for working with TLS settings. [*10/05/2025 07:57:30*]
+ **[TimeSpan 3.0.3](https://github.com/PSModule/TimeSpan)**  - A PowerShell module for working with TimeSpans [*10/05/2025 07:57:28*]
+ **[Telemetry 0.0.5](https://github.com/PSModule/Telemetry)**  - A PowerShell module for managing and registering telemetry. [*10/05/2025 07:49:51*]
+ **[Retry 0.1.7](https://github.com/PSModule/Retry)**  - A PowerShell module to create a retry mechanism around functions [*10/04/2025 16:58:11*]
+ **[PublicIP 1.1.5](https://github.com/PSModule/PublicIP)**  - A PowerShell module that helps getting info about your public IP. [*10/04/2025 16:52:28*]
+ **[PSSemVer 1.1.8](https://github.com/PSModule/PSSemVer)**  - A PowerShell module adding a SemVer compatible class and functions. [*10/04/2025 16:52:25*]
+ **[PSCredential 1.0.4](https://github.com/PSModule/PSCredential)**  - A Powershell module to manage PSCredentials [*10/04/2025 16:48:27*]
+ **[PSCustomObject 0.1.2](https://github.com/PSModule/PSCustomObject)**  - A PowerShell module for missing functions of PSCustomObjects. [*10/04/2025 16:48:23*]
+ **[PowerShellGallery 0.0.18](https://github.com/PSModule/PowerShellGallery)**  - A PowerShell module for interacting with the PowerShell Gallery. [*10/04/2025 16:31:25*]
+ **[PowerShellDataFile 0.0.4](https://github.com/PSModule/PowerShellDataFile)**  - A PowerShell module for base functions... [*10/04/2025 16:31:19*]
+ **[Object 1.0.3](https://github.com/PSModule/Object)**  - A PowerShell module that manages Objects in PowerShell. [*10/04/2025 16:29:04*]
+ **[OpenAI 0.0.11](https://github.com/PSModule/OpenAI)**  - A PowerShell module for interacting with OpenAI [*10/04/2025 16:27:56*]
+ **[Path 1.0.20](https://github.com/PSModule/Path)**  - A PowerShell module to manage the PATH environment variable on Windows. [*10/04/2025 16:27:33*]
+ **[GitHub 0.40.3](https://github.com/PSModule/GitHub)**  - A PowerShell module to interact with GitHub, both interactively and via automation. [*10/04/2025 16:14:53*]
+ **[Net 1.0.1](https://github.com/PSModule/Net)**  - A PowerShell module to bring network functions to PowerShell [*10/04/2025 16:13:20*]
+ **[MemoryMappedFile 0.0.2](https://github.com/PSModule/MemoryMappedFile)**  - A PowerShell module that manages MemoryMappedFile [*10/04/2025 15:59:06*]
+ **[Markdown 1.2.4](https://github.com/PSModule/Markdown)**  - A PowerShell module to handle markdown [*10/04/2025 15:58:27*]
+ **[Json 1.2.2](https://github.com/PSModule/Json)**  - A PowerShell module for typical Json related tasks. [*10/04/2025 14:41:32*]
+ **[IPv6 0.0.2](https://github.com/PSModule/IPv6)**  - A PowerShell module to manage IPv6 networking [*10/04/2025 12:01:20*]
+ **[LinkedIn 0.0.5](https://github.com/PSModule/LinkedIn)**  - A PowerShell module to programmatically interact with LinkedIn [*10/04/2025 12:00:06*]
+ **[IPv4 0.0.11](https://github.com/PSModule/IPv4)**  - A PowerShell module for managing IPv4 data [*10/04/2025 11:55:21*]
+ **[Guid 1.0.4](https://github.com/PSModule/Guid)**  - A PowerShell module that makes working with GUID sligthly more PowerShelly [*10/04/2025 08:48:50*]
+ **[GZip 0.0.5](https://github.com/PSModule/GZip)**  - A PowerShell Module that handles GZip archives [*10/04/2025 08:44:15*]
+ **[Hashtable 1.1.8](https://github.com/PSModule/Hashtable)**  - A PowerShell module that simplifies some interaction with Hashtables. [*10/04/2025 08:40:21*]
+ **[GraphQL 0.0.9](https://github.com/PSModule/GraphQL)**  - A PowerShell module to simplify working with a GraphQL APIs. [*10/04/2025 08:40:15*]
+ **[NerdFonts 1.0.28](https://github.com/PSModule/NerdFonts)**  - A PowerShell module to download and install fonts from NerdFonts. [*10/04/2025 07:46:05*]
+ **[GoogleFonts 1.0.67](https://github.com/PSModule/GoogleFonts)**  - A PowerShell module to download and install fonts from GoogleFonts. [*10/04/2025 07:34:15*]
+ **[Fonts 1.1.23](https://github.com/PSModule/Fonts)**  - A PowerShell module for managing fonts. [*10/04/2025 07:33:41*]
+ **[Claude 0.0.1](https://github.com/PSModule/Claude)**  - A PowerShell module for interacting with Claude API [*10/04/2025 07:07:18*]
+ **[Anthropic 0.0.1](https://github.com/PSModule/Anthropic)**  - asd [*10/04/2025 06:56:15*]
+ **[Gemini 0.0.1](https://github.com/PSModule/Gemini)**  - A PowerShell module for interacting with the Gemini API [*10/04/2025 06:45:51*]
+ **[Dns 1.0.1](https://github.com/PSModule/Dns)**  - A PowerShell module for managing DNS [*10/04/2025 06:38:11*]
+ **[Discord 0.0.4](https://github.com/PSModule/Discord)**  - A PowerShell module to interact with Discord. [*10/04/2025 06:33:04*]
+ **[DeepSeek 0.0.5](https://github.com/PSModule/DeepSeek)**  - A PowerShell module to interact with DeepSeek [*10/04/2025 06:32:37*]
+ **[DynamicParams 1.2.3](https://github.com/PSModule/DynamicParams)**  - A PowerShell module that makes it easier to use dynamic params. [*10/04/2025 06:30:06*]
+ **[DateTime 0.0.4](https://github.com/PSModule/DateTime)**  - A PowerShell module to work with DateTime objects. [*10/04/2025 06:28:05*]
+ **[Context7 0.0.2](https://github.com/PSModule/Context7)**  - A PowerShell module that interacts with Context7 [*10/03/2025 21:41:32*]
+ **[Context 8.1.5](https://github.com/PSModule/Context)**  - A PowerShell module that manages contexts with secrets and variables. [*10/03/2025 21:40:48*]
+ **[Confluence 0.0.5](https://github.com/PSModule/Confluence)**  - A PowerShell module that interacts with Atlassian Confluence [*10/03/2025 21:38:26*]
+ **[CasingStyle 1.0.6](https://github.com/PSModule/CasingStyle)**  - A PowerShell module that works with casing of text. [*10/03/2025 21:30:13*]
+ **[Bluesky 0.0.5](https://github.com/PSModule/Bluesky)**  - A PowerShell module to interact with BlueSky [*10/03/2025 21:09:41*]
+ **[Base64 2.0.4](https://github.com/PSModule/Base64)**  - A PowerShell module that just handles base64 conversion and validation. [*10/03/2025 21:07:42*]
+ **[Ast 0.4.5](https://github.com/PSModule/Ast)**  - A PowerShell module for using the Abstract Syntax Tree (AST) to analyze any PowerShell code. [*10/03/2025 20:57:51*]
+ **[Admin 1.1.10](https://github.com/PSModule/Admin)**  - A PowerShell module working with the admin role. [*10/03/2025 20:56:39*]
+ **[Template-PSModule 0.0.3](https://github.com/PSModule/Template-PSModule)**  - Template for a PowerShell module repo. [*10/03/2025 20:51:41*]
...
+ **[Universal 5.6.8](https://ironmansoftware.com/powershell-universal)**  - Module for PowerShell Universal. [*09/26/2025 17:11:31*]
...
*Updated: Sunday, 05 October 2025 21:52:22 UTC*
