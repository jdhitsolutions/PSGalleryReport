...
+ [Akamai Technologies Ltd.](#Akamai-Technologies-Ltd) (32)
...
+ [Anam Navied](#Anam-Navied) (9)
+ [Ahmad A. Ousman](#Ahmad-A-Ousman) (9)
+ [Dr. Tobias Weltner](#Dr-Tobias-Weltner) (9)
...
+ **[VMware.CloudFoundation.InstanceRecovery 1.0.12.1001](https://vmware.github.io/powershell-module-for-vmware-cloud-foundation-instance-recovery)**  - PowerShell Module for VMware Cloud Foundation Instance Recovery [*09/02/2024 15:02:07*]
...
+ **[PSBlueSky 2.1.0](https://github.com/jdhitsolutions/PSBluesky)**  - A set of PowerShell commands that use the Bluesky API. You can skeet and upload images from a PowerShell prompt. This module is written for PowerShell 7 and uses features like $PSStyle. [*11/21/2024 16:21:18*]
...
+ **[EntraAuth 1.4.21](https://github.com/FriedrichWeinmann/EntraAuth)**  - Get Tokens from Entra ID [*11/26/2024 14:17:08*]
...
+ **[Carbon.Security 1.0.3](https://github.com/webmd-health-services/Carbon.Security)**  - Manages security. [*12/03/2024 19:13:22*]
+ **[Prism 0.9.0](https://github.com/webmd-health-services/Prism)**  - Prism is a PowerShell module manager inspired by NuGet. Run `prism install` in a source code repository, and Prism will
...
get modules installed. [*12/03/2024 00:21:07*]
+ **[PureInvoke 1.0.1](https://github.com/webmd-health-services/PureInvoke)**  - Exposes Win32 API functions as PowerShell commands using .NET's platform invoke (e.g. p/invoke) capabilities. [*11/19/2024 18:19:37*]
...
+ **[AdminToolbox 11.1.0.19](https://github.com/TheTaylorLee/AdminToolbox)**  - Master module for a collection of modules. These modules are varied in their tasks. The overall purpose of them being to provide a powerfull Toolset to improve IT Admin workflows. [*12/03/2024 03:21:01*]
+ **[AdminToolbox.FortiWizard 2.21.2.2](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that generate configuration scripts and manage FortiOS. [*12/03/2024 03:20:47*]
+ **[AdminToolbox.VMWareAutomate 4.9.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions to Automate Bulk VMWare Tasks [*12/03/2024 03:19:41*]
+ **[AdminToolbox.Remoting 1.10.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for remote management and access. [*12/03/2024 03:19:37*]
+ **[AdminToolbox.Office365 4.3.0.18](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for working with Office365 and Azure modules [*12/03/2024 03:19:32*]
+ **[AdminToolbox.Networking 2.21.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Network Troubleshooting Functions [*12/03/2024 03:19:25*]
+ **[AdminToolbox.MSGraph 1.5.0.16](https://github.com/TheTaylorLee/AdminToolbox/)**  - Microsoft Graph interactive API Functions [*12/03/2024 03:19:20*]
+ **[AdminToolbox.Fun 1.7.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions that have no purpose [*12/03/2024 03:19:16*]
+ **[AdminToolbox.FileManagement 1.17.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - File Management Functions [*12/03/2024 03:19:12*]
+ **[AdminToolbox.FFTools 4.17.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Expedite simple ffmpeg actions [*12/03/2024 03:19:06*]
+ **[AdminToolbox.Exchange 1.10.0.19](https://github.com/TheTaylorLee/AdminToolbox/)**  - Functions for Exchange Management [*12/03/2024 03:19:01*]

## Chrissy LeMaire

+ **[dbatools.ai 1.3](https://github.com/potatoqualitee/dbatools.ai)**  - dbatools.ai is a copilot for SQL Server databases [*10/06/2024 19:09:37*]
...
*Updated: Wednesday, 04 December 2024 02:19:16 UTC*
