...
+ [Akamai Technologies Ltd.](#Akamai-Technologies-Ltd) (41)
...
+ **PSSailpoint.TaggedObjects 2.1.38**  - PSSailpoint.TaggedObjects - the PowerShell module for Identity Security Cloud API - Tagged Objects [*09/15/2026 08:41:05*]
+ **PSSailpoint.SuggestedEntitlementDescription 2.1.38**  - PSSailpoint.SuggestedEntitlementDescription - the PowerShell module for Identity Security Cloud API - Suggested Entitlement Description [*09/15/2026 08:39:55*]
+ **PSSailpoint.SpConfig 2.1.38**  - PSSailpoint.SpConfig - the PowerShell module for Identity Security Cloud API - SP-Config [*09/15/2026 08:39:47*]
+ **PSSailpoint.Sources 2.1.38**  - PSSailpoint.Sources - the PowerShell module for Identity Security Cloud API - Sources [*09/15/2026 08:39:41*]
+ **PSSailpoint.SourceUsages 2.1.38**  - PSSailpoint.SourceUsages - the PowerShell module for Identity Security Cloud API - Source Usages [*09/15/2026 08:39:21*]
+ **PSSailpoint.SodViolations 2.1.38**  - PSSailpoint.SodViolations - the PowerShell module for Identity Security Cloud API - SOD Violations [*09/15/2026 08:39:14*]
+ **PSSailpoint.SodPolicies 2.1.38**  - PSSailpoint.SodPolicies - the PowerShell module for Identity Security Cloud API - SOD Policies [*09/15/2026 08:39:11*]
+ **PSSailpoint.SodControls 2.1.38**  - PSSailpoint.SodControls - the PowerShell module for Identity Security Cloud API - SOD Controls [*09/15/2026 08:39:06*]
+ **PSSailpoint.SimIntegrations 2.1.38**  - PSSailpoint.SimIntegrations - the PowerShell module for Identity Security Cloud API - SIM Integrations [*09/15/2026 08:38:50*]
+ **PSSailpoint.SharedSignalsFrameworkSsf 2.1.38**  - PSSailpoint.SharedSignalsFrameworkSsf - the PowerShell module for Identity Security Cloud API - Shared Signals Framework (SSF) [*09/15/2026 08:38:40*]
+ **PSSailpoint.ServiceDeskIntegration 2.1.38**  - PSSailpoint.ServiceDeskIntegration - the PowerShell module for Identity Security Cloud API - Service Desk Integration [*09/15/2026 08:38:30*]
+ **PSSailpoint.Segments 2.1.38**  - PSSailpoint.Segments - the PowerShell module for Identity Security Cloud API - Segments [*09/15/2026 08:38:18*]
+ **PSSailpoint.SearchAttributeConfiguration 2.1.38**  - PSSailpoint.SearchAttributeConfiguration - the PowerShell module for Identity Security Cloud API - Search Attribute Configuration [*09/15/2026 08:38:08*]
+ **PSSailpoint.Search 2.1.38**  - PSSailpoint.Search - the PowerShell module for Identity Security Cloud API - Search [*09/15/2026 08:37:55*]
+ **PSSailpoint.ScheduledSearch 2.1.38**  - PSSailpoint.ScheduledSearch - the PowerShell module for Identity Security Cloud API - Scheduled Search [*09/15/2026 08:37:43*]
+ **PSSailpoint.SavedSearch 2.1.38**  - PSSailpoint.SavedSearch - the PowerShell module for Identity Security Cloud API - Saved Search [*09/15/2026 08:37:23*]
+ **PSSailpoint.Roles 2.1.38**  - PSSailpoint.Roles - the PowerShell module for Identity Security Cloud API - Roles [*09/15/2026 08:37:11*]
+ **PSSailpoint.RolePropagation 2.1.38**  - PSSailpoint.RolePropagation - the PowerShell module for Identity Security Cloud API - Role Propagation [*09/15/2026 08:36:56*]
+ **PSSailpoint.RoleInsights 2.1.38**  - PSSailpoint.RoleInsights - the PowerShell module for Identity Security Cloud API - Role Insights [*09/15/2026 08:36:44*]
+ **PSSailpoint.RequestableObjects 2.1.38**  - PSSailpoint.RequestableObjects - the PowerShell module for Identity Security Cloud API - Requestable Objects [*09/15/2026 08:36:28*]
+ **PSSailpoint.ReportsDataExtraction 2.1.38**  - PSSailpoint.ReportsDataExtraction - the PowerShell module for Identity Security Cloud API - Reports Data Extraction [*09/15/2026 08:36:20*]
+ **PSSailpoint.PublicMachineIdentities 2.1.38**  - PSSailpoint.PublicMachineIdentities - the PowerShell module for Identity Security Cloud API - Public Machine Identities [*09/15/2026 08:36:13*]
+ **PSSailpoint.PublicIdentitiesConfig 2.1.38**  - PSSailpoint.PublicIdentitiesConfig - the PowerShell module for Identity Security Cloud API - Public Identities Config [*09/15/2026 08:36:06*]
+ **PSSailpoint.PublicIdentities 2.1.38**  - PSSailpoint.PublicIdentities - the PowerShell module for Identity Security Cloud API - Public Identities [*09/15/2026 08:35:50*]
+ **PSSailpoint.PrivilegeCriteriaConfiguration 2.1.38**  - PSSailpoint.PrivilegeCriteriaConfiguration - the PowerShell module for Identity Security Cloud API - Privilege Criteria Configuration [*09/15/2026 08:35:44*]
+ **PSSailpoint.PersonalAccessTokens 2.1.38**  - PSSailpoint.PersonalAccessTokens - the PowerShell module for Identity Security Cloud API - Personal Access Tokens [*09/15/2026 08:35:20*]
+ **PSSailpoint.PasswordSyncGroups 2.1.38**  - PSSailpoint.PasswordSyncGroups - the PowerShell module for Identity Security Cloud API - Password Sync Groups [*09/15/2026 08:35:11*]
+ **PSSailpoint.PasswordPolicies 2.1.38**  - PSSailpoint.PasswordPolicies - the PowerShell module for Identity Security Cloud API - Password Policies [*09/15/2026 08:35:04*]
+ **PSSailpoint.PasswordDictionary 2.1.38**  - PSSailpoint.PasswordDictionary - the PowerShell module for Identity Security Cloud API - Password Dictionary [*09/15/2026 08:34:40*]
+ **PSSailpoint.PasswordConfiguration 2.1.38**  - PSSailpoint.PasswordConfiguration - the PowerShell module for Identity Security Cloud API - Password Configuration [*09/15/2026 08:34:20*]
+ **PSSailpoint.ParameterStorage 2.1.38**  - PSSailpoint.ParameterStorage - the PowerShell module for Identity Security Cloud API - Parameter Storage [*09/15/2026 08:34:15*]
+ **PSSailpoint.OauthClients 2.1.38**  - PSSailpoint.OauthClients - the PowerShell module for Identity Security Cloud API - OAuth Clients [*09/15/2026 08:33:48*]
+ **PSSailpoint.Notifications 2.1.38**  - PSSailpoint.Notifications - the PowerShell module for Identity Security Cloud API - Notifications [*09/15/2026 08:33:37*]
+ **PSSailpoint.NonEmployeeLifecycleManagement 2.1.38**  - PSSailpoint.NonEmployeeLifecycleManagement - the PowerShell module for Identity Security Cloud API - Non-Employee Lifecycle Management [*09/15/2026 08:33:13*]
+ **PSSailpoint.MultiHostIntegration 2.1.38**  - PSSailpoint.MultiHostIntegration - the PowerShell module for Identity Security Cloud API - Multi-Host Integration [*09/15/2026 08:33:00*]
+ **PSSailpoint.MfaConfiguration 2.1.38**  - PSSailpoint.MfaConfiguration - the PowerShell module for Identity Security Cloud API - MFA Configuration [*09/15/2026 08:32:37*]
+ **PSSailpoint.ManagedClusters 2.1.38**  - PSSailpoint.ManagedClusters - the PowerShell module for Identity Security Cloud API - Managed Clusters [*09/15/2026 08:32:18*]
+ **PSSailpoint.ManagedClusterTypes 2.1.38**  - PSSailpoint.ManagedClusterTypes - the PowerShell module for Identity Security Cloud API - Managed Cluster Types [*09/15/2026 08:31:59*]
+ **PSSailpoint.MachineIdentitiesLifecycleActions 2.1.38**  - PSSailpoint.MachineIdentitiesLifecycleActions - the PowerShell module for Identity Security Cloud API - Machine Identity Lifecycle Actions [*09/15/2026 08:31:22*]
+ **PSSailpoint.MachineIdentities 2.1.38**  - PSSailpoint.MachineIdentities - the PowerShell module for Identity Security Cloud API - Machine Identities [*09/15/2026 08:31:12*]
+ **PSSailpoint.MachineClassificationConfig 2.1.38**  - PSSailpoint.MachineClassificationConfig - the PowerShell module for Identity Security Cloud API - Machine Classification Config [*09/15/2026 08:30:57*]
+ **PSSailpoint.MachineAccounts 2.1.38**  - PSSailpoint.MachineAccounts - the PowerShell module for Identity Security Cloud API - Machine Accounts [*09/15/2026 08:30:43*]
+ **PSSailpoint.MachineAccountSubtypes 2.1.38**  - PSSailpoint.MachineAccountSubtypes - the PowerShell module for Identity Security Cloud API - Machine Account Subtypes [*09/15/2026 08:30:30*]
+ **PSSailpoint.MachineAccountMappings 2.1.38**  - PSSailpoint.MachineAccountMappings - the PowerShell module for Identity Security Cloud API - Machine Account Mappings [*09/15/2026 08:30:16*]
+ **PSSailpoint.MachineAccountCreationRequest 2.1.38**  - PSSailpoint.MachineAccountCreationRequest - the PowerShell module for Identity Security Cloud API - Machine Account Creation Request [*09/15/2026 08:29:53*]
+ **PSSailpoint.MachineAccountClassify 2.1.38**  - PSSailpoint.MachineAccountClassify - the PowerShell module for Identity Security Cloud API - Machine Account Classify [*09/15/2026 08:29:37*]
+ **PSSailpoint.LifecycleStates 2.1.38**  - PSSailpoint.LifecycleStates - the PowerShell module for Identity Security Cloud API - Lifecycle States [*09/15/2026 08:29:20*]
+ **PSSailpoint.Launchers 2.1.38**  - PSSailpoint.Launchers - the PowerShell module for Identity Security Cloud API - Launchers [*09/15/2026 08:29:02*]
+ **PSSailpoint.JitActivations 2.1.38**  - PSSailpoint.JitActivations - the PowerShell module for Identity Security Cloud API - JIT Activations [*09/15/2026 08:28:42*]
+ **PSSailpoint.JitAccess 2.1.38**  - PSSailpoint.JitAccess - the PowerShell module for Identity Security Cloud API - JIT Access [*09/15/2026 08:28:22*]
+ **PSSailpoint.IdentityProfiles 2.1.38**  - PSSailpoint.IdentityProfiles - the PowerShell module for Identity Security Cloud API - Identity Profiles [*09/15/2026 08:27:43*]
+ **PSSailpoint.IdentityHistory 2.1.38**  - PSSailpoint.IdentityHistory - the PowerShell module for Identity Security Cloud API - Identity History [*09/15/2026 08:27:22*]
+ **PSSailpoint.IdentityAttributes 2.1.38**  - PSSailpoint.IdentityAttributes - the PowerShell module for Identity Security Cloud API - Identity Attributes [*09/15/2026 08:27:06*]
+ **PSSailpoint.Identities 2.1.38**  - PSSailpoint.Identities - the PowerShell module for Identity Security Cloud API - Identities [*09/15/2026 08:26:46*]
+ **PSSailpoint.Icons 2.1.38**  - PSSailpoint.Icons - the PowerShell module for Identity Security Cloud API - Icons [*09/15/2026 08:26:28*]
+ **PSSailpoint.IaiRoleMining 2.1.38**  - PSSailpoint.IaiRoleMining - the PowerShell module for Identity Security Cloud API - IAI Role Mining [*09/15/2026 08:26:14*]
+ **PSSailpoint.IaiPeerGroupStrategies 2.1.38**  - PSSailpoint.IaiPeerGroupStrategies - the PowerShell module for Identity Security Cloud API - IAI Peer Group Strategies [*09/15/2026 08:25:42*]
+ **PSSailpoint.IaiOutliers 2.1.38**  - PSSailpoint.IaiOutliers - the PowerShell module for Identity Security Cloud API - IAI Outliers [*09/15/2026 08:25:21*]
+ **PSSailpoint.IaiCommonAccess 2.1.38**  - PSSailpoint.IaiCommonAccess - the PowerShell module for Identity Security Cloud API - IAI Common Access [*09/15/2026 08:25:12*]
+ **PSSailpoint.IaiAccessRequestRecommendations 2.1.38**  - PSSailpoint.IaiAccessRequestRecommendations - the PowerShell module for Identity Security Cloud API - IAI Access Request Recommendations [*09/15/2026 08:25:02*]
+ **PSSailpoint.GovernanceGroups 2.1.38**  - PSSailpoint.GovernanceGroups - the PowerShell module for Identity Security Cloud API - Governance Groups [*09/15/2026 08:24:47*]
+ **PSSailpoint.GlobalTenantSecuritySettings 2.1.38**  - PSSailpoint.GlobalTenantSecuritySettings - the PowerShell module for Identity Security Cloud API - Global Tenant Security Settings [*09/15/2026 08:24:40*]
+ **PSSailpoint.Entitlements 2.1.38**  - PSSailpoint.Entitlements - the PowerShell module for Identity Security Cloud API - Entitlements [*09/15/2026 08:24:23*]
+ **PSSailpoint.EntitlementConnections 2.1.38**  - PSSailpoint.EntitlementConnections - the PowerShell module for Identity Security Cloud API - Entitlement Connections [*09/15/2026 08:24:15*]
+ **PSSailpoint.Dimensions 2.1.38**  - PSSailpoint.Dimensions - the PowerShell module for Identity Security Cloud API - Dimensions [*09/15/2026 08:24:10*]
+ **PSSailpoint.DeclassifySource 2.1.38**  - PSSailpoint.DeclassifySource - the PowerShell module for Identity Security Cloud API - Declassify Source [*09/15/2026 08:23:51*]
+ **PSSailpoint.DataSegmentation 2.1.38**  - PSSailpoint.DataSegmentation - the PowerShell module for Identity Security Cloud API - Data Segmentation [*09/15/2026 08:23:44*]
+ **PSSailpoint.DataAccessSecurity 2.1.38**  - PSSailpoint.DataAccessSecurity - the PowerShell module for Identity Security Cloud API - Data Access Security [*09/15/2026 08:23:26*]
+ **PSSailpoint.CustomUserLevels 2.1.38**  - PSSailpoint.CustomUserLevels - the PowerShell module for Identity Security Cloud API - Custom User Levels [*09/15/2026 08:23:09*]
+ **PSSailpoint.CustomPasswordInstructions 2.1.38**  - PSSailpoint.CustomPasswordInstructions - the PowerShell module for Identity Security Cloud API - Custom Password Instructions [*09/15/2026 08:22:53*]
+ **PSSailpoint.CustomForms 2.1.38**  - PSSailpoint.CustomForms - the PowerShell module for Identity Security Cloud API - Custom Forms [*09/15/2026 08:22:38*]
+ **PSSailpoint.Connectors 2.1.38**  - PSSailpoint.Connectors - the PowerShell module for Identity Security Cloud API - Connectors [*09/15/2026 08:22:20*]
+ **PSSailpoint.ConnectorRuleManagement 2.1.38**  - PSSailpoint.ConnectorRuleManagement - the PowerShell module for Identity Security Cloud API - Connector Rule Management [*09/15/2026 08:22:02*]
+ **PSSailpoint.ConnectorCustomizers 2.1.38**  - PSSailpoint.ConnectorCustomizers - the PowerShell module for Identity Security Cloud API - Connector Customizers [*09/15/2026 08:21:46*]
+ **PSSailpoint.ConfigurationHub 2.1.38**  - PSSailpoint.ConfigurationHub - the PowerShell module for Identity Security Cloud API - Configuration Hub [*09/15/2026 08:21:33*]
+ **PSSailpoint.ClassifySource 2.1.38**  - PSSailpoint.ClassifySource - the PowerShell module for Identity Security Cloud API - Classify Source [*09/15/2026 08:21:23*]
+ **PSSailpoint.Certifications 2.1.38**  - PSSailpoint.Certifications - the PowerShell module for Identity Security Cloud API - Certifications [*09/15/2026 08:21:01*]
+ **PSSailpoint.CertificationSummaries 2.1.38**  - PSSailpoint.CertificationSummaries - the PowerShell module for Identity Security Cloud API - Certification Summaries [*09/15/2026 08:20:42*]
+ **PSSailpoint.CertificationCampaigns 2.1.38**  - PSSailpoint.CertificationCampaigns - the PowerShell module for Identity Security Cloud API - Certification Campaigns [*09/15/2026 08:20:20*]
+ **PSSailpoint.CertificationCampaignFilters 2.1.38**  - PSSailpoint.CertificationCampaignFilters - the PowerShell module for Identity Security Cloud API - Certification Campaign Filters [*09/15/2026 08:19:57*]
+ **PSSailpoint.BusinessApplications 2.1.38**  - PSSailpoint.BusinessApplications - the PowerShell module for Identity Security Cloud API - Business Applications [*09/15/2026 08:19:38*]
+ **PSSailpoint.Branding 2.1.38**  - PSSailpoint.Branding - the PowerShell module for Identity Security Cloud API - Branding [*09/15/2026 08:19:14*]
+ **PSSailpoint.AuthUsers 2.1.38**  - PSSailpoint.AuthUsers - the PowerShell module for Identity Security Cloud API - Auth Users [*09/15/2026 08:18:51*]
+ **PSSailpoint.AuthProfile 2.1.38**  - PSSailpoint.AuthProfile - the PowerShell module for Identity Security Cloud API - Auth Profile [*09/15/2026 08:18:31*]
+ **PSSailpoint.Apps 2.1.38**  - PSSailpoint.Apps - the PowerShell module for Identity Security Cloud API - Apps [*09/15/2026 08:18:07*]
+ **PSSailpoint.Approvals 2.1.38**  - PSSailpoint.Approvals - the PowerShell module for Identity Security Cloud API - Approvals [*09/15/2026 08:17:44*]
+ **PSSailpoint.ApplicationDiscovery 2.1.38**  - PSSailpoint.ApplicationDiscovery - the PowerShell module for Identity Security Cloud API - Application Discovery [*09/15/2026 08:17:22*]
+ **PSSailpoint.ApiUsage 2.1.38**  - PSSailpoint.ApiUsage - the PowerShell module for Identity Security Cloud API - Api Usage [*09/15/2026 08:17:02*]
+ **PSSailpoint.Accounts 2.1.38**  - PSSailpoint.Accounts - the PowerShell module for Identity Security Cloud API - Accounts [*09/15/2026 08:16:43*]
+ **PSSailpoint.AccountUsages 2.1.38**  - PSSailpoint.AccountUsages - the PowerShell module for Identity Security Cloud API - Account Usages [*09/15/2026 08:16:18*]
+ **PSSailpoint.AccountDeletionRequests 2.1.38**  - PSSailpoint.AccountDeletionRequests - the PowerShell module for Identity Security Cloud API - Account Deletion Requests [*09/15/2026 08:15:52*]
+ **PSSailpoint.AccountAggregations 2.1.38**  - PSSailpoint.AccountAggregations - the PowerShell module for Identity Security Cloud API - Account Aggregations [*09/15/2026 08:15:38*]
+ **PSSailpoint.AccountActivities 2.1.38**  - PSSailpoint.AccountActivities - the PowerShell module for Identity Security Cloud API - Account Activities [*09/15/2026 08:15:14*]
+ **PSSailpoint.AccessRequests 2.1.38**  - PSSailpoint.AccessRequests - the PowerShell module for Identity Security Cloud API - Access Requests [*09/15/2026 08:14:55*]
+ **PSSailpoint.AccessRequestIdentityMetrics 2.1.38**  - PSSailpoint.AccessRequestIdentityMetrics - the PowerShell module for Identity Security Cloud API - Access Request Identity Metrics [*09/15/2026 08:14:36*]
+ **PSSailpoint.AccessRequestApprovals 2.1.38**  - PSSailpoint.AccessRequestApprovals - the PowerShell module for Identity Security Cloud API - Access Request Approvals [*09/15/2026 08:14:13*]
+ **PSSailpoint.AccessProfiles 2.1.38**  - PSSailpoint.AccessProfiles - the PowerShell module for Identity Security Cloud API - Access Profiles [*09/15/2026 08:13:50*]
+ **PSSailpoint.AccessModelMetadata 2.1.38**  - PSSailpoint.AccessModelMetadata - the PowerShell module for Identity Security Cloud API - Access Model Metadata [*09/15/2026 08:13:25*]
...
*Updated: Tuesday, 15 September 2026 14:30:04 UTC*
